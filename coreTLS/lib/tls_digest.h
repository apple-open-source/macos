...
typedef int (*HashInit)(tls_buffer *digestCtx);
typedef int (*HashUpdate)(tls_buffer *digestCtx, const tls_buffer *data);
/* HashFinal also does HashClose */
typedef int (*HashFinal)(tls_buffer *digestCtx, tls_buffer *digest);
typedef int (*HashClose)(tls_buffer *digestCtx);
typedef int (*HashClone)(const tls_buffer *src, tls_buffer *dest);
