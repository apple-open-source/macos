...
//    { "tls.secg.org", 40022, 3, false}, // secg ecc server w/o client side auth - This server generate DH params we didn't support, but this should be fixed now
...
static SSLContextRef make_ssl_ref(bool dh_anonymous,
                                  bool dtls,
                                  int sock, CFArrayRef certs, SSLProtocol prot)
{
