...
enum {
	...
	STATISTIC_WORKQUEUE,
	STATISTIC_FAULTS,
	STATISTIC_COW_FAULTS,
	STATISTIC_MESSAGES_SENT,
	STATISTIC_MESSAGES_RECEIVED,
	STATISTIC_SYSBSD,
	STATISTIC_SYSMACH,
	STATISTIC_CSW,
	STATISTIC_PAGEINS,
...
struct statistics_controller {
	...
	void (*iterate)(
			struct statistics_controller *c, bool (*func)(struct statistic *, void *), void *ptr);
};
...
struct statistic *create_statistic(int type, WINDOW *parent, void *ptr,
		struct statistic_callbacks *callbacks, const char *name);
 ...
 */
bool create_statistic_destructor(
