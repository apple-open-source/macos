...
#ifdef __APPLE__
REGRESSION_TEST(`a1_apple',`$CALENDAR -A 3 -t 28.12.2006')
REGRESSION_TEST(`a2_apple',`$CALENDAR -A 3 -t 29.12.2006')
#else
...
#ifdef __APPLE__
REGRESSION_TEST(`b1_apple',`$CALENDAR -B 3 -t 31.12.2006')
REGRESSION_TEST(`b2_apple',`$CALENDAR -B 3 -t 01.01.2007')
REGRESSION_TEST(`b3_apple',`$CALENDAR -B 3 -t 02.01.2007')
REGRESSION_TEST(`b4_apple',`$CALENDAR -B 3 -t 03.01.2007')
REGRESSION_TEST(`b5_apple',`$CALENDAR -B 3 -t 04.01.2007')
#else
