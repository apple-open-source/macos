 ...
 *                      it to us.
 *
 * Version:      $Id: rlm_attr_filter.c,v 1.19.2.1.2.1 2007/05/16 07:44:18 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_attr_filter.c,v 1.19.2.1.2.1 2007/05/16 07:44:18 aland Exp $";
