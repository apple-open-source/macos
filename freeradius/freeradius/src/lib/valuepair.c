 ...
 *
 * Version:	$Id: valuepair.c,v 1.82.2.1.2.3 2006/05/03 17:40:58 aland Exp $
 *
...
static const char rcsid[] = "$Id: valuepair.c,v 1.82.2.1.2.3 2006/05/03 17:40:58 aland Exp $";
