 ...
 *			the main server.
 *
 * Version:	$Id: request_list.c,v 1.40.2.2.2.7 2007/06/12 09:31:46 aland Exp $
 *
 ...
 */
static const char rcsid[] = "$Id: request_list.c,v 1.40.2.2.2.7 2007/06/12 09:31:46 aland Exp $";
