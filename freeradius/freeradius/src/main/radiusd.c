 ...
 *
 * Version:	$Id: radiusd.c,v 1.321.2.2.2.5 2007/02/12 09:55:24 aland Exp $
 *
...
"$Id: radiusd.c,v 1.321.2.2.2.5 2007/02/12 09:55:24 aland Exp $";
...
const char *radiusd_version = "FreeRADIUS Version 1.1.4, with security changes through 1.1.7, for host apple.com, built on " __DATE__ " at " __TIME__;
