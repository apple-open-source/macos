...
struct gdbarch
{
  ...
  gdbarch_deprecated_print_extra_frame_info_ftype *deprecated_print_extra_frame_info;
...
struct gdbarch startup_gdbarch =
{
  ...
  0,  /* deprecated_print_extra_frame_info */
  0,  /* skip_prologue */
  0,  /* inner_than */
               ...
               struct gdbarch_tdep *tdep)
{
  ...
  current_gdbarch->deprecated_print_extra_frame_info = default_print_extra_frame_info;
...
verify_gdbarch (struct gdbarch *current_gdbarch)
{
  ...
  /* Skip verify of deprecated_print_extra_frame_info, invalid_p == 0 */
  if ((GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL)
...
gdbarch_dump (struct gdbarch *current_gdbarch, struct ui_file *file)
{
  ...
  fprintf_unfiltered (file,
                      "gdbarch_dump: %s # %s\n",
                      "DEPRECATED_PRINT_EXTRA_FRAME_INFO(next_frame, this_cache)",
                      XSTRING (DEPRECATED_PRINT_EXTRA_FRAME_INFO (next_frame, this_cache)));
  fprintf_unfiltered (file,
                      "gdbarch_dump: DEPRECATED_PRINT_EXTRA_FRAME_INFO = <0x%08lx>\n",
                      (long) current_gdbarch->deprecated_print_extra_frame_info
...
void
gdbarch_deprecated_print_extra_frame_info (struct gdbarch *gdbarch, struct frame_info *next_frame, void **this_cache)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->deprecated_print_extra_frame_info != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_deprecated_print_extra_frame_info called\n");
  gdbarch->deprecated_print_extra_frame_info (next_frame, this_cache);
}

void
set_gdbarch_deprecated_print_extra_frame_info (struct gdbarch *gdbarch,
                                               gdbarch_deprecated_print_extra_frame_info_ftype deprecated_print_extra_frame_info)
{
  gdbarch->deprecated_print_extra_frame_info = deprecated_print_extra_frame_info;
}
