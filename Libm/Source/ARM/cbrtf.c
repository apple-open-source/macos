...
static const struct cbrt_table_entry cbrt_table[] = {
	// mantissa = 0x1.00...
	{0x1.0000000000000p+0, 0x1.0000000000000p+0, 0x1.0000000000000p+0, 0x1.0000000000000p+0}, // exponent = 0
	{0x1.037e200000000p+1, 0x1.4400000000000p+0, 0x1.948b0fcd6e9e0p-1, 0x1.f91bd1b62b9cfp-2}, // exponent = 1
	{0x1.0315800000000p+2, 0x1.9800000000000p+0, 0x1.4141414141414p-1, 0x1.f9e7cba5753afp-3}, // exponent = 2
	
	// mantissa = 0x1.04...
	{0x1.060c080000000p+0, 0x1.0200000000000p+0, 0x1.fc07f01fc07f0p-1, 0x1.f42f61dacddc6p-1}, // exponent = 0
	{0x1.05ff4c356ff40p+1, 0x1.450a000000000p+0, 0x1.933fff9b30002p-1, 0x1.f447b132ca3acp-2}, // exponent = 1
	{0x1.06e9aa0000000p+2, 0x1.9a00000000000p+0, 0x1.3fb013fb013fbp-1, 0x1.f289bb31fd41cp-3}, // exponent = 2
	
	// mantissa = 0x1.08...
	{0x1.09fe97c0b2e80p+0, 0x1.034a000000000p+0, 0x1.f9815c85b04a3p-1, 0x1.ecc3168ac46e4p-1}, // exponent = 0
...
float cbrtf(float x) {
	...
	// Smaller polynomial, gives faithful (non-correctly) rounded cbrt:
	// double poly = 1.0 + (.333333333108443729897843505705898 +(-.111111110411403237171599705217552 + (0.617357638819372335290377013123813e-1 - 0.411608607983955119275151074893740e-1*r)*r)*r)*r;
