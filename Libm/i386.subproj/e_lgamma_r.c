...
static const double
two52=  0x1.0p+52, // 4.50359962737049600000e+15, /* 0x43300000, 0x00000000 */
...
#define __kernel_sin(x,y,z) sin(x)
#define __kernel_cos(x,y) cos(x)
...
double lgamma_r(double x, int *signgamp)
{
	...
	*signgamp = 1;
	...
	if((ix|lx)==0) return ((x + one)/zero); /* scp: thwart gcc constant folding */
