...
static struct builtin B1_vec_dst = { { &T_const_float_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:1", "*dst", CODE_FOR_vlfiiD_load, B_UID(388), NULL };
static struct builtin B2_vec_dst = { { &T_const_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:2", "*dst", CODE_FOR_vlfiiD_load, B_UID(389), NULL };
static struct builtin B3_vec_dst = { { &T_const_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:3", "*dst", CODE_FOR_vlfiiD_load, B_UID(390), NULL };
static struct builtin B4_vec_dst = { { &T_const_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:4", "*dst", CODE_FOR_vlfiiD_load, B_UID(391), NULL };
static struct builtin B5_vec_dst = { { &T_const_signed_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:5", "*dst", CODE_FOR_vlfiiD_load, B_UID(392), NULL };
static struct builtin B6_vec_dst = { { &T_const_unsigned_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:6", "*dst", CODE_FOR_vlfiiD_load, B_UID(393), NULL };
static struct builtin B7_vec_dst = { { &T_const_unsigned_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:7", "*dst", CODE_FOR_vlfiiD_load, B_UID(394), NULL };
static struct builtin B8_vec_dst = { { &T_const_unsigned_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:8", "*dst", CODE_FOR_vlfiiD_load, B_UID(395), NULL };
static struct builtin B9_vec_dst = { { &T_const_unsigned_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:9", "*dst", CODE_FOR_vlfiiD_load, B_UID(396), NULL };
static struct builtin B10_vec_dst = { { &T_const_vec_b16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:10", "*dst", CODE_FOR_vlfiiD_load, B_UID(397), NULL };
static struct builtin B11_vec_dst = { { &T_const_vec_b32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:11", "*dst", CODE_FOR_vlfiiD_load, B_UID(398), NULL };
static struct builtin B12_vec_dst = { { &T_const_vec_b8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:12", "*dst", CODE_FOR_vlfiiD_load, B_UID(399), NULL };
static struct builtin B13_vec_dst = { { &T_const_vec_f32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:13", "*dst", CODE_FOR_vlfiiD_load, B_UID(400), NULL };
static struct builtin B14_vec_dst = { { &T_const_vec_p16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:14", "*dst", CODE_FOR_vlfiiD_load, B_UID(401), NULL };
static struct builtin B15_vec_dst = { { &T_const_vec_s16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:15", "*dst", CODE_FOR_vlfiiD_load, B_UID(402), NULL };
static struct builtin B16_vec_dst = { { &T_const_vec_s32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:16", "*dst", CODE_FOR_vlfiiD_load, B_UID(403), NULL };
static struct builtin B17_vec_dst = { { &T_const_vec_s8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:17", "*dst", CODE_FOR_vlfiiD_load, B_UID(404), NULL };
static struct builtin B18_vec_dst = { { &T_const_vec_u16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:18", "*dst", CODE_FOR_vlfiiD_load, B_UID(405), NULL };
static struct builtin B19_vec_dst = { { &T_const_vec_u32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:19", "*dst", CODE_FOR_vlfiiD_load, B_UID(406), NULL };
static struct builtin B20_vec_dst = { { &T_const_vec_u8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dst:20", "*dst", CODE_FOR_vlfiiD_load, B_UID(407), NULL };
static struct builtin B1_vec_dstst = { { &T_const_float_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:1", "*dstst", CODE_FOR_vlfiiD_load, B_UID(408), NULL };
static struct builtin B2_vec_dstst = { { &T_const_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:2", "*dstst", CODE_FOR_vlfiiD_load, B_UID(409), NULL };
static struct builtin B3_vec_dstst = { { &T_const_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:3", "*dstst", CODE_FOR_vlfiiD_load, B_UID(410), NULL };
static struct builtin B4_vec_dstst = { { &T_const_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:4", "*dstst", CODE_FOR_vlfiiD_load, B_UID(411), NULL };
static struct builtin B5_vec_dstst = { { &T_const_signed_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:5", "*dstst", CODE_FOR_vlfiiD_load, B_UID(412), NULL };
static struct builtin B6_vec_dstst = { { &T_const_unsigned_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:6", "*dstst", CODE_FOR_vlfiiD_load, B_UID(413), NULL };
static struct builtin B7_vec_dstst = { { &T_const_unsigned_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:7", "*dstst", CODE_FOR_vlfiiD_load, B_UID(414), NULL };
static struct builtin B8_vec_dstst = { { &T_const_unsigned_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:8", "*dstst", CODE_FOR_vlfiiD_load, B_UID(415), NULL };
static struct builtin B9_vec_dstst = { { &T_const_unsigned_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:9", "*dstst", CODE_FOR_vlfiiD_load, B_UID(416), NULL };
static struct builtin B10_vec_dstst = { { &T_const_vec_b16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:10", "*dstst", CODE_FOR_vlfiiD_load, B_UID(417), NULL };
static struct builtin B11_vec_dstst = { { &T_const_vec_b32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:11", "*dstst", CODE_FOR_vlfiiD_load, B_UID(418), NULL };
static struct builtin B12_vec_dstst = { { &T_const_vec_b8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:12", "*dstst", CODE_FOR_vlfiiD_load, B_UID(419), NULL };
static struct builtin B13_vec_dstst = { { &T_const_vec_f32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:13", "*dstst", CODE_FOR_vlfiiD_load, B_UID(420), NULL };
static struct builtin B14_vec_dstst = { { &T_const_vec_p16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:14", "*dstst", CODE_FOR_vlfiiD_load, B_UID(421), NULL };
static struct builtin B15_vec_dstst = { { &T_const_vec_s16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:15", "*dstst", CODE_FOR_vlfiiD_load, B_UID(422), NULL };
static struct builtin B16_vec_dstst = { { &T_const_vec_s32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:16", "*dstst", CODE_FOR_vlfiiD_load, B_UID(423), NULL };
static struct builtin B17_vec_dstst = { { &T_const_vec_s8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:17", "*dstst", CODE_FOR_vlfiiD_load, B_UID(424), NULL };
static struct builtin B18_vec_dstst = { { &T_const_vec_u16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:18", "*dstst", CODE_FOR_vlfiiD_load, B_UID(425), NULL };
static struct builtin B19_vec_dstst = { { &T_const_vec_u32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:19", "*dstst", CODE_FOR_vlfiiD_load, B_UID(426), NULL };
static struct builtin B20_vec_dstst = { { &T_const_vec_u8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstst:20", "*dstst", CODE_FOR_vlfiiD_load, B_UID(427), NULL };
static struct builtin B1_vec_dststt = { { &T_const_float_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:1", "*dststt", CODE_FOR_vlfiiD_load, B_UID(428), NULL };
static struct builtin B2_vec_dststt = { { &T_const_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:2", "*dststt", CODE_FOR_vlfiiD_load, B_UID(429), NULL };
static struct builtin B3_vec_dststt = { { &T_const_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:3", "*dststt", CODE_FOR_vlfiiD_load, B_UID(430), NULL };
static struct builtin B4_vec_dststt = { { &T_const_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:4", "*dststt", CODE_FOR_vlfiiD_load, B_UID(431), NULL };
static struct builtin B5_vec_dststt = { { &T_const_signed_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:5", "*dststt", CODE_FOR_vlfiiD_load, B_UID(432), NULL };
static struct builtin B6_vec_dststt = { { &T_const_unsigned_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:6", "*dststt", CODE_FOR_vlfiiD_load, B_UID(433), NULL };
static struct builtin B7_vec_dststt = { { &T_const_unsigned_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:7", "*dststt", CODE_FOR_vlfiiD_load, B_UID(434), NULL };
static struct builtin B8_vec_dststt = { { &T_const_unsigned_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:8", "*dststt", CODE_FOR_vlfiiD_load, B_UID(435), NULL };
static struct builtin B9_vec_dststt = { { &T_const_unsigned_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:9", "*dststt", CODE_FOR_vlfiiD_load, B_UID(436), NULL };
static struct builtin B10_vec_dststt = { { &T_const_vec_b16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:10", "*dststt", CODE_FOR_vlfiiD_load, B_UID(437), NULL };
static struct builtin B11_vec_dststt = { { &T_const_vec_b32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:11", "*dststt", CODE_FOR_vlfiiD_load, B_UID(438), NULL };
static struct builtin B12_vec_dststt = { { &T_const_vec_b8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:12", "*dststt", CODE_FOR_vlfiiD_load, B_UID(439), NULL };
static struct builtin B13_vec_dststt = { { &T_const_vec_f32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:13", "*dststt", CODE_FOR_vlfiiD_load, B_UID(440), NULL };
static struct builtin B14_vec_dststt = { { &T_const_vec_p16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:14", "*dststt", CODE_FOR_vlfiiD_load, B_UID(441), NULL };
static struct builtin B15_vec_dststt = { { &T_const_vec_s16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:15", "*dststt", CODE_FOR_vlfiiD_load, B_UID(442), NULL };
static struct builtin B16_vec_dststt = { { &T_const_vec_s32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:16", "*dststt", CODE_FOR_vlfiiD_load, B_UID(443), NULL };
static struct builtin B17_vec_dststt = { { &T_const_vec_s8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:17", "*dststt", CODE_FOR_vlfiiD_load, B_UID(444), NULL };
static struct builtin B18_vec_dststt = { { &T_const_vec_u16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:18", "*dststt", CODE_FOR_vlfiiD_load, B_UID(445), NULL };
static struct builtin B19_vec_dststt = { { &T_const_vec_u32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:19", "*dststt", CODE_FOR_vlfiiD_load, B_UID(446), NULL };
static struct builtin B20_vec_dststt = { { &T_const_vec_u8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dststt:20", "*dststt", CODE_FOR_vlfiiD_load, B_UID(447), NULL };
static struct builtin B1_vec_dstt = { { &T_const_float_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:1", "*dstt", CODE_FOR_vlfiiD_load, B_UID(448), NULL };
static struct builtin B2_vec_dstt = { { &T_const_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:2", "*dstt", CODE_FOR_vlfiiD_load, B_UID(449), NULL };
static struct builtin B3_vec_dstt = { { &T_const_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:3", "*dstt", CODE_FOR_vlfiiD_load, B_UID(450), NULL };
static struct builtin B4_vec_dstt = { { &T_const_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:4", "*dstt", CODE_FOR_vlfiiD_load, B_UID(451), NULL };
static struct builtin B5_vec_dstt = { { &T_const_signed_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:5", "*dstt", CODE_FOR_vlfiiD_load, B_UID(452), NULL };
static struct builtin B6_vec_dstt = { { &T_const_unsigned_char_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:6", "*dstt", CODE_FOR_vlfiiD_load, B_UID(453), NULL };
static struct builtin B7_vec_dstt = { { &T_const_unsigned_int_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:7", "*dstt", CODE_FOR_vlfiiD_load, B_UID(454), NULL };
static struct builtin B8_vec_dstt = { { &T_const_unsigned_long_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:8", "*dstt", CODE_FOR_vlfiiD_load, B_UID(455), NULL };
static struct builtin B9_vec_dstt = { { &T_const_unsigned_short_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:9", "*dstt", CODE_FOR_vlfiiD_load, B_UID(456), NULL };
static struct builtin B10_vec_dstt = { { &T_const_vec_b16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:10", "*dstt", CODE_FOR_vlfiiD_load, B_UID(457), NULL };
static struct builtin B11_vec_dstt = { { &T_const_vec_b32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:11", "*dstt", CODE_FOR_vlfiiD_load, B_UID(458), NULL };
static struct builtin B12_vec_dstt = { { &T_const_vec_b8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:12", "*dstt", CODE_FOR_vlfiiD_load, B_UID(459), NULL };
static struct builtin B13_vec_dstt = { { &T_const_vec_f32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:13", "*dstt", CODE_FOR_vlfiiD_load, B_UID(460), NULL };
static struct builtin B14_vec_dstt = { { &T_const_vec_p16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:14", "*dstt", CODE_FOR_vlfiiD_load, B_UID(461), NULL };
static struct builtin B15_vec_dstt = { { &T_const_vec_s16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:15", "*dstt", CODE_FOR_vlfiiD_load, B_UID(462), NULL };
static struct builtin B16_vec_dstt = { { &T_const_vec_s32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:16", "*dstt", CODE_FOR_vlfiiD_load, B_UID(463), NULL };
static struct builtin B17_vec_dstt = { { &T_const_vec_s8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:17", "*dstt", CODE_FOR_vlfiiD_load, B_UID(464), NULL };
static struct builtin B18_vec_dstt = { { &T_const_vec_u16_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:18", "*dstt", CODE_FOR_vlfiiD_load, B_UID(465), NULL };
static struct builtin B19_vec_dstt = { { &T_const_vec_u32_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:19", "*dstt", CODE_FOR_vlfiiD_load, B_UID(466), NULL };
static struct builtin B20_vec_dstt = { { &T_const_vec_u8_ptr, &T_int, &T_immed_u2, }, "iiD", &T_volatile_void, 3, TRUE, FALSE, 0, "vec_dstt:20", "*dstt", CODE_FOR_vlfiiD_load, B_UID(467), NULL };
...
static struct builtin B1_vec_lvx = { { &T_int, &T_const_float_ptr, NULL, }, "ii", &T_vec_f32, 2, TRUE, FALSE, 0, "vec_lvx:1", "*lvx", CODE_FOR_xlfii_load, B_UID(470), NULL };
static struct builtin B2_vec_lvx = { { &T_int, &T_const_int_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvx:2", "*lvx", CODE_FOR_xlfii_load, B_UID(471), NULL };
static struct builtin B3_vec_lvx = { { &T_int, &T_const_long_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvx:3", "*lvx", CODE_FOR_xlfii_load, B_UID(472), NULL };
static struct builtin B4_vec_lvx = { { &T_int, &T_const_short_ptr, NULL, }, "ii", &T_vec_s16, 2, TRUE, FALSE, 0, "vec_lvx:4", "*lvx", CODE_FOR_xlfii_load, B_UID(473), NULL };
static struct builtin B5_vec_lvx = { { &T_int, &T_const_signed_char_ptr, NULL, }, "ii", &T_vec_s8, 2, TRUE, FALSE, 0, "vec_lvx:5", "*lvx", CODE_FOR_xlfii_load, B_UID(474), NULL };
static struct builtin B6_vec_lvx = { { &T_int, &T_const_unsigned_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, FALSE, 0, "vec_lvx:6", "*lvx", CODE_FOR_xlfii_load, B_UID(475), NULL };
static struct builtin B7_vec_lvx = { { &T_int, &T_const_unsigned_int_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvx:7", "*lvx", CODE_FOR_xlfii_load, B_UID(476), NULL };
static struct builtin B8_vec_lvx = { { &T_int, &T_const_unsigned_long_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvx:8", "*lvx", CODE_FOR_xlfii_load, B_UID(477), NULL };
static struct builtin B9_vec_lvx = { { &T_int, &T_const_unsigned_short_ptr, NULL, }, "ii", &T_vec_u16, 2, TRUE, FALSE, 0, "vec_lvx:9", "*lvx", CODE_FOR_xlfii_load, B_UID(478), NULL };
static struct builtin B10_vec_lvx = { { &T_int, &T_const_vec_b16_ptr, NULL, }, "ii", &T_vec_b16, 2, TRUE, FALSE, 0, "vec_lvx:10", "*lvx", CODE_FOR_xlfii_load, B_UID(479), NULL };
static struct builtin B11_vec_lvx = { { &T_int, &T_const_vec_b32_ptr, NULL, }, "ii", &T_vec_b32, 2, TRUE, FALSE, 0, "vec_lvx:11", "*lvx", CODE_FOR_xlfii_load, B_UID(480), NULL };
static struct builtin B12_vec_lvx = { { &T_int, &T_const_vec_b8_ptr, NULL, }, "ii", &T_vec_b8, 2, TRUE, FALSE, 0, "vec_lvx:12", "*lvx", CODE_FOR_xlfii_load, B_UID(481), NULL };
static struct builtin B13_vec_lvx = { { &T_int, &T_const_vec_f32_ptr, NULL, }, "ii", &T_vec_f32, 2, TRUE, FALSE, 0, "vec_lvx:13", "*lvx", CODE_FOR_xlfii_load, B_UID(482), NULL };
static struct builtin B14_vec_lvx = { { &T_int, &T_const_vec_p16_ptr, NULL, }, "ii", &T_vec_p16, 2, TRUE, FALSE, 0, "vec_lvx:14", "*lvx", CODE_FOR_xlfii_load, B_UID(483), NULL };
static struct builtin B15_vec_lvx = { { &T_int, &T_const_vec_s16_ptr, NULL, }, "ii", &T_vec_s16, 2, TRUE, FALSE, 0, "vec_lvx:15", "*lvx", CODE_FOR_xlfii_load, B_UID(484), NULL };
static struct builtin B16_vec_lvx = { { &T_int, &T_const_vec_s32_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvx:16", "*lvx", CODE_FOR_xlfii_load, B_UID(485), NULL };
static struct builtin B17_vec_lvx = { { &T_int, &T_const_vec_s8_ptr, NULL, }, "ii", &T_vec_s8, 2, TRUE, FALSE, 0, "vec_lvx:17", "*lvx", CODE_FOR_xlfii_load, B_UID(486), NULL };
static struct builtin B18_vec_lvx = { { &T_int, &T_const_vec_u16_ptr, NULL, }, "ii", &T_vec_u16, 2, TRUE, FALSE, 0, "vec_lvx:18", "*lvx", CODE_FOR_xlfii_load, B_UID(487), NULL };
static struct builtin B19_vec_lvx = { { &T_int, &T_const_vec_u32_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvx:19", "*lvx", CODE_FOR_xlfii_load, B_UID(488), NULL };
static struct builtin B20_vec_lvx = { { &T_int, &T_const_vec_u8_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, FALSE, 0, "vec_lvx:20", "*lvx", CODE_FOR_xlfii_load, B_UID(489), NULL };
static struct builtin B1_vec_lvewx = { { &T_int, &T_const_float_ptr, NULL, }, "ii", &T_vec_f32, 2, TRUE, FALSE, 0, "vec_lvewx:1", "*lvewx", CODE_FOR_xlfii_load, B_UID(490), NULL };
static struct builtin B2_vec_lvewx = { { &T_int, &T_const_int_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvewx:2", "*lvewx", CODE_FOR_xlfii_load, B_UID(491), NULL };
static struct builtin B3_vec_lvewx = { { &T_int, &T_const_long_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvewx:3", "*lvewx", CODE_FOR_xlfii_load, B_UID(492), NULL };
static struct builtin B1_vec_lvehx = { { &T_int, &T_const_short_ptr, NULL, }, "ii", &T_vec_s16, 2, TRUE, FALSE, 0, "vec_lvehx:1", "*lvehx", CODE_FOR_xlfii_load, B_UID(493), NULL };
static struct builtin B1_vec_lvebx = { { &T_int, &T_const_signed_char_ptr, NULL, }, "ii", &T_vec_s8, 2, TRUE, FALSE, 0, "vec_lvebx:1", "*lvebx", CODE_FOR_xlfii_load, B_UID(494), NULL };
static struct builtin B2_vec_lvebx = { { &T_int, &T_const_unsigned_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, FALSE, 0, "vec_lvebx:2", "*lvebx", CODE_FOR_xlfii_load, B_UID(495), NULL };
static struct builtin B4_vec_lvewx = { { &T_int, &T_const_unsigned_int_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvewx:4", "*lvewx", CODE_FOR_xlfii_load, B_UID(496), NULL };
static struct builtin B5_vec_lvewx = { { &T_int, &T_const_unsigned_long_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvewx:5", "*lvewx", CODE_FOR_xlfii_load, B_UID(497), NULL };
static struct builtin B2_vec_lvehx = { { &T_int, &T_const_unsigned_short_ptr, NULL, }, "ii", &T_vec_u16, 2, TRUE, FALSE, 0, "vec_lvehx:2", "*lvehx", CODE_FOR_xlfii_load, B_UID(498), NULL };
static struct builtin B1_vec_lvxl = { { &T_int, &T_const_float_ptr, NULL, }, "ii", &T_vec_f32, 2, TRUE, FALSE, 0, "vec_lvxl:1", "*lvxl", CODE_FOR_xlfii_load, B_UID(499), NULL };
static struct builtin B2_vec_lvxl = { { &T_int, &T_const_int_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvxl:2", "*lvxl", CODE_FOR_xlfii_load, B_UID(500), NULL };
static struct builtin B3_vec_lvxl = { { &T_int, &T_const_long_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvxl:3", "*lvxl", CODE_FOR_xlfii_load, B_UID(501), NULL };
static struct builtin B4_vec_lvxl = { { &T_int, &T_const_short_ptr, NULL, }, "ii", &T_vec_s16, 2, TRUE, FALSE, 0, "vec_lvxl:4", "*lvxl", CODE_FOR_xlfii_load, B_UID(502), NULL };
static struct builtin B5_vec_lvxl = { { &T_int, &T_const_signed_char_ptr, NULL, }, "ii", &T_vec_s8, 2, TRUE, FALSE, 0, "vec_lvxl:5", "*lvxl", CODE_FOR_xlfii_load, B_UID(503), NULL };
static struct builtin B6_vec_lvxl = { { &T_int, &T_const_unsigned_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, FALSE, 0, "vec_lvxl:6", "*lvxl", CODE_FOR_xlfii_load, B_UID(504), NULL };
static struct builtin B7_vec_lvxl = { { &T_int, &T_const_unsigned_int_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvxl:7", "*lvxl", CODE_FOR_xlfii_load, B_UID(505), NULL };
static struct builtin B8_vec_lvxl = { { &T_int, &T_const_unsigned_long_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvxl:8", "*lvxl", CODE_FOR_xlfii_load, B_UID(506), NULL };
static struct builtin B9_vec_lvxl = { { &T_int, &T_const_unsigned_short_ptr, NULL, }, "ii", &T_vec_u16, 2, TRUE, FALSE, 0, "vec_lvxl:9", "*lvxl", CODE_FOR_xlfii_load, B_UID(507), NULL };
static struct builtin B10_vec_lvxl = { { &T_int, &T_const_vec_b16_ptr, NULL, }, "ii", &T_vec_b16, 2, TRUE, FALSE, 0, "vec_lvxl:10", "*lvxl", CODE_FOR_xlfii_load, B_UID(508), NULL };
static struct builtin B11_vec_lvxl = { { &T_int, &T_const_vec_b32_ptr, NULL, }, "ii", &T_vec_b32, 2, TRUE, FALSE, 0, "vec_lvxl:11", "*lvxl", CODE_FOR_xlfii_load, B_UID(509), NULL };
static struct builtin B12_vec_lvxl = { { &T_int, &T_const_vec_b8_ptr, NULL, }, "ii", &T_vec_b8, 2, TRUE, FALSE, 0, "vec_lvxl:12", "*lvxl", CODE_FOR_xlfii_load, B_UID(510), NULL };
static struct builtin B13_vec_lvxl = { { &T_int, &T_const_vec_f32_ptr, NULL, }, "ii", &T_vec_f32, 2, TRUE, FALSE, 0, "vec_lvxl:13", "*lvxl", CODE_FOR_xlfii_load, B_UID(511), NULL };
static struct builtin B14_vec_lvxl = { { &T_int, &T_const_vec_p16_ptr, NULL, }, "ii", &T_vec_p16, 2, TRUE, FALSE, 0, "vec_lvxl:14", "*lvxl", CODE_FOR_xlfii_load, B_UID(512), NULL };
static struct builtin B15_vec_lvxl = { { &T_int, &T_const_vec_s16_ptr, NULL, }, "ii", &T_vec_s16, 2, TRUE, FALSE, 0, "vec_lvxl:15", "*lvxl", CODE_FOR_xlfii_load, B_UID(513), NULL };
static struct builtin B16_vec_lvxl = { { &T_int, &T_const_vec_s32_ptr, NULL, }, "ii", &T_vec_s32, 2, TRUE, FALSE, 0, "vec_lvxl:16", "*lvxl", CODE_FOR_xlfii_load, B_UID(514), NULL };
static struct builtin B17_vec_lvxl = { { &T_int, &T_const_vec_s8_ptr, NULL, }, "ii", &T_vec_s8, 2, TRUE, FALSE, 0, "vec_lvxl:17", "*lvxl", CODE_FOR_xlfii_load, B_UID(515), NULL };
static struct builtin B18_vec_lvxl = { { &T_int, &T_const_vec_u16_ptr, NULL, }, "ii", &T_vec_u16, 2, TRUE, FALSE, 0, "vec_lvxl:18", "*lvxl", CODE_FOR_xlfii_load, B_UID(516), NULL };
static struct builtin B19_vec_lvxl = { { &T_int, &T_const_vec_u32_ptr, NULL, }, "ii", &T_vec_u32, 2, TRUE, FALSE, 0, "vec_lvxl:19", "*lvxl", CODE_FOR_xlfii_load, B_UID(517), NULL };
static struct builtin B20_vec_lvxl = { { &T_int, &T_const_vec_u8_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, FALSE, 0, "vec_lvxl:20", "*lvxl", CODE_FOR_xlfii_load, B_UID(518), NULL };
...
static struct builtin B1_vec_lvsl = { { &T_int, &T_const_volatile_float_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:1", "*lvsl", CODE_FOR_xfii_load, B_UID(520), NULL };
static struct builtin B2_vec_lvsl = { { &T_int, &T_const_volatile_int_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:2", "*lvsl", CODE_FOR_xfii_load, B_UID(521), NULL };
static struct builtin B3_vec_lvsl = { { &T_int, &T_const_volatile_long_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:3", "*lvsl", CODE_FOR_xfii_load, B_UID(522), NULL };
static struct builtin B4_vec_lvsl = { { &T_int, &T_const_volatile_short_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:4", "*lvsl", CODE_FOR_xfii_load, B_UID(523), NULL };
static struct builtin B5_vec_lvsl = { { &T_int, &T_const_volatile_signed_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:5", "*lvsl", CODE_FOR_xfii_load, B_UID(524), NULL };
static struct builtin B6_vec_lvsl = { { &T_int, &T_const_volatile_unsigned_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:6", "*lvsl", CODE_FOR_xfii_load, B_UID(525), NULL };
static struct builtin B7_vec_lvsl = { { &T_int, &T_const_volatile_unsigned_int_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:7", "*lvsl", CODE_FOR_xfii_load, B_UID(526), NULL };
static struct builtin B8_vec_lvsl = { { &T_int, &T_const_volatile_unsigned_long_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:8", "*lvsl", CODE_FOR_xfii_load, B_UID(527), NULL };
static struct builtin B9_vec_lvsl = { { &T_int, &T_const_volatile_unsigned_short_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 8, "vec_lvsl:9", "*lvsl", CODE_FOR_xfii_load, B_UID(528), NULL };
static struct builtin B1_vec_lvsr = { { &T_int, &T_const_volatile_float_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:1", "*lvsr", CODE_FOR_xfii_load, B_UID(529), NULL };
static struct builtin B2_vec_lvsr = { { &T_int, &T_const_volatile_int_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:2", "*lvsr", CODE_FOR_xfii_load, B_UID(530), NULL };
static struct builtin B3_vec_lvsr = { { &T_int, &T_const_volatile_long_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:3", "*lvsr", CODE_FOR_xfii_load, B_UID(531), NULL };
static struct builtin B4_vec_lvsr = { { &T_int, &T_const_volatile_short_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:4", "*lvsr", CODE_FOR_xfii_load, B_UID(532), NULL };
static struct builtin B5_vec_lvsr = { { &T_int, &T_const_volatile_signed_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:5", "*lvsr", CODE_FOR_xfii_load, B_UID(533), NULL };
static struct builtin B6_vec_lvsr = { { &T_int, &T_const_volatile_unsigned_char_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:6", "*lvsr", CODE_FOR_xfii_load, B_UID(534), NULL };
static struct builtin B7_vec_lvsr = { { &T_int, &T_const_volatile_unsigned_int_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:7", "*lvsr", CODE_FOR_xfii_load, B_UID(535), NULL };
static struct builtin B8_vec_lvsr = { { &T_int, &T_const_volatile_unsigned_long_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:8", "*lvsr", CODE_FOR_xfii_load, B_UID(536), NULL };
static struct builtin B9_vec_lvsr = { { &T_int, &T_const_volatile_unsigned_short_ptr, NULL, }, "ii", &T_vec_u8, 2, TRUE, TRUE, 9, "vec_lvsr:9", "*lvsr", CODE_FOR_xfii_load, B_UID(537), NULL };
...
static struct builtin B1_vec_stvx = { { &T_vec_b16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:1", "*stvx", CODE_FOR_sfxii_store, B_UID(853), NULL };
static struct builtin B2_vec_stvx = { { &T_vec_b16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:2", "*stvx", CODE_FOR_sfxii_store, B_UID(854), NULL };
static struct builtin B3_vec_stvx = { { &T_vec_b16, &T_int, &T_vec_b16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:3", "*stvx", CODE_FOR_sfxii_store, B_UID(855), NULL };
static struct builtin B4_vec_stvx = { { &T_vec_b32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:4", "*stvx", CODE_FOR_sfxii_store, B_UID(856), NULL };
static struct builtin B5_vec_stvx = { { &T_vec_b32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:5", "*stvx", CODE_FOR_sfxii_store, B_UID(857), NULL };
static struct builtin B6_vec_stvx = { { &T_vec_b32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:6", "*stvx", CODE_FOR_sfxii_store, B_UID(858), NULL };
static struct builtin B7_vec_stvx = { { &T_vec_b32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:7", "*stvx", CODE_FOR_sfxii_store, B_UID(859), NULL };
static struct builtin B8_vec_stvx = { { &T_vec_b32, &T_int, &T_vec_b32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:8", "*stvx", CODE_FOR_sfxii_store, B_UID(860), NULL };
static struct builtin B9_vec_stvx = { { &T_vec_b8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:9", "*stvx", CODE_FOR_sfxii_store, B_UID(861), NULL };
static struct builtin B10_vec_stvx = { { &T_vec_b8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:10", "*stvx", CODE_FOR_sfxii_store, B_UID(862), NULL };
static struct builtin B11_vec_stvx = { { &T_vec_b8, &T_int, &T_vec_b8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:11", "*stvx", CODE_FOR_sfxii_store, B_UID(863), NULL };
static struct builtin B12_vec_stvx = { { &T_vec_f32, &T_int, &T_float_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:12", "*stvx", CODE_FOR_sfxii_store, B_UID(864), NULL };
static struct builtin B13_vec_stvx = { { &T_vec_f32, &T_int, &T_vec_f32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:13", "*stvx", CODE_FOR_sfxii_store, B_UID(865), NULL };
static struct builtin B14_vec_stvx = { { &T_vec_p16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:14", "*stvx", CODE_FOR_sfxii_store, B_UID(866), NULL };
static struct builtin B15_vec_stvx = { { &T_vec_p16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:15", "*stvx", CODE_FOR_sfxii_store, B_UID(867), NULL };
static struct builtin B16_vec_stvx = { { &T_vec_p16, &T_int, &T_vec_p16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:16", "*stvx", CODE_FOR_sfxii_store, B_UID(868), NULL };
static struct builtin B17_vec_stvx = { { &T_vec_s16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:17", "*stvx", CODE_FOR_sfxii_store, B_UID(869), NULL };
static struct builtin B18_vec_stvx = { { &T_vec_s16, &T_int, &T_vec_s16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:18", "*stvx", CODE_FOR_sfxii_store, B_UID(870), NULL };
static struct builtin B19_vec_stvx = { { &T_vec_s32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:19", "*stvx", CODE_FOR_sfxii_store, B_UID(871), NULL };
static struct builtin B20_vec_stvx = { { &T_vec_s32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:20", "*stvx", CODE_FOR_sfxii_store, B_UID(872), NULL };
static struct builtin B21_vec_stvx = { { &T_vec_s32, &T_int, &T_vec_s32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:21", "*stvx", CODE_FOR_sfxii_store, B_UID(873), NULL };
static struct builtin B22_vec_stvx = { { &T_vec_s8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:22", "*stvx", CODE_FOR_sfxii_store, B_UID(874), NULL };
static struct builtin B23_vec_stvx = { { &T_vec_s8, &T_int, &T_vec_s8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:23", "*stvx", CODE_FOR_sfxii_store, B_UID(875), NULL };
static struct builtin B24_vec_stvx = { { &T_vec_u16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:24", "*stvx", CODE_FOR_sfxii_store, B_UID(876), NULL };
static struct builtin B25_vec_stvx = { { &T_vec_u16, &T_int, &T_vec_u16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:25", "*stvx", CODE_FOR_sfxii_store, B_UID(877), NULL };
static struct builtin B26_vec_stvx = { { &T_vec_u32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:26", "*stvx", CODE_FOR_sfxii_store, B_UID(878), NULL };
static struct builtin B27_vec_stvx = { { &T_vec_u32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:27", "*stvx", CODE_FOR_sfxii_store, B_UID(879), NULL };
static struct builtin B28_vec_stvx = { { &T_vec_u32, &T_int, &T_vec_u32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:28", "*stvx", CODE_FOR_sfxii_store, B_UID(880), NULL };
static struct builtin B29_vec_stvx = { { &T_vec_u8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:29", "*stvx", CODE_FOR_sfxii_store, B_UID(881), NULL };
static struct builtin B30_vec_stvx = { { &T_vec_u8, &T_int, &T_vec_u8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvx:30", "*stvx", CODE_FOR_sfxii_store, B_UID(882), NULL };
static struct builtin B1_vec_stvebx = { { &T_vec_b16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:1", "*stvebx", CODE_FOR_sfxii_store, B_UID(883), NULL };
static struct builtin B2_vec_stvebx = { { &T_vec_b16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:2", "*stvebx", CODE_FOR_sfxii_store, B_UID(884), NULL };
static struct builtin B1_vec_stvewx = { { &T_vec_b32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:1", "*stvewx", CODE_FOR_sfxii_store, B_UID(885), NULL };
static struct builtin B2_vec_stvewx = { { &T_vec_b32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:2", "*stvewx", CODE_FOR_sfxii_store, B_UID(886), NULL };
static struct builtin B3_vec_stvewx = { { &T_vec_b32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:3", "*stvewx", CODE_FOR_sfxii_store, B_UID(887), NULL };
static struct builtin B4_vec_stvewx = { { &T_vec_b32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:4", "*stvewx", CODE_FOR_sfxii_store, B_UID(888), NULL };
static struct builtin B3_vec_stvebx = { { &T_vec_b8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:3", "*stvebx", CODE_FOR_sfxii_store, B_UID(889), NULL };
static struct builtin B4_vec_stvebx = { { &T_vec_b8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:4", "*stvebx", CODE_FOR_sfxii_store, B_UID(890), NULL };
static struct builtin B5_vec_stvewx = { { &T_vec_f32, &T_int, &T_float_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:5", "*stvewx", CODE_FOR_sfxii_store, B_UID(891), NULL };
static struct builtin B1_vec_stvehx = { { &T_vec_p16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvehx:1", "*stvehx", CODE_FOR_sfxii_store, B_UID(892), NULL };
static struct builtin B2_vec_stvehx = { { &T_vec_p16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvehx:2", "*stvehx", CODE_FOR_sfxii_store, B_UID(893), NULL };
static struct builtin B3_vec_stvehx = { { &T_vec_s16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvehx:3", "*stvehx", CODE_FOR_sfxii_store, B_UID(894), NULL };
static struct builtin B6_vec_stvewx = { { &T_vec_s32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:6", "*stvewx", CODE_FOR_sfxii_store, B_UID(895), NULL };
static struct builtin B7_vec_stvewx = { { &T_vec_s32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:7", "*stvewx", CODE_FOR_sfxii_store, B_UID(896), NULL };
static struct builtin B5_vec_stvebx = { { &T_vec_s8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:5", "*stvebx", CODE_FOR_sfxii_store, B_UID(897), NULL };
static struct builtin B4_vec_stvehx = { { &T_vec_u16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvehx:4", "*stvehx", CODE_FOR_sfxii_store, B_UID(898), NULL };
static struct builtin B8_vec_stvewx = { { &T_vec_u32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:8", "*stvewx", CODE_FOR_sfxii_store, B_UID(899), NULL };
static struct builtin B9_vec_stvewx = { { &T_vec_u32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvewx:9", "*stvewx", CODE_FOR_sfxii_store, B_UID(900), NULL };
static struct builtin B6_vec_stvebx = { { &T_vec_u8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvebx:6", "*stvebx", CODE_FOR_sfxii_store, B_UID(901), NULL };
static struct builtin B1_vec_stvxl = { { &T_vec_b16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:1", "*stvxl", CODE_FOR_sfxii_store, B_UID(902), NULL };
static struct builtin B2_vec_stvxl = { { &T_vec_b16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:2", "*stvxl", CODE_FOR_sfxii_store, B_UID(903), NULL };
static struct builtin B3_vec_stvxl = { { &T_vec_b16, &T_int, &T_vec_b16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:3", "*stvxl", CODE_FOR_sfxii_store, B_UID(904), NULL };
static struct builtin B4_vec_stvxl = { { &T_vec_b32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:4", "*stvxl", CODE_FOR_sfxii_store, B_UID(905), NULL };
static struct builtin B5_vec_stvxl = { { &T_vec_b32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:5", "*stvxl", CODE_FOR_sfxii_store, B_UID(906), NULL };
static struct builtin B6_vec_stvxl = { { &T_vec_b32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:6", "*stvxl", CODE_FOR_sfxii_store, B_UID(907), NULL };
static struct builtin B7_vec_stvxl = { { &T_vec_b32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:7", "*stvxl", CODE_FOR_sfxii_store, B_UID(908), NULL };
static struct builtin B8_vec_stvxl = { { &T_vec_b32, &T_int, &T_vec_b32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:8", "*stvxl", CODE_FOR_sfxii_store, B_UID(909), NULL };
static struct builtin B9_vec_stvxl = { { &T_vec_b8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:9", "*stvxl", CODE_FOR_sfxii_store, B_UID(910), NULL };
static struct builtin B10_vec_stvxl = { { &T_vec_b8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:10", "*stvxl", CODE_FOR_sfxii_store, B_UID(911), NULL };
static struct builtin B11_vec_stvxl = { { &T_vec_b8, &T_int, &T_vec_b8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:11", "*stvxl", CODE_FOR_sfxii_store, B_UID(912), NULL };
static struct builtin B12_vec_stvxl = { { &T_vec_f32, &T_int, &T_float_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:12", "*stvxl", CODE_FOR_sfxii_store, B_UID(913), NULL };
static struct builtin B13_vec_stvxl = { { &T_vec_f32, &T_int, &T_vec_f32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:13", "*stvxl", CODE_FOR_sfxii_store, B_UID(914), NULL };
static struct builtin B14_vec_stvxl = { { &T_vec_p16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:14", "*stvxl", CODE_FOR_sfxii_store, B_UID(915), NULL };
static struct builtin B15_vec_stvxl = { { &T_vec_p16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:15", "*stvxl", CODE_FOR_sfxii_store, B_UID(916), NULL };
static struct builtin B16_vec_stvxl = { { &T_vec_p16, &T_int, &T_vec_p16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:16", "*stvxl", CODE_FOR_sfxii_store, B_UID(917), NULL };
static struct builtin B17_vec_stvxl = { { &T_vec_s16, &T_int, &T_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:17", "*stvxl", CODE_FOR_sfxii_store, B_UID(918), NULL };
static struct builtin B18_vec_stvxl = { { &T_vec_s16, &T_int, &T_vec_s16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:18", "*stvxl", CODE_FOR_sfxii_store, B_UID(919), NULL };
static struct builtin B19_vec_stvxl = { { &T_vec_s32, &T_int, &T_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:19", "*stvxl", CODE_FOR_sfxii_store, B_UID(920), NULL };
static struct builtin B20_vec_stvxl = { { &T_vec_s32, &T_int, &T_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:20", "*stvxl", CODE_FOR_sfxii_store, B_UID(921), NULL };
static struct builtin B21_vec_stvxl = { { &T_vec_s32, &T_int, &T_vec_s32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:21", "*stvxl", CODE_FOR_sfxii_store, B_UID(922), NULL };
static struct builtin B22_vec_stvxl = { { &T_vec_s8, &T_int, &T_signed_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:22", "*stvxl", CODE_FOR_sfxii_store, B_UID(923), NULL };
static struct builtin B23_vec_stvxl = { { &T_vec_s8, &T_int, &T_vec_s8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:23", "*stvxl", CODE_FOR_sfxii_store, B_UID(924), NULL };
static struct builtin B24_vec_stvxl = { { &T_vec_u16, &T_int, &T_unsigned_short_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:24", "*stvxl", CODE_FOR_sfxii_store, B_UID(925), NULL };
static struct builtin B25_vec_stvxl = { { &T_vec_u16, &T_int, &T_vec_u16_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:25", "*stvxl", CODE_FOR_sfxii_store, B_UID(926), NULL };
static struct builtin B26_vec_stvxl = { { &T_vec_u32, &T_int, &T_unsigned_int_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:26", "*stvxl", CODE_FOR_sfxii_store, B_UID(927), NULL };
static struct builtin B27_vec_stvxl = { { &T_vec_u32, &T_int, &T_unsigned_long_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:27", "*stvxl", CODE_FOR_sfxii_store, B_UID(928), NULL };
static struct builtin B28_vec_stvxl = { { &T_vec_u32, &T_int, &T_vec_u32_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:28", "*stvxl", CODE_FOR_sfxii_store, B_UID(929), NULL };
static struct builtin B29_vec_stvxl = { { &T_vec_u8, &T_int, &T_unsigned_char_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:29", "*stvxl", CODE_FOR_sfxii_store, B_UID(930), NULL };
static struct builtin B30_vec_stvxl = { { &T_vec_u8, &T_int, &T_vec_u8_ptr, }, "xii", &T_void, 3, FALSE, FALSE, 0, "vec_stvxl:30", "*stvxl", CODE_FOR_sfxii_store, B_UID(931), NULL };
static struct builtin B1_vec_vsubuhm = { { &T_vec_b16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubuhm:1", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(932), NULL };
static struct builtin B2_vec_vsubuhm = { { &T_vec_b16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhm:2", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(933), NULL };
static struct builtin B1_vec_vsubuwm = { { &T_vec_b32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubuwm:1", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(934), NULL };
static struct builtin B2_vec_vsubuwm = { { &T_vec_b32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuwm:2", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(935), NULL };
static struct builtin B1_vec_vsububm = { { &T_vec_b8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsububm:1", "*vsububm", CODE_FOR_xfxx_simple, B_UID(936), NULL };
static struct builtin B2_vec_vsububm = { { &T_vec_b8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububm:2", "*vsububm", CODE_FOR_xfxx_simple, B_UID(937), NULL };
static struct builtin B_vec_vsubfp = { { &T_vec_f32, &T_vec_f32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vsubfp", "*vsubfp", CODE_FOR_xfxx_fp, B_UID(938), NULL };
static struct builtin B3_vec_vsubuhm = { { &T_vec_s16, &T_vec_b16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubuhm:3", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(939), NULL };
static struct builtin B4_vec_vsubuhm = { { &T_vec_s16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubuhm:4", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(940), NULL };
static struct builtin B3_vec_vsubuwm = { { &T_vec_s32, &T_vec_b32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubuwm:3", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(941), NULL };
static struct builtin B4_vec_vsubuwm = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubuwm:4", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(942), NULL };
static struct builtin B3_vec_vsububm = { { &T_vec_s8, &T_vec_b8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsububm:3", "*vsububm", CODE_FOR_xfxx_simple, B_UID(943), NULL };
static struct builtin B4_vec_vsububm = { { &T_vec_s8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsububm:4", "*vsububm", CODE_FOR_xfxx_simple, B_UID(944), NULL };
static struct builtin B5_vec_vsubuhm = { { &T_vec_u16, &T_vec_b16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhm:5", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(945), NULL };
static struct builtin B6_vec_vsubuhm = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhm:6", "*vsubuhm", CODE_FOR_xfxx_simple, B_UID(946), NULL };
static struct builtin B5_vec_vsubuwm = { { &T_vec_u32, &T_vec_b32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuwm:5", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(947), NULL };
static struct builtin B6_vec_vsubuwm = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuwm:6", "*vsubuwm", CODE_FOR_xfxx_simple, B_UID(948), NULL };
static struct builtin B5_vec_vsububm = { { &T_vec_u8, &T_vec_b8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububm:5", "*vsububm", CODE_FOR_xfxx_simple, B_UID(949), NULL };
static struct builtin B6_vec_vsububm = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububm:6", "*vsububm", CODE_FOR_xfxx_simple, B_UID(950), NULL };
static struct builtin B_vec_vsubcuw = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_vsubcuw", "*vsubcuw", CODE_FOR_xfxx_simple, B_UID(951), NULL };
static struct builtin B1_vec_vsubshs = { { &T_vec_b16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubshs:1", "*vsubshs", CODE_FOR_xfxx_simple, B_UID(952), NULL };
static struct builtin B1_vec_vsubuhs = { { &T_vec_b16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhs:1", "*vsubuhs", CODE_FOR_xfxx_simple, B_UID(953), NULL };
static struct builtin B1_vec_vsubsws = { { &T_vec_b32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubsws:1", "*vsubsws", CODE_FOR_xfxx_simple, B_UID(954), NULL };
static struct builtin B1_vec_vsubuws = { { &T_vec_b32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuws:1", "*vsubuws", CODE_FOR_xfxx_simple, B_UID(955), NULL };
static struct builtin B1_vec_vsubsbs = { { &T_vec_b8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsubsbs:1", "*vsubsbs", CODE_FOR_xfxx_simple, B_UID(956), NULL };
static struct builtin B1_vec_vsububs = { { &T_vec_b8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububs:1", "*vsububs", CODE_FOR_xfxx_simple, B_UID(957), NULL };
static struct builtin B2_vec_vsubshs = { { &T_vec_s16, &T_vec_b16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubshs:2", "*vsubshs", CODE_FOR_xfxx_simple, B_UID(958), NULL };
static struct builtin B3_vec_vsubshs = { { &T_vec_s16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vsubshs:3", "*vsubshs", CODE_FOR_xfxx_simple, B_UID(959), NULL };
static struct builtin B2_vec_vsubsws = { { &T_vec_s32, &T_vec_b32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubsws:2", "*vsubsws", CODE_FOR_xfxx_simple, B_UID(960), NULL };
static struct builtin B3_vec_vsubsws = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vsubsws:3", "*vsubsws", CODE_FOR_xfxx_simple, B_UID(961), NULL };
static struct builtin B2_vec_vsubsbs = { { &T_vec_s8, &T_vec_b8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsubsbs:2", "*vsubsbs", CODE_FOR_xfxx_simple, B_UID(962), NULL };
static struct builtin B3_vec_vsubsbs = { { &T_vec_s8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vsubsbs:3", "*vsubsbs", CODE_FOR_xfxx_simple, B_UID(963), NULL };
static struct builtin B2_vec_vsubuhs = { { &T_vec_u16, &T_vec_b16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhs:2", "*vsubuhs", CODE_FOR_xfxx_simple, B_UID(964), NULL };
static struct builtin B3_vec_vsubuhs = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vsubuhs:3", "*vsubuhs", CODE_FOR_xfxx_simple, B_UID(965), NULL };
static struct builtin B2_vec_vsubuws = { { &T_vec_u32, &T_vec_b32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuws:2", "*vsubuws", CODE_FOR_xfxx_simple, B_UID(966), NULL };
static struct builtin B3_vec_vsubuws = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vsubuws:3", "*vsubuws", CODE_FOR_xfxx_simple, B_UID(967), NULL };
static struct builtin B2_vec_vsububs = { { &T_vec_u8, &T_vec_b8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububs:2", "*vsububs", CODE_FOR_xfxx_simple, B_UID(968), NULL };
static struct builtin B3_vec_vsububs = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vsububs:3", "*vsububs", CODE_FOR_xfxx_simple, B_UID(969), NULL };
static struct builtin B_vec_vsum2sws = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_vsum2sws", "*vsum2sws", CODE_FOR_xfxx_complex, B_UID(970), NULL };
static struct builtin B_vec_vsum4shs = { { &T_vec_s16, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_vsum4shs", "*vsum4shs", CODE_FOR_xfxx_complex, B_UID(971), NULL };
static struct builtin B_vec_vsum4sbs = { { &T_vec_s8, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_vsum4sbs", "*vsum4sbs", CODE_FOR_xfxx_complex, B_UID(972), NULL };
static struct builtin B_vec_vsum4ubs = { { &T_vec_u8, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_vsum4ubs", "*vsum4ubs", CODE_FOR_xfxx_complex, B_UID(973), NULL };
static struct builtin B_vec_vsumsws = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_vsumsws", "*vsumsws", CODE_FOR_xfxx_complex, B_UID(974), NULL };
static struct builtin B_vec_vrfiz = { { &T_vec_f32, NULL, NULL, }, "x", &T_vec_f32, 1, FALSE, FALSE, 0, "vec_vrfiz", "*vrfiz", CODE_FOR_xfx_fp, B_UID(975), NULL };
static struct builtin B1_vec_unpack2sh = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_unpack2sh:1", "*vmrghh", CODE_FOR_xfxx_perm, B_UID(976), NULL };
static struct builtin B2_vec_unpack2sh = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 0, "vec_unpack2sh:2", "*vmrghb", CODE_FOR_xfxx_perm, B_UID(977), NULL };
static struct builtin B1_vec_unpack2sl = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 0, "vec_unpack2sl:1", "*vmrglh", CODE_FOR_xfxx_perm, B_UID(978), NULL };
static struct builtin B2_vec_unpack2sl = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 0, "vec_unpack2sl:2", "*vmrglb", CODE_FOR_xfxx_perm, B_UID(979), NULL };
static struct builtin B1_vec_unpack2uh = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_unpack2uh:1", "*vmrghh", CODE_FOR_xfxx_perm, B_UID(980), NULL };
static struct builtin B2_vec_unpack2uh = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 0, "vec_unpack2uh:2", "*vmrghb", CODE_FOR_xfxx_perm, B_UID(981), NULL };
static struct builtin B1_vec_unpack2ul = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 0, "vec_unpack2ul:1", "*vmrglh", CODE_FOR_xfxx_perm, B_UID(982), NULL };
static struct builtin B2_vec_unpack2ul = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 0, "vec_unpack2ul:2", "*vmrglb", CODE_FOR_xfxx_perm, B_UID(983), NULL };
static struct builtin B1_vec_vupkhsh = { { &T_vec_b16, NULL, NULL, }, "x", &T_vec_b32, 1, FALSE, FALSE, 0, "vec_vupkhsh:1", "*vupkhsh", CODE_FOR_xfx_perm, B_UID(984), NULL };
static struct builtin B1_vec_vupkhsb = { { &T_vec_b8, NULL, NULL, }, "x", &T_vec_b16, 1, FALSE, FALSE, 0, "vec_vupkhsb:1", "*vupkhsb", CODE_FOR_xfx_perm, B_UID(985), NULL };
static struct builtin B_vec_vupkhpx = { { &T_vec_p16, NULL, NULL, }, "x", &T_vec_u32, 1, FALSE, FALSE, 0, "vec_vupkhpx", "*vupkhpx", CODE_FOR_xfx_perm, B_UID(986), NULL };
static struct builtin B2_vec_vupkhsh = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 0, "vec_vupkhsh:2", "*vupkhsh", CODE_FOR_xfx_perm, B_UID(987), NULL };
static struct builtin B2_vec_vupkhsb = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 0, "vec_vupkhsb:2", "*vupkhsb", CODE_FOR_xfx_perm, B_UID(988), NULL };
static struct builtin B1_vec_vupklsh = { { &T_vec_b16, NULL, NULL, }, "x", &T_vec_b32, 1, FALSE, FALSE, 0, "vec_vupklsh:1", "*vupklsh", CODE_FOR_xfx_perm, B_UID(989), NULL };
static struct builtin B1_vec_vupklsb = { { &T_vec_b8, NULL, NULL, }, "x", &T_vec_b16, 1, FALSE, FALSE, 0, "vec_vupklsb:1", "*vupklsb", CODE_FOR_xfx_perm, B_UID(990), NULL };
static struct builtin B_vec_vupklpx = { { &T_vec_p16, NULL, NULL, }, "x", &T_vec_u32, 1, FALSE, FALSE, 0, "vec_vupklpx", "*vupklpx", CODE_FOR_xfx_perm, B_UID(991), NULL };
static struct builtin B2_vec_vupklsh = { { &T_vec_s16, NULL, NULL, }, "x", &T_vec_s32, 1, FALSE, FALSE, 0, "vec_vupklsh:2", "*vupklsh", CODE_FOR_xfx_perm, B_UID(992), NULL };
static struct builtin B2_vec_vupklsb = { { &T_vec_s8, NULL, NULL, }, "x", &T_vec_s16, 1, FALSE, FALSE, 0, "vec_vupklsb:2", "*vupklsb", CODE_FOR_xfx_perm, B_UID(993), NULL };
static struct builtin B1_vec_vxor = { { &T_vec_b16, &T_vec_b16, NULL, }, "xx", &T_vec_b16, 2, FALSE, FALSE, 1, "vec_vxor:1", "*vxor", CODE_FOR_xfxx_simple, B_UID(994), NULL };
static struct builtin B2_vec_vxor = { { &T_vec_b16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:2", "*vxor", CODE_FOR_xfxx_simple, B_UID(995), NULL };
static struct builtin B3_vec_vxor = { { &T_vec_b16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:3", "*vxor", CODE_FOR_xfxx_simple, B_UID(996), NULL };
static struct builtin B4_vec_vxor = { { &T_vec_b32, &T_vec_b32, NULL, }, "xx", &T_vec_b32, 2, FALSE, FALSE, 1, "vec_vxor:4", "*vxor", CODE_FOR_xfxx_simple, B_UID(997), NULL };
static struct builtin B5_vec_vxor = { { &T_vec_b32, &T_vec_f32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:5", "*vxor", CODE_FOR_xfxx_simple, B_UID(998), NULL };
static struct builtin B6_vec_vxor = { { &T_vec_b32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:6", "*vxor", CODE_FOR_xfxx_simple, B_UID(999), NULL };
static struct builtin B7_vec_vxor = { { &T_vec_b32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:7", "*vxor", CODE_FOR_xfxx_simple, B_UID(1000), NULL };
static struct builtin B8_vec_vxor = { { &T_vec_b8, &T_vec_b8, NULL, }, "xx", &T_vec_b8, 2, FALSE, FALSE, 1, "vec_vxor:8", "*vxor", CODE_FOR_xfxx_simple, B_UID(1001), NULL };
static struct builtin B9_vec_vxor = { { &T_vec_b8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:9", "*vxor", CODE_FOR_xfxx_simple, B_UID(1002), NULL };
static struct builtin B10_vec_vxor = { { &T_vec_b8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:10", "*vxor", CODE_FOR_xfxx_simple, B_UID(1003), NULL };
static struct builtin B11_vec_vxor = { { &T_vec_f32, &T_vec_b32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:11", "*vxor", CODE_FOR_xfxx_simple, B_UID(1004), NULL };
static struct builtin B12_vec_vxor = { { &T_vec_f32, &T_vec_f32, NULL, }, "xx", &T_vec_f32, 2, FALSE, FALSE, 1, "vec_vxor:12", "*vxor", CODE_FOR_xfxx_simple, B_UID(1005), NULL };
static struct builtin B13_vec_vxor = { { &T_vec_s16, &T_vec_b16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:13", "*vxor", CODE_FOR_xfxx_simple, B_UID(1006), NULL };
static struct builtin B14_vec_vxor = { { &T_vec_s16, &T_vec_s16, NULL, }, "xx", &T_vec_s16, 2, FALSE, FALSE, 1, "vec_vxor:14", "*vxor", CODE_FOR_xfxx_simple, B_UID(1007), NULL };
static struct builtin B15_vec_vxor = { { &T_vec_s32, &T_vec_b32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:15", "*vxor", CODE_FOR_xfxx_simple, B_UID(1008), NULL };
static struct builtin B16_vec_vxor = { { &T_vec_s32, &T_vec_s32, NULL, }, "xx", &T_vec_s32, 2, FALSE, FALSE, 1, "vec_vxor:16", "*vxor", CODE_FOR_xfxx_simple, B_UID(1009), NULL };
static struct builtin B17_vec_vxor = { { &T_vec_s8, &T_vec_b8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:17", "*vxor", CODE_FOR_xfxx_simple, B_UID(1010), NULL };
static struct builtin B18_vec_vxor = { { &T_vec_s8, &T_vec_s8, NULL, }, "xx", &T_vec_s8, 2, FALSE, FALSE, 1, "vec_vxor:18", "*vxor", CODE_FOR_xfxx_simple, B_UID(1011), NULL };
static struct builtin B19_vec_vxor = { { &T_vec_u16, &T_vec_b16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:19", "*vxor", CODE_FOR_xfxx_simple, B_UID(1012), NULL };
static struct builtin B20_vec_vxor = { { &T_vec_u16, &T_vec_u16, NULL, }, "xx", &T_vec_u16, 2, FALSE, FALSE, 1, "vec_vxor:20", "*vxor", CODE_FOR_xfxx_simple, B_UID(1013), NULL };
static struct builtin B21_vec_vxor = { { &T_vec_u32, &T_vec_b32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:21", "*vxor", CODE_FOR_xfxx_simple, B_UID(1014), NULL };
static struct builtin B22_vec_vxor = { { &T_vec_u32, &T_vec_u32, NULL, }, "xx", &T_vec_u32, 2, FALSE, FALSE, 1, "vec_vxor:22", "*vxor", CODE_FOR_xfxx_simple, B_UID(1015), NULL };
static struct builtin B23_vec_vxor = { { &T_vec_u8, &T_vec_b8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:23", "*vxor", CODE_FOR_xfxx_simple, B_UID(1016), NULL };
static struct builtin B24_vec_vxor = { { &T_vec_u8, &T_vec_u8, NULL, }, "xx", &T_vec_u8, 2, FALSE, FALSE, 1, "vec_vxor:24", "*vxor", CODE_FOR_xfxx_simple, B_UID(1017), NULL };
#define LAST_B_UID B_UID(1018)
...
static struct builtin *const O_vec_abs[4] = {
  &B1_vec_abs,
  &B2_vec_abs,
  &B3_vec_abs,
  &B4_vec_abs,
};
static struct builtin *const O_vec_abss[3] = {
  &B1_vec_abss,
  &B2_vec_abss,
  &B3_vec_abss,
};
static struct builtin *const O_vec_add[19] = {
  &B1_vec_vadduhm,
  &B2_vec_vadduhm,
  &B1_vec_vadduwm,
  &B2_vec_vadduwm,
...
static struct builtin *const O_vec_addc[1] = {
  &B_vec_vaddcuw,
};
static struct builtin *const O_vec_adds[18] = {
  &B1_vec_vaddshs,
  &B1_vec_vadduhs,
  &B1_vec_vaddsws,
  &B1_vec_vadduws,
...
static struct builtin *const O_vec_all_eq[23] = {
  &B1_vec_all_eq,
  &B2_vec_all_eq,
  &B3_vec_all_eq,
  &B4_vec_all_eq,
...
static struct builtin *const O_vec_all_ge[19] = {
  &B1_vec_all_ge,
  &B2_vec_all_ge,
  &B3_vec_all_ge,
  &B4_vec_all_ge,
...
static struct builtin *const O_vec_all_gt[19] = {
  &B1_vec_all_gt,
  &B2_vec_all_gt,
  &B3_vec_all_gt,
  &B4_vec_all_gt,
...
static struct builtin *const O_vec_all_in[1] = {
  &B_vec_all_in,
};
static struct builtin *const O_vec_all_le[19] = {
  &B1_vec_all_le,
  &B2_vec_all_le,
  &B3_vec_all_le,
  &B4_vec_all_le,
...
static struct builtin *const O_vec_all_lt[19] = {
  &B1_vec_all_lt,
  &B2_vec_all_lt,
  &B3_vec_all_lt,
  &B4_vec_all_lt,
...
static struct builtin *const O_vec_all_nan[1] = {
  &B_vec_all_nan,
};
static struct builtin *const O_vec_all_ne[23] = {
  &B1_vec_all_ne,
  &B2_vec_all_ne,
  &B3_vec_all_ne,
  &B4_vec_all_ne,
...
static struct builtin *const O_vec_all_nge[1] = {
  &B_vec_all_nge,
};
static struct builtin *const O_vec_all_ngt[1] = {
  &B_vec_all_ngt,
};
static struct builtin *const O_vec_all_nle[1] = {
  &B_vec_all_nle,
};
static struct builtin *const O_vec_all_nlt[1] = {
  &B_vec_all_nlt,
};
static struct builtin *const O_vec_all_numeric[1] = {
  &B_vec_all_numeric,
};
static struct builtin *const O_vec_and[24] = {
  &B1_vec_vand,
  &B2_vec_vand,
  &B3_vec_vand,
  &B4_vec_vand,
...
static struct builtin *const O_vec_andc[24] = {
  &B1_vec_vandc,
  &B2_vec_vandc,
  &B3_vec_vandc,
  &B4_vec_vandc,
...
static struct builtin *const O_vec_any_eq[23] = {
  &B1_vec_any_eq,
  &B2_vec_any_eq,
  &B3_vec_any_eq,
  &B4_vec_any_eq,
...
static struct builtin *const O_vec_any_ge[19] = {
  &B1_vec_any_ge,
  &B2_vec_any_ge,
  &B3_vec_any_ge,
  &B4_vec_any_ge,
...
static struct builtin *const O_vec_any_gt[19] = {
  &B1_vec_any_gt,
  &B2_vec_any_gt,
  &B3_vec_any_gt,
  &B4_vec_any_gt,
...
static struct builtin *const O_vec_any_le[19] = {
  &B1_vec_any_le,
  &B2_vec_any_le,
  &B3_vec_any_le,
  &B4_vec_any_le,
...
static struct builtin *const O_vec_any_lt[19] = {
  &B1_vec_any_lt,
  &B2_vec_any_lt,
  &B3_vec_any_lt,
  &B4_vec_any_lt,
...
static struct builtin *const O_vec_any_nan[1] = {
  &B_vec_any_nan,
};
static struct builtin *const O_vec_any_ne[23] = {
  &B1_vec_any_ne,
  &B2_vec_any_ne,
  &B3_vec_any_ne,
  &B4_vec_any_ne,
...
static struct builtin *const O_vec_any_nge[1] = {
  &B_vec_any_nge,
};
static struct builtin *const O_vec_any_ngt[1] = {
  &B_vec_any_ngt,
};
static struct builtin *const O_vec_any_nle[1] = {
  &B_vec_any_nle,
};
static struct builtin *const O_vec_any_nlt[1] = {
  &B_vec_any_nlt,
};
static struct builtin *const O_vec_any_numeric[1] = {
  &B_vec_any_numeric,
};
static struct builtin *const O_vec_any_out[1] = {
  &B_vec_any_out,
};
static struct builtin *const O_vec_avg[6] = {
  &B_vec_vavgsh,
  &B_vec_vavgsw,
  &B_vec_vavgsb,
  &B_vec_vavguh,
...
static struct builtin *const O_vec_ceil[1] = {
  &B_vec_vrfip,
};
static struct builtin *const O_vec_cmpb[1] = {
  &B_vec_vcmpbfp,
};
static struct builtin *const O_vec_cmpeq[7] = {
  &B_vec_vcmpeqfp,
  &B1_vec_vcmpequh,
  &B1_vec_vcmpequw,
  &B1_vec_vcmpequb,
...
static struct builtin *const O_vec_cmpge[1] = {
  &B_vec_vcmpgefp,
};
static struct builtin *const O_vec_cmpgt[7] = {
  &B_vec_vcmpgtfp,
  &B_vec_vcmpgtsh,
  &B_vec_vcmpgtsw,
  &B_vec_vcmpgtsb,
...
static struct builtin *const O_vec_cmple[1] = {
  &B_vec_cmple,
};
static struct builtin *const O_vec_cmplt[7] = {
  &B1_vec_cmplt,
  &B2_vec_cmplt,
  &B3_vec_cmplt,
  &B4_vec_cmplt,
...
static struct builtin *const O_vec_ctf[2] = {
  &B_vec_vcfsx,
  &B_vec_vcfux,
};
static struct builtin *const O_vec_cts[1] = {
  &B_vec_vctsxs,
};
static struct builtin *const O_vec_ctu[1] = {
  &B_vec_vctuxs,
};
static struct builtin *const O_vec_dss[1] = {
  &B_vec_dss,
};
static struct builtin *const O_vec_dssall[1] = {
  &B_vec_dssall,
};
static struct builtin *const O_vec_dst[20] = {
  &B1_vec_dst,
  &B2_vec_dst,
  &B3_vec_dst,
  &B4_vec_dst,
...
static struct builtin *const O_vec_dstst[20] = {
  &B1_vec_dstst,
  &B2_vec_dstst,
  &B3_vec_dstst,
  &B4_vec_dstst,
...
static struct builtin *const O_vec_dststt[20] = {
  &B1_vec_dststt,
  &B2_vec_dststt,
  &B3_vec_dststt,
  &B4_vec_dststt,
...
static struct builtin *const O_vec_dstt[20] = {
  &B1_vec_dstt,
  &B2_vec_dstt,
  &B3_vec_dstt,
  &B4_vec_dstt,
...
static struct builtin *const O_vec_expte[1] = {
  &B_vec_vexptefp,
};
static struct builtin *const O_vec_floor[1] = {
  &B_vec_vrfim,
};
static struct builtin *const O_vec_ld[20] = {
  &B1_vec_lvx,
  &B2_vec_lvx,
  &B3_vec_lvx,
  &B4_vec_lvx,
...
static struct builtin *const O_vec_lde[9] = {
  &B1_vec_lvewx,
  &B2_vec_lvewx,
  &B3_vec_lvewx,
  &B1_vec_lvehx,
...
static struct builtin *const O_vec_ldl[20] = {
  &B1_vec_lvxl,
  &B2_vec_lvxl,
  &B3_vec_lvxl,
  &B4_vec_lvxl,
...
static struct builtin *const O_vec_loge[1] = {
  &B_vec_vlogefp,
};
static struct builtin *const O_vec_lvebx[2] = {
  &B1_vec_lvebx,
  &B2_vec_lvebx,
};
static struct builtin *const O_vec_lvehx[2] = {
  &B1_vec_lvehx,
  &B2_vec_lvehx,
};
static struct builtin *const O_vec_lvewx[5] = {
  &B1_vec_lvewx,
  &B2_vec_lvewx,
  &B3_vec_lvewx,
  &B4_vec_lvewx,
...
static struct builtin *const O_vec_lvsl[9] = {
  &B1_vec_lvsl,
  &B2_vec_lvsl,
  &B3_vec_lvsl,
  &B4_vec_lvsl,
...
static struct builtin *const O_vec_lvsr[9] = {
  &B1_vec_lvsr,
  &B2_vec_lvsr,
  &B3_vec_lvsr,
  &B4_vec_lvsr,
...
static struct builtin *const O_vec_lvx[20] = {
  &B1_vec_lvx,
  &B2_vec_lvx,
  &B3_vec_lvx,
  &B4_vec_lvx,
...
static struct builtin *const O_vec_lvxl[20] = {
  &B1_vec_lvxl,
  &B2_vec_lvxl,
  &B3_vec_lvxl,
  &B4_vec_lvxl,
...
static struct builtin *const O_vec_madd[1] = {
  &B_vec_vmaddfp,
};
static struct builtin *const O_vec_madds[1] = {
  &B_vec_vmhaddshs,
};
static struct builtin *const O_vec_max[19] = {
  &B1_vec_vmaxsh,
  &B1_vec_vmaxuh,
  &B1_vec_vmaxsw,
  &B1_vec_vmaxuw,
...
static struct builtin *const O_vec_mergeh[11] = {
  &B1_vec_vmrghh,
  &B1_vec_vmrghw,
  &B1_vec_vmrghb,
  &B2_vec_vmrghw,
...
static struct builtin *const O_vec_mergel[11] = {
  &B1_vec_vmrglh,
  &B1_vec_vmrglw,
  &B1_vec_vmrglb,
  &B2_vec_vmrglw,
...
static struct builtin *const O_vec_mfvscr[1] = {
  &B_vec_mfvscr,
};
static struct builtin *const O_vec_min[19] = {
  &B1_vec_vminsh,
  &B1_vec_vminuh,
  &B1_vec_vminsw,
  &B1_vec_vminuw,
...
static struct builtin *const O_vec_mladd[4] = {
  &B1_vec_vmladduhm,
  &B2_vec_vmladduhm,
  &B3_vec_vmladduhm,
  &B4_vec_vmladduhm,
};
static struct builtin *const O_vec_mradds[1] = {
  &B_vec_vmhraddshs,
};
static struct builtin *const O_vec_msum[4] = {
  &B_vec_vmsumshm,
  &B_vec_vmsummbm,
  &B_vec_vmsumuhm,
  &B_vec_vmsumubm,
};
static struct builtin *const O_vec_msums[2] = {
  &B_vec_vmsumshs,
  &B_vec_vmsumuhs,
};
static struct builtin *const O_vec_mtvscr[10] = {
  &B1_vec_mtvscr,
  &B2_vec_mtvscr,
  &B3_vec_mtvscr,
  &B4_vec_mtvscr,
...
static struct builtin *const O_vec_mule[4] = {
  &B_vec_vmulesh,
  &B_vec_vmulesb,
  &B_vec_vmuleuh,
  &B_vec_vmuleub,
};
static struct builtin *const O_vec_mulo[4] = {
  &B_vec_vmulosh,
  &B_vec_vmulosb,
  &B_vec_vmulouh,
  &B_vec_vmuloub,
};
static struct builtin *const O_vec_nmsub[1] = {
  &B_vec_vnmsubfp,
};
static struct builtin *const O_vec_nor[10] = {
  &B1_vec_vnor,
  &B2_vec_vnor,
  &B3_vec_vnor,
  &B4_vec_vnor,
...
static struct builtin *const O_vec_or[24] = {
  &B1_vec_vor,
  &B2_vec_vor,
  &B3_vec_vor,
  &B4_vec_vor,
...
static struct builtin *const O_vec_pack[6] = {
  &B1_vec_vpkuhum,
  &B1_vec_vpkuwum,
  &B2_vec_vpkuhum,
  &B2_vec_vpkuwum,
...
static struct builtin *const O_vec_packpx[1] = {
  &B_vec_vpkpx,
};
static struct builtin *const O_vec_packs[4] = {
  &B_vec_vpkshss,
  &B_vec_vpkswss,
  &B_vec_vpkuhus,
  &B_vec_vpkuwus,
};
static struct builtin *const O_vec_packsu[4] = {
  &B_vec_vpkshus,
  &B_vec_vpkswus,
  &B_vec_vpkuhus,
  &B_vec_vpkuwus,
};
static struct builtin *const O_vec_perm[11] = {
  &B1_vec_vperm,
  &B2_vec_vperm,
  &B3_vec_vperm,
  &B4_vec_vperm,
...
static struct builtin *const O_vec_re[1] = {
  &B_vec_vrefp,
};
static struct builtin *const O_vec_rl[6] = {
  &B1_vec_vrlh,
  &B1_vec_vrlw,
  &B1_vec_vrlb,
  &B2_vec_vrlh,
...
static struct builtin *const O_vec_round[1] = {
  &B_vec_vrfin,
};
static struct builtin *const O_vec_rsqrte[1] = {
  &B_vec_vrsqrtefp,
};
static struct builtin *const O_vec_sel[20] = {
  &B1_vec_vsel,
  &B2_vec_vsel,
  &B3_vec_vsel,
  &B4_vec_vsel,
...
static struct builtin *const O_vec_sl[6] = {
  &B1_vec_vslh,
  &B1_vec_vslw,
  &B1_vec_vslb,
  &B2_vec_vslh,
...
static struct builtin *const O_vec_sld[8] = {
  &B1_vec_vsldoi,
  &B2_vec_vsldoi,
  &B3_vec_vsldoi,
  &B4_vec_vsldoi,
...
static struct builtin *const O_vec_sll[30] = {
  &B1_vec_vsl,
  &B2_vec_vsl,
  &B3_vec_vsl,
  &B4_vec_vsl,
...
static struct builtin *const O_vec_slo[16] = {
  &B1_vec_vslo,
  &B2_vec_vslo,
  &B3_vec_vslo,
  &B4_vec_vslo,
...
static struct builtin *const O_vec_splat[11] = {
  &B1_vec_vsplth,
  &B1_vec_vspltw,
  &B1_vec_vspltb,
  &B2_vec_vspltw,
...
static struct builtin *const O_vec_splat_s16[1] = {
  &B_vec_vspltish,
};
static struct builtin *const O_vec_splat_s32[1] = {
  &B_vec_vspltisw,
};
static struct builtin *const O_vec_splat_s8[1] = {
  &B_vec_vspltisb,
};
static struct builtin *const O_vec_splat_u16[1] = {
  &B_vec_splat_u16,
};
static struct builtin *const O_vec_splat_u32[1] = {
  &B_vec_splat_u32,
};
static struct builtin *const O_vec_splat_u8[1] = {
  &B_vec_splat_u8,
};
static struct builtin *const O_vec_sr[6] = {
  &B1_vec_vsrh,
  &B1_vec_vsrw,
  &B1_vec_vsrb,
  &B2_vec_vsrh,
...
static struct builtin *const O_vec_sra[6] = {
  &B1_vec_vsrah,
  &B1_vec_vsraw,
  &B1_vec_vsrab,
  &B2_vec_vsrah,
...
static struct builtin *const O_vec_srl[30] = {
  &B1_vec_vsr,
  &B2_vec_vsr,
  &B3_vec_vsr,
  &B4_vec_vsr,
...
static struct builtin *const O_vec_sro[16] = {
  &B1_vec_vsro,
  &B2_vec_vsro,
  &B3_vec_vsro,
  &B4_vec_vsro,
...
static struct builtin *const O_vec_st[30] = {
  &B1_vec_stvx,
  &B2_vec_stvx,
  &B3_vec_stvx,
  &B4_vec_stvx,
...
static struct builtin *const O_vec_ste[19] = {
  &B1_vec_stvebx,
  &B2_vec_stvebx,
  &B1_vec_stvewx,
  &B2_vec_stvewx,
...
static struct builtin *const O_vec_stl[30] = {
  &B1_vec_stvxl,
  &B2_vec_stvxl,
  &B3_vec_stvxl,
  &B4_vec_stvxl,
...
static struct builtin *const O_vec_stvebx[6] = {
  &B1_vec_stvebx,
  &B2_vec_stvebx,
  &B3_vec_stvebx,
  &B4_vec_stvebx,
...
static struct builtin *const O_vec_stvehx[4] = {
  &B1_vec_stvehx,
  &B2_vec_stvehx,
  &B3_vec_stvehx,
  &B4_vec_stvehx,
};
static struct builtin *const O_vec_stvewx[9] = {
  &B1_vec_stvewx,
  &B2_vec_stvewx,
  &B3_vec_stvewx,
  &B4_vec_stvewx,
...
static struct builtin *const O_vec_stvx[30] = {
  &B1_vec_stvx,
  &B2_vec_stvx,
  &B3_vec_stvx,
  &B4_vec_stvx,
...
static struct builtin *const O_vec_stvxl[30] = {
  &B1_vec_stvxl,
  &B2_vec_stvxl,
  &B3_vec_stvxl,
  &B4_vec_stvxl,
...
static struct builtin *const O_vec_sub[19] = {
  &B1_vec_vsubuhm,
  &B2_vec_vsubuhm,
  &B1_vec_vsubuwm,
  &B2_vec_vsubuwm,
...
static struct builtin *const O_vec_subc[1] = {
  &B_vec_vsubcuw,
};
static struct builtin *const O_vec_subs[18] = {
  &B1_vec_vsubshs,
  &B1_vec_vsubuhs,
  &B1_vec_vsubsws,
  &B1_vec_vsubuws,
...
static struct builtin *const O_vec_sum2s[1] = {
  &B_vec_vsum2sws,
};
static struct builtin *const O_vec_sum4s[3] = {
  &B_vec_vsum4shs,
  &B_vec_vsum4sbs,
  &B_vec_vsum4ubs,
};
static struct builtin *const O_vec_sums[1] = {
  &B_vec_vsumsws,
};
static struct builtin *const O_vec_trunc[1] = {
  &B_vec_vrfiz,
};
static struct builtin *const O_vec_unpack2sh[2] = {
  &B1_vec_unpack2sh,
  &B2_vec_unpack2sh,
};
static struct builtin *const O_vec_unpack2sl[2] = {
  &B1_vec_unpack2sl,
  &B2_vec_unpack2sl,
};
static struct builtin *const O_vec_unpack2uh[2] = {
  &B1_vec_unpack2uh,
  &B2_vec_unpack2uh,
};
static struct builtin *const O_vec_unpack2ul[2] = {
  &B1_vec_unpack2ul,
  &B2_vec_unpack2ul,
};
static struct builtin *const O_vec_unpackh[5] = {
  &B1_vec_vupkhsh,
  &B1_vec_vupkhsb,
  &B_vec_vupkhpx,
  &B2_vec_vupkhsh,
...
static struct builtin *const O_vec_unpackl[5] = {
  &B1_vec_vupklsh,
  &B1_vec_vupklsb,
  &B_vec_vupklpx,
  &B2_vec_vupklsh,
...
static struct builtin *const O_vec_vaddcuw[1] = {
  &B_vec_vaddcuw,
};
static struct builtin *const O_vec_vaddfp[1] = {
  &B_vec_vaddfp,
};
static struct builtin *const O_vec_vaddsbs[3] = {
  &B1_vec_vaddsbs,
  &B2_vec_vaddsbs,
  &B3_vec_vaddsbs,
};
static struct builtin *const O_vec_vaddshs[3] = {
  &B1_vec_vaddshs,
  &B2_vec_vaddshs,
  &B3_vec_vaddshs,
};
static struct builtin *const O_vec_vaddsws[3] = {
  &B1_vec_vaddsws,
  &B2_vec_vaddsws,
  &B3_vec_vaddsws,
};
static struct builtin *const O_vec_vaddubm[6] = {
  &B1_vec_vaddubm,
  &B2_vec_vaddubm,
  &B3_vec_vaddubm,
  &B4_vec_vaddubm,
...
static struct builtin *const O_vec_vaddubs[3] = {
  &B1_vec_vaddubs,
  &B2_vec_vaddubs,
  &B3_vec_vaddubs,
};
static struct builtin *const O_vec_vadduhm[6] = {
  &B1_vec_vadduhm,
  &B2_vec_vadduhm,
  &B3_vec_vadduhm,
  &B4_vec_vadduhm,
...
static struct builtin *const O_vec_vadduhs[3] = {
  &B1_vec_vadduhs,
  &B2_vec_vadduhs,
  &B3_vec_vadduhs,
};
static struct builtin *const O_vec_vadduwm[6] = {
  &B1_vec_vadduwm,
  &B2_vec_vadduwm,
  &B3_vec_vadduwm,
  &B4_vec_vadduwm,
...
static struct builtin *const O_vec_vadduws[3] = {
  &B1_vec_vadduws,
  &B2_vec_vadduws,
  &B3_vec_vadduws,
};
static struct builtin *const O_vec_vand[24] = {
  &B1_vec_vand,
  &B2_vec_vand,
  &B3_vec_vand,
  &B4_vec_vand,
...
static struct builtin *const O_vec_vandc[24] = {
  &B1_vec_vandc,
  &B2_vec_vandc,
  &B3_vec_vandc,
  &B4_vec_vandc,
...
static struct builtin *const O_vec_vavgsb[1] = {
  &B_vec_vavgsb,
};
static struct builtin *const O_vec_vavgsh[1] = {
  &B_vec_vavgsh,
};
static struct builtin *const O_vec_vavgsw[1] = {
  &B_vec_vavgsw,
};
static struct builtin *const O_vec_vavgub[1] = {
  &B_vec_vavgub,
};
static struct builtin *const O_vec_vavguh[1] = {
  &B_vec_vavguh,
};
static struct builtin *const O_vec_vavguw[1] = {
  &B_vec_vavguw,
};
static struct builtin *const O_vec_vcfsx[1] = {
  &B_vec_vcfsx,
};
static struct builtin *const O_vec_vcfux[1] = {
  &B_vec_vcfux,
};
static struct builtin *const O_vec_vcmpbfp[1] = {
  &B_vec_vcmpbfp,
};
static struct builtin *const O_vec_vcmpeqfp[1] = {
  &B_vec_vcmpeqfp,
};
static struct builtin *const O_vec_vcmpequb[2] = {
  &B1_vec_vcmpequb,
  &B2_vec_vcmpequb,
};
static struct builtin *const O_vec_vcmpequh[2] = {
  &B1_vec_vcmpequh,
  &B2_vec_vcmpequh,
};
static struct builtin *const O_vec_vcmpequw[2] = {
  &B1_vec_vcmpequw,
  &B2_vec_vcmpequw,
};
static struct builtin *const O_vec_vcmpgefp[1] = {
  &B_vec_vcmpgefp,
};
static struct builtin *const O_vec_vcmpgtfp[1] = {
  &B_vec_vcmpgtfp,
};
static struct builtin *const O_vec_vcmpgtsb[1] = {
  &B_vec_vcmpgtsb,
};
static struct builtin *const O_vec_vcmpgtsh[1] = {
  &B_vec_vcmpgtsh,
};
static struct builtin *const O_vec_vcmpgtsw[1] = {
  &B_vec_vcmpgtsw,
};
static struct builtin *const O_vec_vcmpgtub[1] = {
  &B_vec_vcmpgtub,
};
static struct builtin *const O_vec_vcmpgtuh[1] = {
  &B_vec_vcmpgtuh,
};
static struct builtin *const O_vec_vcmpgtuw[1] = {
  &B_vec_vcmpgtuw,
};
static struct builtin *const O_vec_vctsxs[1] = {
  &B_vec_vctsxs,
};
static struct builtin *const O_vec_vctuxs[1] = {
  &B_vec_vctuxs,
};
static struct builtin *const O_vec_vexptefp[1] = {
  &B_vec_vexptefp,
};
static struct builtin *const O_vec_vlogefp[1] = {
  &B_vec_vlogefp,
};
static struct builtin *const O_vec_vmaddfp[1] = {
  &B_vec_vmaddfp,
};
static struct builtin *const O_vec_vmaxfp[1] = {
  &B_vec_vmaxfp,
};
static struct builtin *const O_vec_vmaxsb[3] = {
  &B1_vec_vmaxsb,
  &B2_vec_vmaxsb,
  &B3_vec_vmaxsb,
};
static struct builtin *const O_vec_vmaxsh[3] = {
  &B1_vec_vmaxsh,
  &B2_vec_vmaxsh,
  &B3_vec_vmaxsh,
};
static struct builtin *const O_vec_vmaxsw[3] = {
  &B1_vec_vmaxsw,
  &B2_vec_vmaxsw,
  &B3_vec_vmaxsw,
};
static struct builtin *const O_vec_vmaxub[3] = {
  &B1_vec_vmaxub,
  &B2_vec_vmaxub,
  &B3_vec_vmaxub,
};
static struct builtin *const O_vec_vmaxuh[3] = {
  &B1_vec_vmaxuh,
  &B2_vec_vmaxuh,
  &B3_vec_vmaxuh,
};
static struct builtin *const O_vec_vmaxuw[3] = {
  &B1_vec_vmaxuw,
  &B2_vec_vmaxuw,
  &B3_vec_vmaxuw,
};
static struct builtin *const O_vec_vmhaddshs[1] = {
  &B_vec_vmhaddshs,
};
static struct builtin *const O_vec_vmhraddshs[1] = {
  &B_vec_vmhraddshs,
};
static struct builtin *const O_vec_vminfp[1] = {
  &B_vec_vminfp,
};
static struct builtin *const O_vec_vminsb[3] = {
  &B1_vec_vminsb,
  &B2_vec_vminsb,
  &B3_vec_vminsb,
};
static struct builtin *const O_vec_vminsh[3] = {
  &B1_vec_vminsh,
  &B2_vec_vminsh,
  &B3_vec_vminsh,
};
static struct builtin *const O_vec_vminsw[3] = {
  &B1_vec_vminsw,
  &B2_vec_vminsw,
  &B3_vec_vminsw,
};
static struct builtin *const O_vec_vminub[3] = {
  &B1_vec_vminub,
  &B2_vec_vminub,
  &B3_vec_vminub,
};
static struct builtin *const O_vec_vminuh[3] = {
  &B1_vec_vminuh,
  &B2_vec_vminuh,
  &B3_vec_vminuh,
};
static struct builtin *const O_vec_vminuw[3] = {
  &B1_vec_vminuw,
  &B2_vec_vminuw,
  &B3_vec_vminuw,
};
static struct builtin *const O_vec_vmladduhm[4] = {
  &B1_vec_vmladduhm,
  &B2_vec_vmladduhm,
  &B3_vec_vmladduhm,
  &B4_vec_vmladduhm,
};
static struct builtin *const O_vec_vmrghb[3] = {
  &B1_vec_vmrghb,
  &B2_vec_vmrghb,
  &B3_vec_vmrghb,
};
static struct builtin *const O_vec_vmrghh[4] = {
  &B1_vec_vmrghh,
  &B2_vec_vmrghh,
  &B3_vec_vmrghh,
  &B4_vec_vmrghh,
};
static struct builtin *const O_vec_vmrghw[4] = {
  &B1_vec_vmrghw,
  &B2_vec_vmrghw,
  &B3_vec_vmrghw,
  &B4_vec_vmrghw,
};
static struct builtin *const O_vec_vmrglb[3] = {
  &B1_vec_vmrglb,
  &B2_vec_vmrglb,
  &B3_vec_vmrglb,
};
static struct builtin *const O_vec_vmrglh[4] = {
  &B1_vec_vmrglh,
  &B2_vec_vmrglh,
  &B3_vec_vmrglh,
  &B4_vec_vmrglh,
};
static struct builtin *const O_vec_vmrglw[4] = {
  &B1_vec_vmrglw,
  &B2_vec_vmrglw,
  &B3_vec_vmrglw,
  &B4_vec_vmrglw,
};
static struct builtin *const O_vec_vmsummbm[1] = {
  &B_vec_vmsummbm,
};
static struct builtin *const O_vec_vmsumshm[1] = {
  &B_vec_vmsumshm,
};
static struct builtin *const O_vec_vmsumshs[1] = {
  &B_vec_vmsumshs,
};
static struct builtin *const O_vec_vmsumubm[1] = {
  &B_vec_vmsumubm,
};
static struct builtin *const O_vec_vmsumuhm[1] = {
  &B_vec_vmsumuhm,
};
static struct builtin *const O_vec_vmsumuhs[1] = {
  &B_vec_vmsumuhs,
};
static struct builtin *const O_vec_vmulesb[1] = {
  &B_vec_vmulesb,
};
static struct builtin *const O_vec_vmulesh[1] = {
  &B_vec_vmulesh,
};
static struct builtin *const O_vec_vmuleub[1] = {
  &B_vec_vmuleub,
};
static struct builtin *const O_vec_vmuleuh[1] = {
  &B_vec_vmuleuh,
};
static struct builtin *const O_vec_vmulosb[1] = {
  &B_vec_vmulosb,
};
static struct builtin *const O_vec_vmulosh[1] = {
  &B_vec_vmulosh,
};
static struct builtin *const O_vec_vmuloub[1] = {
  &B_vec_vmuloub,
};
static struct builtin *const O_vec_vmulouh[1] = {
  &B_vec_vmulouh,
};
static struct builtin *const O_vec_vnmsubfp[1] = {
  &B_vec_vnmsubfp,
};
static struct builtin *const O_vec_vnor[10] = {
  &B1_vec_vnor,
  &B2_vec_vnor,
  &B3_vec_vnor,
  &B4_vec_vnor,
...
static struct builtin *const O_vec_vor[24] = {
  &B1_vec_vor,
  &B2_vec_vor,
  &B3_vec_vor,
  &B4_vec_vor,
...
static struct builtin *const O_vec_vperm[11] = {
  &B1_vec_vperm,
  &B2_vec_vperm,
  &B3_vec_vperm,
  &B4_vec_vperm,
...
static struct builtin *const O_vec_vpkpx[1] = {
  &B_vec_vpkpx,
};
static struct builtin *const O_vec_vpkshss[1] = {
  &B_vec_vpkshss,
};
static struct builtin *const O_vec_vpkshus[1] = {
  &B_vec_vpkshus,
};
static struct builtin *const O_vec_vpkswss[1] = {
  &B_vec_vpkswss,
};
static struct builtin *const O_vec_vpkswus[1] = {
  &B_vec_vpkswus,
};
static struct builtin *const O_vec_vpkuhum[3] = {
  &B1_vec_vpkuhum,
  &B2_vec_vpkuhum,
  &B3_vec_vpkuhum,
};
static struct builtin *const O_vec_vpkuhus[1] = {
  &B_vec_vpkuhus,
};
static struct builtin *const O_vec_vpkuwum[3] = {
  &B1_vec_vpkuwum,
  &B2_vec_vpkuwum,
  &B3_vec_vpkuwum,
};
static struct builtin *const O_vec_vpkuwus[1] = {
  &B_vec_vpkuwus,
};
static struct builtin *const O_vec_vrefp[1] = {
  &B_vec_vrefp,
};
static struct builtin *const O_vec_vrfim[1] = {
  &B_vec_vrfim,
};
static struct builtin *const O_vec_vrfin[1] = {
  &B_vec_vrfin,
};
static struct builtin *const O_vec_vrfip[1] = {
  &B_vec_vrfip,
};
static struct builtin *const O_vec_vrfiz[1] = {
  &B_vec_vrfiz,
};
static struct builtin *const O_vec_vrlb[2] = {
  &B1_vec_vrlb,
  &B2_vec_vrlb,
};
static struct builtin *const O_vec_vrlh[2] = {
  &B1_vec_vrlh,
  &B2_vec_vrlh,
};
static struct builtin *const O_vec_vrlw[2] = {
  &B1_vec_vrlw,
  &B2_vec_vrlw,
};
static struct builtin *const O_vec_vrsqrtefp[1] = {
  &B_vec_vrsqrtefp,
};
static struct builtin *const O_vec_vsel[20] = {
  &B1_vec_vsel,
  &B2_vec_vsel,
  &B3_vec_vsel,
  &B4_vec_vsel,
...
static struct builtin *const O_vec_vsl[30] = {
  &B1_vec_vsl,
  &B2_vec_vsl,
  &B3_vec_vsl,
  &B4_vec_vsl,
...
static struct builtin *const O_vec_vslb[2] = {
  &B1_vec_vslb,
  &B2_vec_vslb,
};
static struct builtin *const O_vec_vsldoi[8] = {
  &B1_vec_vsldoi,
  &B2_vec_vsldoi,
  &B3_vec_vsldoi,
  &B4_vec_vsldoi,
...
static struct builtin *const O_vec_vslh[2] = {
  &B1_vec_vslh,
  &B2_vec_vslh,
};
static struct builtin *const O_vec_vslo[16] = {
  &B1_vec_vslo,
  &B2_vec_vslo,
  &B3_vec_vslo,
  &B4_vec_vslo,
...
static struct builtin *const O_vec_vslw[2] = {
  &B1_vec_vslw,
  &B2_vec_vslw,
};
static struct builtin *const O_vec_vspltb[3] = {
  &B1_vec_vspltb,
  &B2_vec_vspltb,
  &B3_vec_vspltb,
};
static struct builtin *const O_vec_vsplth[4] = {
  &B1_vec_vsplth,
  &B2_vec_vsplth,
  &B3_vec_vsplth,
  &B4_vec_vsplth,
};
static struct builtin *const O_vec_vspltisb[1] = {
  &B_vec_vspltisb,
};
static struct builtin *const O_vec_vspltish[1] = {
  &B_vec_vspltish,
};
static struct builtin *const O_vec_vspltisw[1] = {
  &B_vec_vspltisw,
};
static struct builtin *const O_vec_vspltw[4] = {
  &B1_vec_vspltw,
  &B2_vec_vspltw,
  &B3_vec_vspltw,
  &B4_vec_vspltw,
};
static struct builtin *const O_vec_vsr[30] = {
  &B1_vec_vsr,
  &B2_vec_vsr,
  &B3_vec_vsr,
  &B4_vec_vsr,
...
static struct builtin *const O_vec_vsrab[2] = {
  &B1_vec_vsrab,
  &B2_vec_vsrab,
};
static struct builtin *const O_vec_vsrah[2] = {
  &B1_vec_vsrah,
  &B2_vec_vsrah,
};
static struct builtin *const O_vec_vsraw[2] = {
  &B1_vec_vsraw,
  &B2_vec_vsraw,
};
static struct builtin *const O_vec_vsrb[2] = {
  &B1_vec_vsrb,
  &B2_vec_vsrb,
};
static struct builtin *const O_vec_vsrh[2] = {
  &B1_vec_vsrh,
  &B2_vec_vsrh,
};
static struct builtin *const O_vec_vsro[16] = {
  &B1_vec_vsro,
  &B2_vec_vsro,
  &B3_vec_vsro,
  &B4_vec_vsro,
...
static struct builtin *const O_vec_vsrw[2] = {
  &B1_vec_vsrw,
  &B2_vec_vsrw,
};
static struct builtin *const O_vec_vsubcuw[1] = {
  &B_vec_vsubcuw,
};
static struct builtin *const O_vec_vsubfp[1] = {
  &B_vec_vsubfp,
};
static struct builtin *const O_vec_vsubsbs[3] = {
  &B1_vec_vsubsbs,
  &B2_vec_vsubsbs,
  &B3_vec_vsubsbs,
};
static struct builtin *const O_vec_vsubshs[3] = {
  &B1_vec_vsubshs,
  &B2_vec_vsubshs,
  &B3_vec_vsubshs,
};
static struct builtin *const O_vec_vsubsws[3] = {
  &B1_vec_vsubsws,
  &B2_vec_vsubsws,
  &B3_vec_vsubsws,
};
static struct builtin *const O_vec_vsububm[6] = {
  &B1_vec_vsububm,
  &B2_vec_vsububm,
  &B3_vec_vsububm,
  &B4_vec_vsububm,
...
static struct builtin *const O_vec_vsububs[3] = {
  &B1_vec_vsububs,
  &B2_vec_vsububs,
  &B3_vec_vsububs,
};
static struct builtin *const O_vec_vsubuhm[6] = {
  &B1_vec_vsubuhm,
  &B2_vec_vsubuhm,
  &B3_vec_vsubuhm,
  &B4_vec_vsubuhm,
...
static struct builtin *const O_vec_vsubuhs[3] = {
  &B1_vec_vsubuhs,
  &B2_vec_vsubuhs,
  &B3_vec_vsubuhs,
};
static struct builtin *const O_vec_vsubuwm[6] = {
  &B1_vec_vsubuwm,
  &B2_vec_vsubuwm,
  &B3_vec_vsubuwm,
  &B4_vec_vsubuwm,
...
static struct builtin *const O_vec_vsubuws[3] = {
  &B1_vec_vsubuws,
  &B2_vec_vsubuws,
  &B3_vec_vsubuws,
};
static struct builtin *const O_vec_vsum2sws[1] = {
  &B_vec_vsum2sws,
};
static struct builtin *const O_vec_vsum4sbs[1] = {
  &B_vec_vsum4sbs,
};
static struct builtin *const O_vec_vsum4shs[1] = {
  &B_vec_vsum4shs,
};
static struct builtin *const O_vec_vsum4ubs[1] = {
  &B_vec_vsum4ubs,
};
static struct builtin *const O_vec_vsumsws[1] = {
  &B_vec_vsumsws,
};
static struct builtin *const O_vec_vupkhpx[1] = {
  &B_vec_vupkhpx,
};
static struct builtin *const O_vec_vupkhsb[2] = {
  &B1_vec_vupkhsb,
  &B2_vec_vupkhsb,
};
static struct builtin *const O_vec_vupkhsh[2] = {
  &B1_vec_vupkhsh,
  &B2_vec_vupkhsh,
};
static struct builtin *const O_vec_vupklpx[1] = {
  &B_vec_vupklpx,
};
static struct builtin *const O_vec_vupklsb[2] = {
  &B1_vec_vupklsb,
  &B2_vec_vupklsb,
};
static struct builtin *const O_vec_vupklsh[2] = {
  &B1_vec_vupklsh,
  &B2_vec_vupklsh,
};
static struct builtin *const O_vec_vxor[24] = {
  &B1_vec_vxor,
  &B2_vec_vxor,
  &B3_vec_vxor,
  &B4_vec_vxor,
...
static struct builtin *const O_vec_xor[24] = {
  &B1_vec_vxor,
  &B2_vec_vxor,
  &B3_vec_vxor,
  &B4_vec_vxor,
...
struct overloadx Overload[] = {
  ...
  { "vec_st", 30, 3, O_vec_st, O_UID(105), NULL },
  { "vec_ste", 19, 3, O_vec_ste, O_UID(106), NULL },
  { "vec_stl", 30, 3, O_vec_stl, O_UID(107), NULL },
  { "vec_stvebx", 6, 3, O_vec_stvebx, O_UID(108), NULL },
  { "vec_stvehx", 4, 3, O_vec_stvehx, O_UID(109), NULL },
  { "vec_stvewx", 9, 3, O_vec_stvewx, O_UID(110), NULL },
  { "vec_stvx", 30, 3, O_vec_stvx, O_UID(111), NULL },
  { "vec_stvxl", 30, 3, O_vec_stvxl, O_UID(112), NULL },
