...
glutSpecialUpFunc = _GLUT.glutSpecialUpFunc

glutKeyboardUpFunc = _GLUT.glutKeyboardUpFunc

glutJoystickFunc = _GLUT.glutJoystickFunc
...
glutIgnoreKeyRepeat = _GLUT.glutIgnoreKeyRepeat

glutSetKeyRepeat = _GLUT.glutSetKeyRepeat

glutForceJoystickFunc = _GLUT.glutForceJoystickFunc

glutGameModeString = _GLUT.glutGameModeString

glutEnterGameMode = _GLUT.glutEnterGameMode

glutLeaveGameMode = _GLUT.glutLeaveGameMode

glutGameModeGet = _GLUT.glutGameModeGet

glutMainLoopEvent = _GLUT.glutMainLoopEvent

glutLeaveMainLoop = _GLUT.glutLeaveMainLoop

glutMouseWheelFunc = _GLUT.glutMouseWheelFunc

glutCloseFunc = _GLUT.glutCloseFunc

glutMenuDestroyFunc = _GLUT.glutMenuDestroyFunc

glutSetOption = _GLUT.glutSetOption

glutGetWindowData = _GLUT.glutGetWindowData

glutSetWindowData = _GLUT.glutSetWindowData

glutGetMenuData = _GLUT.glutGetMenuData

glutSetMenuData = _GLUT.glutSetMenuData

glutBitmapHeight = _GLUT.glutBitmapHeight

glutStrokeHeight = _GLUT.glutStrokeHeight

glutBitmapString = _GLUT.glutBitmapString

glutStrokeString = _GLUT.glutStrokeString

glutWireRhombicDodecahedron = _GLUT.glutWireRhombicDodecahedron

glutSolidRhombicDodecahedron = _GLUT.glutSolidRhombicDodecahedron

glutWireSierpinskiSponge = _GLUT.glutWireSierpinskiSponge

glutSolidSierpinskiSponge = _GLUT.glutSolidSierpinskiSponge

glutWireCylinder = _GLUT.glutWireCylinder

glutSolidCylinder = _GLUT.glutSolidCylinder

glutGetProcAddress = _GLUT.glutGetProcAddress
...
GLUT_WINDOW_FORMAT_ID = _GLUT.GLUT_WINDOW_FORMAT_ID
GLUT_DEVICE_IGNORE_KEY_REPEAT = _GLUT.GLUT_DEVICE_IGNORE_KEY_REPEAT
GLUT_DEVICE_KEY_REPEAT = _GLUT.GLUT_DEVICE_KEY_REPEAT
GLUT_HAS_JOYSTICK = _GLUT.GLUT_HAS_JOYSTICK
GLUT_OWNS_JOYSTICK = _GLUT.GLUT_OWNS_JOYSTICK
GLUT_JOYSTICK_BUTTONS = _GLUT.GLUT_JOYSTICK_BUTTONS
GLUT_JOYSTICK_AXES = _GLUT.GLUT_JOYSTICK_AXES
GLUT_JOYSTICK_POLL_RATE = _GLUT.GLUT_JOYSTICK_POLL_RATE
GLUT_KEY_REPEAT_OFF = _GLUT.GLUT_KEY_REPEAT_OFF
GLUT_KEY_REPEAT_ON = _GLUT.GLUT_KEY_REPEAT_ON
GLUT_KEY_REPEAT_DEFAULT = _GLUT.GLUT_KEY_REPEAT_DEFAULT
GLUT_JOYSTICK_BUTTON_A = _GLUT.GLUT_JOYSTICK_BUTTON_A
GLUT_JOYSTICK_BUTTON_B = _GLUT.GLUT_JOYSTICK_BUTTON_B
GLUT_JOYSTICK_BUTTON_C = _GLUT.GLUT_JOYSTICK_BUTTON_C
GLUT_JOYSTICK_BUTTON_D = _GLUT.GLUT_JOYSTICK_BUTTON_D
GLUT_GAME_MODE_ACTIVE = _GLUT.GLUT_GAME_MODE_ACTIVE
GLUT_GAME_MODE_POSSIBLE = _GLUT.GLUT_GAME_MODE_POSSIBLE
GLUT_GAME_MODE_WIDTH = _GLUT.GLUT_GAME_MODE_WIDTH
GLUT_GAME_MODE_HEIGHT = _GLUT.GLUT_GAME_MODE_HEIGHT
GLUT_GAME_MODE_PIXEL_DEPTH = _GLUT.GLUT_GAME_MODE_PIXEL_DEPTH
GLUT_GAME_MODE_REFRESH_RATE = _GLUT.GLUT_GAME_MODE_REFRESH_RATE
GLUT_GAME_MODE_DISPLAY_CHANGED = _GLUT.GLUT_GAME_MODE_DISPLAY_CHANGED
GLUT_ACTION_EXIT = _GLUT.GLUT_ACTION_EXIT
GLUT_ACTION_GLUTMAINLOOP_RETURNS = _GLUT.GLUT_ACTION_GLUTMAINLOOP_RETURNS
GLUT_ACTION_CONTINUE_EXECUTION = _GLUT.GLUT_ACTION_CONTINUE_EXECUTION
GLUT_CREATE_NEW_CONTEXT = _GLUT.GLUT_CREATE_NEW_CONTEXT
GLUT_USE_CURRENT_CONTEXT = _GLUT.GLUT_USE_CURRENT_CONTEXT
GLUT_ACTION_ON_WINDOW_CLOSE = _GLUT.GLUT_ACTION_ON_WINDOW_CLOSE
GLUT_WINDOW_BORDER_WIDTH = _GLUT.GLUT_WINDOW_BORDER_WIDTH
GLUT_WINDOW_HEADER_HEIGHT = _GLUT.GLUT_WINDOW_HEADER_HEIGHT
GLUT_VERSION = _GLUT.GLUT_VERSION
GLUT_RENDERING_CONTEXT = _GLUT.GLUT_RENDERING_CONTEXT
