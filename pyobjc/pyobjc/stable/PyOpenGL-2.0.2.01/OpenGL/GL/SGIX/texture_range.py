...
__doc__ = 'http://oss.sgi.com/projects/ogl-sample/registry/SGIX/texture_range.txt'
...
def glInitTextureRangeSGIX():
	from OpenGL.GL import __has_extension
	return __has_extension("GL_SGIX_texture_range")

glInitTexRangeSGIX = glInitTextureRangeSGIX

def __info():
	if glInitTextureRangeSGIX():
		return []
