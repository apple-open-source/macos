...
__doc__ = 'http://oss.sgi.com/projects/ogl-sample/registry/NV/texture_shader.txt'
...
def glInitTextureShaderNV():
	...
	return __has_extension("GL_NV_texture_shader")

glInitTexShaderNV = glInitTextureShaderNV
