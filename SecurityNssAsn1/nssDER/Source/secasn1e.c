 ...
 * Encoding Rules).
 *
 * $Id: secasn1e.c,v 1.5.20.1 2004/04/08 23:31:00 mb Exp $
 */
	...
	switch (state->underlying_kind) {
	  ...
	  case SEC_ASN1_INTEGER:
	    ...
	    */
		...
		#else
		SECItemType integerType = ((SECItem *)state->src)->type;
		#endif 
		blen = ((SECItem *)state->src)->Length;
