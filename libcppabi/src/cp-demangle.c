...
d_dump (struct demangle_component *dc, int indent)
{
  ...
  switch (dc->type)
    ...
    case DEMANGLE_COMPONENT_POINTER:
      printf ("pointer\n");
      break;
    case DEMANGLE_COMPONENT_RVALUE:
      printf ("rvalue\n");
      break;
...
*/
const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Dd = { NL ("decimal64"),	NL ("decimal64"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_De = { NL ("decimal128"),	NL ("decimal128"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Df = { NL ("decimal32"),	NL ("decimal32"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Dh = { NL ("decimal16"),	NL ("decimal16"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Di = { NL ("char32_t"),	NL ("char32_t"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Ds = { NL ("char16_t"),	NL ("char16_t"), D_PRINT_INT  };

const struct demangle_builtin_type_info
cplus_demangle_builtin_type_Dn = { NL ("nullptr_t"),	NL ("nullptr_t"), D_PRINT_DEFAULT  };
...
cplus_demangle_type (struct d_info *di)
{
  ...
  switch (peek)
   ...
   case 'D':
	...
	case 'd':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Dd);
	    break;
	case 'e':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_De);
	    break;
	case 'f':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Df);
	    break;
	case 'h':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Dh);
	    break;
	case 'i':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Di);
	    break;
	case 's':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Ds);
	    break;
	case 'n':
	    ret = d_make_builtin_type (di,&cplus_demangle_builtin_type_Dn);
	    break;
	default:
	    // error
	    return NULL;
    ...
    case 'O':
      d_advance (di, 1);
      ret = d_make_comp (di, DEMANGLE_COMPONENT_RVALUE,
			 cplus_demangle_type (di), NULL);
      break;
