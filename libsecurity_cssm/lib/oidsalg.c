...
const CSSM_OID
	...
	CSSMOID_RSAWithOAEP 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_RSAWithOAEP},
	CSSMOID_OAEP_MGF1		= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_OAEP_MGF1},
	CSSMOID_OAEP_ID_PSPECIFIED 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_OAEP_ID_PSPECIFIED},
	CSSMOID_SHA224WithRSA 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_SHA224WithRSA},
	CSSMOID_SHA256WithRSA 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_SHA256WithRSA},
	CSSMOID_SHA384WithRSA 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_SHA384WithRSA},
	CSSMOID_SHA512WithRSA 	= {OID_PKCS_1_LENGTH+1, (uint8 *)OID_SHA512WithRSA},
	...
	CSSMOID_SHA224			= {OID_NIST_HASHALG_LENGTH+1, (uint8 *)OID_SHA224},
	CSSMOID_SHA256			= {OID_NIST_HASHALG_LENGTH+1, (uint8 *)OID_SHA256},
	CSSMOID_SHA384			= {OID_NIST_HASHALG_LENGTH+1, (uint8 *)OID_SHA384},
	CSSMOID_SHA512			= {OID_NIST_HASHALG_LENGTH+1, (uint8 *)OID_SHA512},
	CSSMOID_SHA1WithRSA_OIW = {OID_OIW_ALGORITHM_LENGTH+1, (uint8 *)OID_OIW_RSAWithSHA1},
	CSSMOID_DES_CBC			= {OID_OIW_ALGORITHM_LENGTH+1, (uint8 *)OID_OIW_DES_CBC},
	...
	CSSMOID_ANSI_MQV1			= {OID_ANSI_X9_42_SCHEME_LEN + 1, (uint8 *)OID_ANSI_MQV1},
	CSSMOID_ANSI_MQV2			= {OID_ANSI_X9_42_SCHEME_LEN + 1, (uint8 *)OID_ANSI_MQV2},
...
CSSMOID_APPLE_TP_CODE_SIGN = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_CODE_SIGN},
CSSMOID_APPLE_TP_SW_UPDATE_SIGNING = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_SW_UPDATE_SIGNING},
CSSMOID_APPLE_TP_IP_SEC	 = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_IP_SEC},
CSSMOID_APPLE_TP_ICHAT	 = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_ICHAT},
CSSMOID_APPLE_TP_RESOURCE_SIGN = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_RESOURCE_SIGN},
CSSMOID_APPLE_TP_PKINIT_CLIENT	 = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_PKINIT_CLIENT},
CSSMOID_APPLE_TP_PKINIT_SERVER	 = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_PKINIT_SERVER},
CSSMOID_APPLE_TP_CODE_SIGNING	 = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_CODE_SIGNING},
CSSMOID_APPLE_TP_PACKAGE_SIGNING = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_PACKAGE_SIGNING},
CSSMOID_APPLE_TP_MACAPPSTORE_RECEIPT = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_MACAPPSTORE_RECEIPT},
CSSMOID_APPLE_TP_APPLEID_SHARING = {APPLE_TP_OID_LENGTH+1,  (uint8 *)APPLE_TP_APPLEID_SHARING},
...
const CSSM_OID	
	CSSMOID_PKCS5_DIGEST_ALG			= { OID_RSA_HASH_LENGTH, (uint8 *)OID_PKCS5_DIGEST_ALG },
	CSSMOID_PKCS5_ENCRYPT_ALG			= { OID_RSA_ENCRYPT_LENGTH, (uint8 *)OID_PKCS5_ENCRYPT_ALG },
	CSSMOID_PKCS5_HMAC_SHA1				= { OID_RSA_HASH_LENGTH+1, (uint8 *)OID_PKCS5_HMAC_SHA1 },
	CSSMOID_PKCS5_pbeWithMD2AndDES		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithMD2AndDES },
	CSSMOID_PKCS5_pbeWithMD5AndDES		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithMD5AndDES },
	CSSMOID_PKCS5_pbeWithMD2AndRC2		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithMD2AndRC2 },
	CSSMOID_PKCS5_pbeWithMD5AndRC2		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithMD5AndRC2 },
	CSSMOID_PKCS5_pbeWithSHA1AndDES		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithSHA1AndDES },
	CSSMOID_PKCS5_pbeWithSHA1AndRC2		= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_pbeWithSHA1AndRC2 },
	CSSMOID_PKCS5_PBKDF2				= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_PBKDF2 },
	CSSMOID_PKCS5_PBES2					= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_PBES2 },
	CSSMOID_PKCS5_PBMAC1				= { OID_PKCS_5_LENGTH+1, (uint8 *)OID_PKCS5_PBMAC1 },
	CSSMOID_PKCS5_RC2_CBC				= { OID_RSA_ENCRYPT_LENGTH+1, (uint8 *)OID_PKCS5_RC2_CBC },
	CSSMOID_PKCS5_DES_EDE3_CBC			= { OID_RSA_ENCRYPT_LENGTH+1, (uint8 *)OID_PKCS5_DES_EDE3_CBC },
	CSSMOID_PKCS5_RC5_CBC				= { OID_RSA_ENCRYPT_LENGTH+1, (uint8 *)OID_PKCS5_RC5_CBC };
