...
#line 23 "complete.def"

#line 34 "complete.def"
     ...
     WORD_LIST *list;
{
  ...
  if (Farg)
    builtin_error ("%s", _("warning: -F option may not work as you expect"));
  if (Carg)
    builtin_error ("%s", _("warning: -C option may not work as you expect"));
