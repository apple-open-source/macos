...
/* Rhapsody requires __private_extern__ before symbol names that
 * conflict with names in a linked-in dylib (eg. System Framework)
 * in order to "prebind" the binary.
 */
#ifndef __APPLE__
