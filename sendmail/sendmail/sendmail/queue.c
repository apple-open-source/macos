...
#ifndef lint
# if QUEUE
static char id[] = "@(#)$Id: queue.c,v 1.1.1.1 2000/06/10 00:40:56 wsanchez Exp $ (with queueing)";
# else /* QUEUE */
static char id[] = "@(#)$Id: queue.c,v 1.1.1.1 2000/06/10 00:40:56 wsanchez Exp $ (without queueing)";
# endif /* QUEUE */
#endif /* ! lint */
