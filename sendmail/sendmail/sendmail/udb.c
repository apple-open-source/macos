...
#ifndef lint
# if USERDB
static char id[] = "@(#)$Id: udb.c,v 1.1.1.1 2000/06/10 00:40:56 wsanchez Exp $ (with USERDB)";
# else /* USERDB */
static char id[] = "@(#)$Id: udb.c,v 1.1.1.1 2000/06/10 00:40:56 wsanchez Exp $ (without USERDB)";
# endif /* USERDB */
#endif /* ! lint */
