...
#ifndef lint
# if NAMED_BIND
static char id[] = "@(#)$Id: domain.c,v 1.1.1.1 2000/06/10 00:40:55 wsanchez Exp $ (with name server)";
# else /* NAMED_BIND */
static char id[] = "@(#)$Id: domain.c,v 1.1.1.1 2000/06/10 00:40:55 wsanchez Exp $ (without name server)";
# endif /* NAMED_BIND */
#endif /* ! lint */
