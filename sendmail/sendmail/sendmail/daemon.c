...
#ifndef lint
# ifdef DAEMON
static char id[] = "@(#)$Id: daemon.c,v 1.1.1.1 2000/06/10 00:40:55 wsanchez Exp $ (with daemon mode)";
# else /* DAEMON */
static char id[] = "@(#)$Id: daemon.c,v 1.1.1.1 2000/06/10 00:40:55 wsanchez Exp $ (without daemon mode)";
# endif /* DAEMON */
#endif /* ! lint */
