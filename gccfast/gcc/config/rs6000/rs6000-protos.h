...
/* Define global data defined in rs6000.c */
extern const char *rs6000_condexec_insns_str; /* -mcond-exec-insns= option */
extern int rs6000_condexec_insns;             /* value of -mcond-exec-insns */
...
extern int reg_or_postreload_mem_operand PARAMS ((rtx, enum machine_mode));
...
extern char * output_bdxx_branch PARAMS ((const char *, int, int, rtx));
