...
(define_attr "type" "integer,load,load_ext,load_ext_u,load_ext_ux,load_ux,load_u,store,store_ux,store_u,fpload,fpload_ux,fpload_u,fpstore,fpstore_ux,fpstore_u,vecload,vecstore,imul,imul2,imul3,lmul,idiv,ldiv,branch,cmp,fast_compare,compare,delayed_compare,imul_compare,lmul_compare,fpcompare,cr_logical,delayed_cr,mfcr,mfcrf,mtcr,mfjmpr,mtjmpr,fp,fpsimple,dmul,sdiv,ddiv,ssqrt,dsqrt,jmpreg,brinc,vecsimple,veccomplex,vecdiv,veccmp,veccmpsimple,vecperm,vecfloat,vecfdiv,vec_easy,nop"
...
(define_expand "floatunshisf2"
  [
   ...
   (set (match_dup 10) (match_operand:SF 0 "reg_or_mem_operand" ""))
   (set (match_dup 11) (minus:SF (match_dup 10) (match_dup 6)))
...
(define_insn "*movcc_internal1"
  ...
  "@
   ...
   mfcr %0,128
   mfcr %0,%R1\;{rlinm|rlwinm} %0,%0,%f1,0xf0000000
   mr %0,%1
   mf%1 %0
   mt%0 %1
   mt%0 %1
  ...
  [(set_attr "type" "cr_logical,mtcr,mtcr,mfcrf,mfcrf,*,mfjmpr,*,mtjmpr,load,store")
  ...
  "*
{
  ...
  {
    rtx align_rtx[2];
    align_rtx[0] = gen_rtx_CONST_INT(VOIDmode,align_calls_log);
    align_rtx[1] = gen_rtx_CONST_INT(VOIDmode,align_calls_max_skip);
    output_asm_insn(\".p2align %0,,%1\",align_rtx);
  }
  ...
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r")
	(match_operator:SI 1 "scc_comparison_operator"
			   [(match_operand 2 "cc_reg_operand" "y")
			    (const_int 0)]))]
  ""
  "%D1mfcr %0,%R2\;{rlinm|rlwinm} %0,%0,%J1,1"
  [(set_attr "type" "mfcrf")
   (set_attr "length" "12")])
...
(define_insn ""
  ...
  "! TARGET_POWERPC64"
  "@
   %D1mfcr %3,%R2\;{rlinm.|rlwinm.} %3,%3,%J1,1
   #"
  [(set_attr "type" "delayed_compare")
  ...
  "*
{
  ...
  return \"%D1mfcr %0,%R2\;{rlinm|rlwinm} %0,%0,%4,%5,%5\";
}"
  [(set_attr "type" "mfcrf")
   (set_attr "length" "12")])
  ...
  "*
{
  ...
  return \"%D1mfcr %4,%R2\;{rlinm.|rlwinm.} %4,%4,%5,%6,%6\";
}"
  [(set_attr "type" "delayed_compare")
   (set_attr "length" "12,16")])
/* APPLE LOCAL end optimized mfcr instruction generation */
...
(define_insn "*ne0"
  ...
  "! TARGET_POWER && (! TARGET_POWERPC64 || TARGET_32BIT)  && !TARGET_ISEL"
...
(define_insn "*ctrsi_internal1"
  [(set (pc)
	(if_then_else (ne (match_operand:SI 1 "register_operand" "c,*r,*r")
		      ...
		      (label_ref (match_operand 0 "" ""))
		      (pc)))
   (set (match_operand:SI 2 "reg_or_postreload_mem_operand" "=1,*r,m*q*c*l")
	(plus:SI (match_dup 1)
		 (const_int -1)))
  ...
  "*
{
  if (which_alternative != 0)
    ...
    return output_bdxx_branch (\"%l0\", get_attr_length (insn), 0, insn);
}"
  [(set_attr "type" "branch")
   (set_attr "length" "*,12,16")])
  ...
  "*
{
  if (which_alternative != 0)
    ...
    return output_bdxx_branch (\"%l0\", get_attr_length (insn), 1, insn);
}"
  [(set_attr "type" "branch")
   (set_attr "length" "*,12,16")])
...
(define_insn "*ctrdi_internal1"
  [(set (pc)
	(if_then_else (ne (match_operand:DI 1 "register_operand" "c,*r,*r")
		      ...
		      (label_ref (match_operand 0 "" ""))
		      (pc)))
   (set (match_operand:DI 2 "reg_or_postreload_mem_operand" "=1,*r,m*c*l")
	(plus:DI (match_dup 1)
		 (const_int -1)))
   (clobber (match_scratch:CC 3 "=X,&x,&x"))
...
(define_insn "*ctrsi_internal3"
  [(set (pc)
   ...
   (clobber (match_scratch:CC 3 "=X,&x,&X"))
   (clobber (match_scratch:SI 4 "=X,X,r"))]
  "(! TARGET_POWERPC64 || ! TARGET_64BIT) && find_reg_note (insn, REG_NONNEG, 0)"
  "*
{
  if (which_alternative != 0)
    return \"#\";
...
;; APPLE LOCAL 64bit registers, ABI32bit
;; This group is for 32-bit hardware running 32-bit mode
...
;; APPLE LOCAL 64bit registers, ABI32bit
; These two are for 64-bit hardware in 64-bit mode
...
(define_split
  [(set (pc)
   ...
   (clobber (match_scratch:CC 3 ""))
   (clobber (match_scratch:DI 4 ""))]
  "TARGET_POWERPC64 && TARGET_64BIT && reload_completed"
  [(parallel [(set (match_dup 3)
