...
extern void expand_end_cond			PARAMS ((tree));
extern void expand_start_else			PARAMS ((void));
extern void expand_start_elseif			PARAMS ((tree));
extern struct nesting *expand_start_loop 	PARAMS ((int, tree));
extern struct nesting *expand_start_loop_continue_elsewhere 	PARAMS ((int, tree));
...
extern int expand_exit_loop_top_cond		PARAMS ((struct nesting *,
							 tree));
extern int expand_exit_something		PARAMS ((tree));
...
extern void expand_start_case			PARAMS ((int, tree, tree,
						       const char *, tree));
extern void expand_end_case_type		PARAMS ((tree, tree, tree));
#define expand_end_case(cond) expand_end_case_type (cond, NULL, NULL_TREE)
...
extern void print_obstack_name		PARAMS ((char *, FILE *,
						 const char *));
#endif
extern void expand_function_end		PARAMS ((const char *, int, int, tree));
