...
struct profile_info
  {
    ...
    /* Total count of the number of calls instrumented.  */

    int count_instrumented_calls;

    /* Total count of the number of calls instrumented in this function. */

    int count_calls_instrumented_now;
    ...
    /* Max. value of counters in program corresponding to the profile data
       for the current function.  */

    gcov_type max_counter_in_program;

    gcov_type max_call_counter_in_program;
