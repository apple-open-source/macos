...
extern tree get_structure_offset                PARAMS ((tree, tree));
...
extern void c_decorate_for_feedback		PARAMS ((tree, walk_tree_fn));
extern unsigned int c_find_control_flow_tree	PARAMS ((tree));
extern tree c_create_feedback_counter_tree	PARAMS ((tree, int));
