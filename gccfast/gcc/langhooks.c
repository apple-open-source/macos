...
void
lhd_decorate_for_feedback (fndecl, f)
     tree fndecl ATTRIBUTE_UNUSED;
     walk_tree_fn f ATTRIBUTE_UNUSED;
{
}
unsigned int 
lhd_find_control_flow_do_nothing_t (t)
     tree t ATTRIBUTE_UNUSED;
{
  return 0;
}

tree lhd_create_feedback_counter_tree (table, ix)
     tree table ATTRIBUTE_UNUSED;
     int ix ATTRIBUTE_UNUSED;
{
  return NULL_TREE;
}
