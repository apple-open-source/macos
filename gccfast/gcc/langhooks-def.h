...
extern void lhd_decorate_for_feedback PARAMS ((tree, walk_tree_fn));
extern unsigned int lhd_find_control_flow_do_nothing_t PARAMS ((tree));
extern tree lhd_create_feedback_counter_tree PARAMS ((tree, int));
...
/* APPLE LOCAL end new tree dump */
/* APPLE LOCAL new feedback */
#define LANG_HOOKS_NEW_FEEDBACK_DECORATE_FOR_FEEDBACK lhd_decorate_for_feedback
#define LANG_HOOKS_NEW_FEEDBACK_FIND_CONTROL_FLOW_TREE	lhd_find_control_flow_do_nothing_t
#define LANG_HOOKS_NEW_FEEDBACK_CREATE_FEEDBACK_COUNTER_TREE lhd_create_feedback_counter_tree
/* APPLE LOCAL end new feedback */
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  /* APPLE LOCAL end new tree dump */ \
  /* APPLE LOCAL new feedback */ \
  LANG_HOOKS_NEW_FEEDBACK_DECORATE_FOR_FEEDBACK, \
  LANG_HOOKS_NEW_FEEDBACK_FIND_CONTROL_FLOW_TREE, \
  LANG_HOOKS_NEW_FEEDBACK_CREATE_FEEDBACK_COUNTER_TREE, \
  /* APPLE LOCAL end new feedback */ \
