...
bool has_dont_shorten_note       PARAMS ((basic_block));
...
/* Return boolean indicating if bb contains NOTE_INSN_DONT_SHORTEN_BRANCH
   (note indicating NOT to merge the jump with another block)
*/
bool
