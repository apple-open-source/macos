...
struct cp_binding_level GTY(())
  {
    ...
    /* APPLE LOCAL begin improved wrapup_global_declarations fsf candidate */
    /* An array of static functions and variables (for namespaces only) */
    varray_type static_decls;
    /* APPLE LOCAL end improved wrapup_global_declarations fsf candidate */
     ...
     tree newdecl, olddecl;
{
  ...
  if (TREE_CODE (newdecl) == TYPE_DECL
      ...
      /* Some ObjC++ metadata is fwd-declared as 'extern', only to be
	 made 'static' later; we need to tolerate this, at least for
	 now.  */
