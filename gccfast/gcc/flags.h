...
/* Nonzero if calls to floor are to be inlined. */

extern int flag_inline_floor;
...
extern int flag_relax_aliasing;
...
/*Haifa, Align calls to reduce miss-alignment of returns*/
extern int align_calls;
extern int align_calls_log;
extern int align_calls_max_skip;
...
extern int flag_callgraph_inlining;

/* Nonzero to throttle inlining with percentage growth.  */
extern int flag_callgraph_inlining_limit;

/* Nonzero to throttle callgraph inlining with call counts..  */
extern HOST_WIDEST_INT flag_callgraph_inlining_count;

/* haifa begin */
/* inline only if call is executed at least ratio% of hotest call */
extern HOST_WIDEST_INT flag_callgraph_inlining_ratio;

/* inline only if call is executed at least ratio% of total callee */
extern HOST_WIDEST_INT flag_callgraph_inlining_callee_ratio;

/* inline only if call is executed at least ratio% of total caller */
extern HOST_WIDEST_INT flag_callgraph_inlining_caller_ratio;

/* inline always if callee has at most flag_imline_small stmts */
extern HOST_WIDEST_INT flag_callgraph_inline_small;
/* haifa end */
...
extern int flag_loop_to_memset;
...
extern int branch_predictions_threshold;
