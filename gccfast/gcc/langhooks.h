...
struct lang_hooks
{
  ...
  /* APPLE LOCAL new feedback info */
  void (*decorate_for_feedback)		    PARAMS ((tree, walk_tree_fn));
  unsigned int (*find_control_flow_tree)    PARAMS ((tree));
  tree (*create_feedback_counter_tree)	    PARAMS ((tree, int));
  /* APPLE LOCAL end new feedback info */
