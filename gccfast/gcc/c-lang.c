...
#undef LANG_HOOKS_NEW_FEEDBACK_DECORATE_FOR_FEEDBACK
#define LANG_HOOKS_NEW_FEEDBACK_DECORATE_FOR_FEEDBACK c_decorate_for_feedback
#undef LANG_HOOKS_NEW_FEEDBACK_FIND_CONTROL_FLOW_TREE
#define LANG_HOOKS_NEW_FEEDBACK_FIND_CONTROL_FLOW_TREE  c_find_control_flow_tree
#undef LANG_HOOKS_NEW_FEEDBACK_CREATE_FEEDBACK_COUNTER_TREE
#define LANG_HOOKS_NEW_FEEDBACK_CREATE_FEEDBACK_COUNTER_TREE c_create_feedback_counter_tree
