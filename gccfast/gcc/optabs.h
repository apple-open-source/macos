...
#ifdef TREE_CODE
/* Same as above, with the original TREE passed in 
   (feedback-friendly).  Some places tree.h is not included.  */
extern void expand_float_tree PARAMS ((rtx, rtx, int, tree));
extern void expand_fix_tree PARAMS ((rtx, rtx, int, tree));
#endif
