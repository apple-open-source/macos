...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "../.." /I "../src" /I "../../agraph" /I "../../cdt" /I "../../graph" /I "../../third-party/include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_LIBEXPAT" /Fp"$(INTDIR)\dot2gxl.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\dot2gxl.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib agraph.lib cdt.lib common.lib graph.lib ToolsSupport.lib libexpat.lib libexpatw.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\dot2gxl.pdb" /machine:I386 /out:"$(OUTDIR)\dot2gxl.exe" /libpath:"../../third-party/lib" /libpath:"../../makearch/win32/static/release" 
LINK32_OBJS= \
	"$(INTDIR)\cvtgxl.obj" \
	"$(INTDIR)\dot2gxl.obj" \
	"$(INTDIR)\gxl2dot.obj"
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\dot2gxl.exe"
   copy .\Release\dot2gxl.exe ..\..\makearch\win32\static\Release\dot2gxl.exe
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "../.." /I "../src" /I "../../agraph" /I "../../cdt" /I "../../graph" /I "../../third-party/include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_LIBEXPAT" /Fp"$(INTDIR)\dot2gxl.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\dot2gxl.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib agraph.lib cdt.lib common.lib graph.lib ToolsSupport.lib libexpat.lib libexpatw.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\dot2gxl.pdb" /debug /machine:I386 /out:"$(OUTDIR)\dot2gxl.exe" /pdbtype:sept /libpath:"../../third-party/lib" /libpath:"../../makearch/win32/static/debug" 
LINK32_OBJS= \
	"$(INTDIR)\cvtgxl.obj" \
	"$(INTDIR)\dot2gxl.obj" \
	"$(INTDIR)\gxl2dot.obj"
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\dot2gxl.exe"
   copy .\Debug\dot2gxl.exe ..\..\makearch\win32\static\Debug\dot2gxl.exe
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
