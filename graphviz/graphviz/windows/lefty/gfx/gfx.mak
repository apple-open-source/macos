...
CPP=cl.exe
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I ".." /I "..\ws\mswin32" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /Fp"$(INTDIR)\gfx.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\gfx.lib"
   copy .\Release\gfx.lib ..\..\makearch\win32\static\Release
...
CPP=cl.exe
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I ".." /I "..\ws\mswin32" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "MSWIN32" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\gfx.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\gfx.lib" "$(OUTDIR)\gfx.bsc"
   copy .\Debug\gfx.lib ..\..\makearch\win32\static\Debug
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
"$(INTDIR)\lefty.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\lefty.res" /i "\graphvizCVS\builddaemon\graphviz-win\lefty\ws\mswin32" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\lefty.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\lefty.res" /i "\graphvizCVS\builddaemon\graphviz-win\lefty\ws\mswin32" /d "_DEBUG" $(SOURCE)
