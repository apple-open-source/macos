...
static const char * const yytname[] = {   "$","error","$undefined.","T_graph",
"T_digraph","T_strict","T_node","T_edge","T_edgeop","T_id","T_subgraph","'{'",
"'}'","';'","':'","'('","','","')'","'@'","'['","']'","'='","file","@1","graph_type",
"stmt_list","stmt_list1","stmt","stmt1","node_stmt","@2","node_id","node_name",
"edge_stmt","@3","@4","@5","@6","edgeRHS","@7","@8","node_port","port_location",
"port_angle","attr_stmt","@9","attr_class","opt_attr_list","rec_attr_list","attr_list",
"inside_attr_list","attr_set","optcomma","subg_stmt","@10","subg_hdr", NULL
};
#endif
...
-32768,-32768,-32768,-32768,-32768,   -44,-32768,-32768,-32768,    17,
