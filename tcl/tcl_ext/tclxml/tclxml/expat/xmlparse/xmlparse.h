...
/* Turns default expansion of internal entities on/off, depending on the value
 * of expandEntities.  ericm@scriptics.com, 1999.6.28
 */
void XMLPARSEAPI
XML_SetDefaultExpandInternalEntities(XML_Parser parser, int expandEntities);
