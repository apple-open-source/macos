...
package ifneeded xotcl::store::sdbm 1.2 \
   [list load [file join $dir libxotclsdbm1.2[info sharedlibextension]]]

package ifneeded xotcl::store::gdbm 1.2 \
   [list load [file join $dir libxotclgdbm1.2[info sharedlibextension]]]
