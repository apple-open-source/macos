 ...
 *                                last update: 2/3/04 {10:39:36 AM} 
...
TclaeNewOSTypeObj(OSType theOSType)	/* The desired OSType */
{
    ...
    Tcl_ExternalToUtfDString(tclAE_macRoman_encoding, (const char *) &theOSType, sizeof(OSType), &theOSTypeDS);
