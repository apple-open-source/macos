 ...
 *
 * RCS: @(#) $Id: tclMacOSA_OSX.c,v 1.2 2007/08/23 10:58:27 das Exp $
 */
...
/*     return Tcl_PkgProvide(interp, "OSAConnect", "1.0"); */
    return Tcl_PkgProvide(interp, "Tclapplescript", "1.0");
}

#if 0
/*
    ...
    CONST char **argv)
{
	...
	sprintf(buffer, "Error #%-6ld compiling script", (long)osaErr);
