...
/* Name: SMBPrefIOPMTimeoutSecs
 * Type: number
 * Duration in seconds the server will delay sleep when only
 * IPC$ share connections exist.
 * Defaults to 2 minutes.
 */
#define kSMBPrefIOPMTimeoutSecs "IOPMTimeoutSecs"
