...
static void CCAES_Discreet_Cmac(const void *key, const uint8_t *data, size_t dataLength, void *macOut) {
...
static void CCAES_Discreet_Cmac_EvenChunk(const void *key, const uint8_t *data, size_t dataLength, void *macOut) {
...
{
    byteBuffer mdBufdiscreet, mdBufEvenChunk, mdBufoneshot;
