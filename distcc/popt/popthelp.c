...
static void displayArgs(poptContext con,
		/*@unused@*/ enum poptCallbackReason UNUSED(foo),
		struct poptOption * key, 
		/*@unused@*/ const char * UNUSED(arg), /*@unused@*/ void * UNUSED(data))
	/*@globals fileSystem@*/
	/*@modifies fileSystem@*/
{
    if (key->shortName == '?')
...
getArgDescrip(const struct poptOption * opt,
		...
		/*@null@*/ const char * MAYBE_UNUSED(translation_domain))
		/*@=paramuse@*/
	/*@*/
{
...
void poptPrintHelp(poptContext con, FILE * fp, /*@unused@*/ int UNUSED(flags))
{
    int leftColWidth;
...
void poptPrintUsage(poptContext con, FILE * fp, /*@unused@*/ int UNUSED(flags))
{
