...
/*
 * Lookup tables for mul(). Only 6 multiplicands are used when calling this 
 * function so we just have a table for each one.
 */
const word8 mulBy0x02[256] = {
