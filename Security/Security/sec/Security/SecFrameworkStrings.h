...
#define SEC_CK_JOIN_PROMPT          SecStringWithDefaultValue("Enter the Apple ID password for “%@” to allow this new %@ to use your passwords.", "CloudKeychain", 0, "Enter the Apple ID password for “%@” to allow this new %@ to use your passwords.", "Message for alert when a new device is joining the circle")
#define SEC_CK_JOIN_TITLE           SecStringWithDefaultValue("Allow “%@” to Use iCloud Keychain?", "CloudKeychain", 0, "Allow “%@” to Use iCloud Keychain?", "Title for alert when a new device is joining the circle")
