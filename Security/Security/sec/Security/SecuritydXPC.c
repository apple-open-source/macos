...
CFStringRef SOSCCGetOperationDescription(enum SecXPCOperation op)
{
    switch (op) {
        ...
        case sec_keychain_sync_update_key_parameter_id:
            return CFSTR("keychain_sync_update_key_parameter");
        case sec_keychain_sync_update_circle_id:
            return CFSTR("keychain_sync_update_circle");
        ...
        case sec_add_shared_web_credential_id:
            return CFSTR("sec_add_shared_web_credential");
        case sec_copy_shared_web_credential_id:
            return CFSTR("sec_copy_shared_web_credential");
        case sec_otr_session_create_remote_id:
            return CFSTR("sec_otr_session_create_remote");
        case sec_otr_session_process_packet_remote_id:
            return CFSTR("sec_otr_session_process_packet_remote");
        ...
        case kSecXPCOpCopyValidPeerPeerInfo:
            return CFSTR("ValidPeers");
        case kSecXPCOpCopyNotValidPeerPeerInfo:
            return CFSTR("NotValidPeers");
        ...
        case kSecXPCOpCopyRetirementPeerInfo:
            return CFSTR("RetirementPeerInfo");
        case kSecXPCOpCopyGenerationPeerInfo:
            return CFSTR("GenerationPeerInfo");
