...
extern CFTypeRef _kSecKeyWrapPGPSymAlg; /* CFNumber */
extern CFTypeRef _kSecKeyWrapPGPFingerprint; /* CFDataRef, at least 20 bytes */
extern CFTypeRef _kSecKeyWrapPGPWrapAlg; /* kSecKeyWrapRFC6637WrapNNN, or any of the other PGP wrap algs */
