/*
 * Verify CDSA implementation of SHA2 against FIPS test vectors. 
 */
...
#include "cspwrap.h"
#include "common.h"
/* this is for hard-coded lengths only */
