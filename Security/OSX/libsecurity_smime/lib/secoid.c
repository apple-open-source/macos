...
const static SECOidData oids[] = {
    {{0, NULL}, SEC_OID_UNKNOWN, "Unknown OID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION},
    ...
    OD(rc2cbc, SEC_OID_RC2_CBC, "RC2-CBC", CSSM_ALGID_RC2, INVALID_CERT_EXTENSION),
    OD(rc4, SEC_OID_RC4, "RC4", CSSM_ALGID_RC4, INVALID_CERT_EXTENSION),
    OD(desede3cbc, SEC_OID_DES_EDE3_CBC, "DES-EDE3-CBC", CSSM_ALGID_3DES_3KEY_EDE, INVALID_CERT_EXTENSION),
    OD(rc5cbcpad, SEC_OID_RC5_CBC_PAD, "RC5-CBCPad", CSSM_ALGID_RC5, INVALID_CERT_EXTENSION),
    OD(desecb, SEC_OID_DES_ECB, "DES-ECB", CSSM_ALGID_DES, INVALID_CERT_EXTENSION),
    OD(descbc, SEC_OID_DES_CBC, "DES-CBC", CSSM_ALGID_DES, INVALID_CERT_EXTENSION),
    OD(desofb, SEC_OID_DES_OFB, "DES-OFB", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(descfb, SEC_OID_DES_CFB, "DES-CFB", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(desmac, SEC_OID_DES_MAC, "DES-MAC", CSSM_ALGID_DES, INVALID_CERT_EXTENSION),
    OD(desede, SEC_OID_DES_EDE, "DES-EDE", CSSM_ALGID_3DES_3KEY_EDE, INVALID_CERT_EXTENSION),
    OD(isoSHAWithRSASignature, SEC_OID_ISO_SHA_WITH_RSA_SIGNATURE, "ISO SHA with RSA Signature", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs1RSAEncryption, SEC_OID_PKCS1_RSA_ENCRYPTION, "PKCS #1 RSA Encryption", CSSM_ALGID_RSA, INVALID_CERT_EXTENSION),
     ...
     * PKCS #11.
     */
    OD(pkcs1MD2WithRSAEncryption,
       SEC_OID_PKCS1_MD2_WITH_RSA_ENCRYPTION,
       "PKCS #1 MD2 With RSA Encryption",
       CSSM_ALGID_MD2WithRSA,
       INVALID_CERT_EXTENSION),
    OD(pkcs1MD4WithRSAEncryption,
       SEC_OID_PKCS1_MD4_WITH_RSA_ENCRYPTION,
       "PKCS #1 MD4 With RSA Encryption",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs1MD5WithRSAEncryption,
       SEC_OID_PKCS1_MD5_WITH_RSA_ENCRYPTION,
       "PKCS #1 MD5 With RSA Encryption",
       CSSM_ALGID_MD5WithRSA,
       INVALID_CERT_EXTENSION),
    OD(pkcs1SHA1WithRSAEncryption,
       SEC_OID_PKCS1_SHA1_WITH_RSA_ENCRYPTION,
       "PKCS #1 SHA-1 With RSA Encryption",
       CSSM_ALGID_SHA1WithRSA,
       INVALID_CERT_EXTENSION),

    OD(pkcs5PbeWithMD2AndDEScbc,
       SEC_OID_PKCS5_PBE_WITH_MD2_AND_DES_CBC,
       "PKCS #5 Password Based Encryption with MD2 and DES CBC",
       CSSM_ALGID_PKCS5_PBKDF1_MD2,
       INVALID_CERT_EXTENSION),
    OD(pkcs5PbeWithMD5AndDEScbc,
       SEC_OID_PKCS5_PBE_WITH_MD5_AND_DES_CBC,
       "PKCS #5 Password Based Encryption with MD5 and DES CBC",
       CSSM_ALGID_PKCS5_PBKDF1_MD5,
       INVALID_CERT_EXTENSION),
    OD(pkcs5PbeWithSha1AndDEScbc,
       SEC_OID_PKCS5_PBE_WITH_SHA1_AND_DES_CBC,
       "PKCS #5 Password Based Encryption with SHA1 and DES CBC",
       CSSM_ALGID_PKCS5_PBKDF1_SHA1,
       INVALID_CERT_EXTENSION),
    OD(pkcs7, SEC_OID_PKCS7, "PKCS #7", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs7Data, SEC_OID_PKCS7_DATA, "PKCS #7 Data", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs7SignedData, SEC_OID_PKCS7_SIGNED_DATA, "PKCS #7 Signed Data", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs7EnvelopedData, SEC_OID_PKCS7_ENVELOPED_DATA, "PKCS #7 Enveloped Data", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs7SignedEnvelopedData,
       SEC_OID_PKCS7_SIGNED_ENVELOPED_DATA,
       "PKCS #7 Signed And Enveloped Data",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs7DigestedData, SEC_OID_PKCS7_DIGESTED_DATA, "PKCS #7 Digested Data", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs7EncryptedData, SEC_OID_PKCS7_ENCRYPTED_DATA, "PKCS #7 Encrypted Data", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9EmailAddress, SEC_OID_PKCS9_EMAIL_ADDRESS, "PKCS #9 Email Address", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9UnstructuredName, SEC_OID_PKCS9_UNSTRUCTURED_NAME, "PKCS #9 Unstructured Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9ContentType, SEC_OID_PKCS9_CONTENT_TYPE, "PKCS #9 Content Type", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9MessageDigest, SEC_OID_PKCS9_MESSAGE_DIGEST, "PKCS #9 Message Digest", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9SigningTime, SEC_OID_PKCS9_SIGNING_TIME, "PKCS #9 Signing Time", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9CounterSignature, SEC_OID_PKCS9_COUNTER_SIGNATURE, "PKCS #9 Counter Signature", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9ChallengePassword, SEC_OID_PKCS9_CHALLENGE_PASSWORD, "PKCS #9 Challenge Password", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9UnstructuredAddress, SEC_OID_PKCS9_UNSTRUCTURED_ADDRESS, "PKCS #9 Unstructured Address", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9ExtendedCertificateAttributes,
       SEC_OID_PKCS9_EXTENDED_CERTIFICATE_ATTRIBUTES,
       "PKCS #9 Extended Certificate Attributes",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs9SMIMECapabilities, SEC_OID_PKCS9_SMIME_CAPABILITIES, "PKCS #9 S/MIME Capabilities", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520CommonName, SEC_OID_AVA_COMMON_NAME, "X520 Common Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520CountryName, SEC_OID_AVA_COUNTRY_NAME, "X520 Country Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520LocalityName, SEC_OID_AVA_LOCALITY, "X520 Locality Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520StateOrProvinceName, SEC_OID_AVA_STATE_OR_PROVINCE, "X520 State Or Province Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520OrgName, SEC_OID_AVA_ORGANIZATION_NAME, "X520 Organization Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520OrgUnitName, SEC_OID_AVA_ORGANIZATIONAL_UNIT_NAME, "X520 Organizational Unit Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(x520DnQualifier, SEC_OID_AVA_DN_QUALIFIER, "X520 DN Qualifier", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(rfc2247DomainComponent, SEC_OID_AVA_DC, "RFC 2247 Domain Component", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(nsTypeGIF, SEC_OID_NS_TYPE_GIF, "GIF", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(nsTypeJPEG, SEC_OID_NS_TYPE_JPEG, "JPEG", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(nsTypeURL, SEC_OID_NS_TYPE_URL, "URL", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(nsTypeHTML, SEC_OID_NS_TYPE_HTML, "HTML", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(nsTypeCertSeq, SEC_OID_NS_TYPE_CERT_SEQUENCE, "Certificate Sequence", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertKEADSSOld, SEC_OID_MISSI_KEA_DSS_OLD, "MISSI KEA and DSS Algorithm (Old)", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertDSSOld, SEC_OID_MISSI_DSS_OLD, "MISSI DSS Algorithm (Old)", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertKEADSS, SEC_OID_MISSI_KEA_DSS, "MISSI KEA and DSS Algorithm", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertDSS, SEC_OID_MISSI_DSS, "MISSI DSS Algorithm", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertKEA, SEC_OID_MISSI_KEA, "MISSI KEA Algorithm", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(missiCertAltKEA, SEC_OID_MISSI_ALT_KEA, "MISSI Alternate KEA Algorithm", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* Netscape private extensions */
    OD(nsCertExtNetscapeOK, SEC_OID_NS_CERT_EXT_NETSCAPE_OK, "Netscape says this cert is OK", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    ...
    OD(nsExtBaseURL, SEC_OID_NS_CERT_EXT_BASE_URL, "Certificate Extension Base URL", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtRevocationURL, SEC_OID_NS_CERT_EXT_REVOCATION_URL, "Certificate Revocation URL", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtCARevocationURL,
       SEC_OID_NS_CERT_EXT_CA_REVOCATION_URL,
       "Certificate Authority Revocation URL",
       CSSM_ALGID_NONE,
       SUPPORTED_CERT_EXTENSION),
    OD(nsExtCACRLURL, SEC_OID_NS_CERT_EXT_CA_CRL_URL, "Certificate Authority CRL Download URL", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    OD(nsExtCACertURL,
       SEC_OID_NS_CERT_EXT_CA_CERT_URL,
       "Certificate Authority Certificate Download URL",
       CSSM_ALGID_NONE,
       UNSUPPORTED_CERT_EXTENSION),
    OD(nsExtCertRenewalURL, SEC_OID_NS_CERT_EXT_CERT_RENEWAL_URL, "Certificate Renewal URL", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtCAPolicyURL, SEC_OID_NS_CERT_EXT_CA_POLICY_URL, "Certificate Authority Policy URL", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtHomepageURL, SEC_OID_NS_CERT_EXT_HOMEPAGE_URL, "Certificate Homepage URL", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    OD(nsExtEntityLogo, SEC_OID_NS_CERT_EXT_ENTITY_LOGO, "Certificate Entity Logo", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    OD(nsExtUserPicture, SEC_OID_NS_CERT_EXT_USER_PICTURE, "Certificate User Picture", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    OD(nsExtSSLServerName, SEC_OID_NS_CERT_EXT_SSL_SERVER_NAME, "Certificate SSL Server Name", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtComment, SEC_OID_NS_CERT_EXT_COMMENT, "Certificate Comment", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtLostPasswordURL, SEC_OID_NS_CERT_EXT_LOST_PASSWORD_URL, "Lost Password URL", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(nsExtCertRenewalTime, SEC_OID_NS_CERT_EXT_CERT_RENEWAL_TIME, "Certificate Renewal Time", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    ...
    OD(x509PrivateKeyUsagePeriod,
       SEC_OID_X509_PRIVATE_KEY_USAGE_PERIOD,
       "Certificate Private Key Usage Period",
       CSSM_ALGID_NONE,
       UNSUPPORTED_CERT_EXTENSION),
    OD(x509SubjectAltName, SEC_OID_X509_SUBJECT_ALT_NAME, "Certificate Subject Alt Name", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(x509IssuerAltName, SEC_OID_X509_ISSUER_ALT_NAME, "Certificate Issuer Alt Name", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    ...
    OD(x509PolicyMappings, SEC_OID_X509_POLICY_MAPPINGS, "Certificate Policy Mappings", CSSM_ALGID_NONE, UNSUPPORTED_CERT_EXTENSION),
    ...
    OD(x509AuthKeyID, SEC_OID_X509_AUTH_KEY_ID, "Certificate Authority Key Identifier", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    ...
    OD(x509CrlNumber, SEC_OID_X509_CRL_NUMBER, "CRL Number", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    ...
    OD(x500RSAEncryption, SEC_OID_X500_RSA_ENCRYPTION, "X500 RSA Encryption", CSSM_ALGID_RSA, INVALID_CERT_EXTENSION),

    /* added for alg 1485 */
    OD(rfc1274Uid, SEC_OID_RFC1274_UID, "RFC1274 User Id", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(rfc1274Mail, SEC_OID_RFC1274_MAIL, "RFC1274 E-mail Address", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* pkcs 12 additions */
    OD(pkcs12, SEC_OID_PKCS12, "PKCS #12", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12ModeIDs, SEC_OID_PKCS12_MODE_IDS, "PKCS #12 Mode IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12ESPVKIDs, SEC_OID_PKCS12_ESPVK_IDS, "PKCS #12 ESPVK IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12BagIDs, SEC_OID_PKCS12_BAG_IDS, "PKCS #12 Bag IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12CertBagIDs, SEC_OID_PKCS12_CERT_BAG_IDS, "PKCS #12 Cert Bag IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12OIDs, SEC_OID_PKCS12_OIDS, "PKCS #12 OIDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12PBEIDs, SEC_OID_PKCS12_PBE_IDS, "PKCS #12 PBE IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12SignatureIDs, SEC_OID_PKCS12_SIGNATURE_IDS, "PKCS #12 Signature IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12EnvelopingIDs, SEC_OID_PKCS12_ENVELOPING_IDS, "PKCS #12 Enveloping IDs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12PKCS8KeyShrouding, SEC_OID_PKCS12_PKCS8_KEY_SHROUDING, "PKCS #12 Key Shrouding", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12KeyBagID, SEC_OID_PKCS12_KEY_BAG_ID, "PKCS #12 Key Bag ID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12CertAndCRLBagID, SEC_OID_PKCS12_CERT_AND_CRL_BAG_ID, "PKCS #12 Cert And CRL Bag ID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12SecretBagID, SEC_OID_PKCS12_SECRET_BAG_ID, "PKCS #12 Secret Bag ID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12X509CertCRLBag, SEC_OID_PKCS12_X509_CERT_CRL_BAG, "PKCS #12 X509 Cert CRL Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12SDSICertBag, SEC_OID_PKCS12_SDSI_CERT_BAG, "PKCS #12 SDSI Cert Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    ...
    /* DSA signatures */
    OD(ansix9DSASignature, SEC_OID_ANSIX9_DSA_SIGNATURE, "ANSI X9.57 DSA Signature", CSSM_ALGID_DSA, INVALID_CERT_EXTENSION),
    ...
    /* verisign oids */
    OD(verisignUserNotices, SEC_OID_VERISIGN_USER_NOTICES, "Verisign User Notices", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* pkix oids */
    OD(pkixCPSPointerQualifier, SEC_OID_PKIX_CPS_POINTER_QUALIFIER, "PKIX CPS Pointer Qualifier", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixUserNoticeQualifier, SEC_OID_PKIX_USER_NOTICE_QUALIFIER, "PKIX User Notice Qualifier", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(pkixOCSP, SEC_OID_PKIX_OCSP, "PKIX Online Certificate Status Protocol", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPBasicResponse, SEC_OID_PKIX_OCSP_BASIC_RESPONSE, "OCSP Basic Response", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPNonce, SEC_OID_PKIX_OCSP_NONCE, "OCSP Nonce Extension", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPCRL, SEC_OID_PKIX_OCSP_CRL, "OCSP CRL Reference Extension", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPResponse, SEC_OID_PKIX_OCSP_RESPONSE, "OCSP Response Types Extension", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPNoCheck, SEC_OID_PKIX_OCSP_NO_CHECK, "OCSP No Check Extension", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    OD(pkixOCSPArchiveCutoff, SEC_OID_PKIX_OCSP_ARCHIVE_CUTOFF, "OCSP Archive Cutoff Extension", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPServiceLocator, SEC_OID_PKIX_OCSP_SERVICE_LOCATOR, "OCSP Service Locator Extension", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(pkixRegCtrlRegToken,
       SEC_OID_PKIX_REGCTRL_REGTOKEN,
       "PKIX CRMF Registration Control, Registration Token",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixRegCtrlAuthenticator,
       SEC_OID_PKIX_REGCTRL_AUTHENTICATOR,
       "PKIX CRMF Registration Control, Registration Authenticator",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixRegCtrlPKIPubInfo,
    ...
    OD(pkixRegCtrlPKIArchOptions,
       ...
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixRegCtrlOldCertID,
       SEC_OID_PKIX_REGCTRL_OLD_CERT_ID,
       "PKIX CRMF Registration Control, Old Certificate ID",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixRegCtrlProtEncKey,
       SEC_OID_PKIX_REGCTRL_PROTOCOL_ENC_KEY,
       "PKIX CRMF Registration Control, Protocol Encryption Key",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixRegInfoUTF8Pairs, SEC_OID_PKIX_REGINFO_UTF8_PAIRS, "PKIX CRMF Registration Info, UTF8 Pairs", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixRegInfoCertReq,
    ...
    OD(pkixExtendedKeyUsageClientAuth,
       ...
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixExtendedKeyUsageCodeSign, SEC_OID_EXT_KEY_USAGE_CODE_SIGN, "Code Signing Certificate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixExtendedKeyUsageEMailProtect,
       SEC_OID_EXT_KEY_USAGE_EMAIL_PROTECT,
       "E-Mail Protection Certificate",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkixExtendedKeyUsageTimeStamp, SEC_OID_EXT_KEY_USAGE_TIME_STAMP, "Time Stamping Certifcate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkixOCSPResponderExtendedKeyUsage, SEC_OID_OCSP_RESPONDER, "OCSP Responder Certificate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* Netscape Algorithm OIDs */

    OD(netscapeSMimeKEA, SEC_OID_NETSCAPE_SMIME_KEA, "Netscape S/MIME KEA", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* Skipjack OID -- ### mwelch temporary */
    OD(skipjackCBC, SEC_OID_FORTEZZA_SKIPJACK, "Skipjack CBC64", CSSM_ALGID_SKIPJACK, INVALID_CERT_EXTENSION),
    ...
    OD(pkcs12V2PBEWithSha1And40BitRC2cbc,
       ...
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs12SafeContentsID, SEC_OID_PKCS12_SAFE_CONTENTS_ID, "PKCS #12 Safe Contents ID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12PKCS8ShroudedKeyBagID,
       SEC_OID_PKCS12_PKCS8_SHROUDED_KEY_BAG_ID,
       "PKCS #12 Safe Contents ID",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs12V1KeyBag, SEC_OID_PKCS12_V1_KEY_BAG_ID, "PKCS #12 V1 Key Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12V1PKCS8ShroudedKeyBag,
       SEC_OID_PKCS12_V1_PKCS8_SHROUDED_KEY_BAG_ID,
       "PKCS #12 V1 PKCS8 Shrouded Key Bag",
       CSSM_ALGID_NONE,
       INVALID_CERT_EXTENSION),
    OD(pkcs12V1CertBag, SEC_OID_PKCS12_V1_CERT_BAG_ID, "PKCS #12 V1 Cert Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12V1CRLBag, SEC_OID_PKCS12_V1_CRL_BAG_ID, "PKCS #12 V1 CRL Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12V1SecretBag, SEC_OID_PKCS12_V1_SECRET_BAG_ID, "PKCS #12 V1 Secret Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12V1SafeContentsBag, SEC_OID_PKCS12_V1_SAFE_CONTENTS_BAG_ID, "PKCS #12 V1 Safe Contents Bag", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(pkcs9X509Certificate, SEC_OID_PKCS9_X509_CERT, "PKCS #9 X509 Certificate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9SDSICertificate, SEC_OID_PKCS9_SDSI_CERT, "PKCS #9 SDSI Certificate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9X509CRL, SEC_OID_PKCS9_X509_CRL, "PKCS #9 X509 CRL", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9FriendlyName, SEC_OID_PKCS9_FRIENDLY_NAME, "PKCS #9 Friendly Name", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs9LocalKeyID, SEC_OID_PKCS9_LOCAL_KEY_ID, "PKCS #9 Local Key ID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(pkcs12KeyUsageAttr, SEC_OID_PKCS12_KEY_USAGE, "PKCS 12 Key Usage", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(dhPublicKey, SEC_OID_X942_DIFFIE_HELMAN_KEY, "Diffie-Helman Public Key", CSSM_ALGID_DH, INVALID_CERT_EXTENSION),
    OD(netscapeNickname, SEC_OID_NETSCAPE_NICKNAME, "Netscape Nickname", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* Cert Server specific OIDs */
    OD(netscapeRecoveryRequest, SEC_OID_NETSCAPE_RECOVERY_REQUEST, "Recovery Request OID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(nsExtAIACertRenewal, SEC_OID_CERT_RENEWAL_LOCATOR, "Certificate Renewal Locator OID", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(nsExtCertScopeOfUse, SEC_OID_NS_CERT_EXT_SCOPE_OF_USE, "Certificate Scope-of-Use Extension", CSSM_ALGID_NONE, SUPPORTED_CERT_EXTENSION),
    ...
    OD(cmsESDH,
       ...
       CSSM_ALGID_NONE /* XXX */,
       INVALID_CERT_EXTENSION),
    OD(cms3DESwrap, SEC_OID_CMS_3DES_KEY_WRAP, "CMS 3DES Key Wrap", CSSM_ALGID_NONE /* XXX */, INVALID_CERT_EXTENSION),
    OD(cmsRC2wrap, SEC_OID_CMS_RC2_KEY_WRAP, "CMS RC2 Key Wrap", CSSM_ALGID_NONE /* XXX */, INVALID_CERT_EXTENSION),
    OD(smimeEncryptionKeyPreference,
    ...
    /* AES algorithm OIDs */
    OD(aes128_ECB, SEC_OID_AES_128_ECB, "AES-128-ECB", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),
    OD(aes128_CBC, SEC_OID_AES_128_CBC, "AES-128-CBC", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),
    OD(aes192_ECB, SEC_OID_AES_192_ECB, "AES-192-ECB", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),
    OD(aes192_CBC, SEC_OID_AES_192_CBC, "AES-192-CBC", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),
    OD(aes256_ECB, SEC_OID_AES_256_ECB, "AES-256-ECB", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),
    OD(aes256_CBC, SEC_OID_AES_256_CBC, "AES-256-CBC", CSSM_ALGID_AES, INVALID_CERT_EXTENSION),

    /* More bogus DSA OIDs */
    OD(sdn702DSASignature, SEC_OID_SDN702_DSA_SIGNATURE, "SDN.702 DSA Signature", CSSM_ALGID_SHA1WithDSA, INVALID_CERT_EXTENSION),
    ...
    OD(pkcs1SHA256WithRSAEncryption,
       SEC_OID_PKCS1_SHA256_WITH_RSA_ENCRYPTION,
       "PKCS #1 SHA-256 With RSA Encryption",
       CSSM_ALGID_SHA256WithRSA,
       INVALID_CERT_EXTENSION),
    OD(pkcs1SHA384WithRSAEncryption,
       SEC_OID_PKCS1_SHA384_WITH_RSA_ENCRYPTION,
       "PKCS #1 SHA-384 With RSA Encryption",
       CSSM_ALGID_SHA384WithRSA,
       INVALID_CERT_EXTENSION),
    OD(pkcs1SHA512WithRSAEncryption,
       SEC_OID_PKCS1_SHA512_WITH_RSA_ENCRYPTION,
       "PKCS #1 SHA-512 With RSA Encryption",
       CSSM_ALGID_SHA512WithRSA,
       INVALID_CERT_EXTENSION),

    OD(aes128_KEY_WRAP, SEC_OID_AES_128_KEY_WRAP, "AES-128 Key Wrap", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(aes192_KEY_WRAP, SEC_OID_AES_192_KEY_WRAP, "AES-192 Key Wrap", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(aes256_KEY_WRAP, SEC_OID_AES_256_KEY_WRAP, "AES-256 Key Wrap", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* caller-specified OID for eContentType */
    OD(noOid, SEC_OID_OTHER, "Caller-specified eContentType", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(ecPublicKey, SEC_OID_EC_PUBLIC_KEY, "ECDSA Public Key", CSSM_ALGID_ECDSA, INVALID_CERT_EXTENSION),
    OD(ecdsaWithSHA1, SEC_OID_ECDSA_WithSHA1, "SHA-1 With ECDSA", CSSM_ALGID_SHA1WithECDSA, INVALID_CERT_EXTENSION),
    OD(dhSinglePassStdDHsha1kdf, SEC_OID_DH_SINGLE_STD_SHA1KDF, "ECDH With SHA1 KDF", CSSM_ALGID_ECDH_X963_KDF, INVALID_CERT_EXTENSION),
    OD(secp256r1, SEC_OID_SECP_256_R1, "secp256r1", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(secp384r1, SEC_OID_SECP_384_R1, "secp384r1", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(secp521r1, SEC_OID_SECP_521_R1, "secp521r1", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(smimeTimeStampTokenInfo, SEC_OID_PKCS9_ID_CT_TSTInfo, "id-ct-TSTInfo", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(smimeTimeStampToken, SEC_OID_PKCS9_TIMESTAMP_TOKEN, "id-aa-timeStampToken", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    OD(smimeSigningCertificate, SEC_OID_PKCS9_SIGNING_CERTIFICATE, "id-aa-signing-certificate", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* ECDSA with SHA2 */
    OD(ecdsaWithSHA256, SEC_OID_ECDSA_WITH_SHA256, "ECDSA With SHA-256", CSSM_ALGID_SHA256WithECDSA, INVALID_CERT_EXTENSION),
    OD(ecdsaWithSHA384, SEC_OID_ECDSA_WITH_SHA384, "ECDSA With SHA-384", CSSM_ALGID_SHA384WithECDSA, INVALID_CERT_EXTENSION),
    OD(ecdsaWithSHA512, SEC_OID_ECDSA_WITH_SHA512, "ECDSA With SHA-512", CSSM_ALGID_SHA512WithECDSA, INVALID_CERT_EXTENSION),

    /* Apple Hash Agility */
    OD(appleHashAgility, SEC_OID_APPLE_HASH_AGILITY, "appleCodesigningHashAgilityAttribute", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
    OD(appleHashAgilityV2, SEC_OID_APPLE_HASH_AGILITY_V2, "appleCodesigningHashAgilityAttribute", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),

    /* Apple Expiration Time */
    OD(appleExpirationTime, SEC_OID_APPLE_EXPIRATION_TIME, "appleExpirationTimeAttribute", CSSM_ALGID_NONE, INVALID_CERT_EXTENSION),
};
...
static SECStatus secoid_DynamicRehash(void)
{
    SECOidData* oid;
    PLHashEntry* entry;
    int i;
    ...
    if (!oid_d_hash) {
        oid_d_hash =
            PL_NewHashTable(0, SECITEM_Hash, SECITEM_HashCompare, PL_CompareValues, NULL, NULL);
    }
...
/* caller holds oid_hash_mutex */
static SECStatus InitOIDHash(void)
{
    PLHashEntry* entry;
    const SECOidData* oid;
    int i;

    oidhash = PL_NewHashTable(0, SECITEM_Hash, SECITEM_HashCompare, PL_CompareValues, NULL, NULL);
    oidmechhash =
        PL_NewHashTable(0, secoid_HashNumber, PL_CompareValues, PL_CompareValues, NULL, NULL);
    ...
    for (i = 0; i < (sizeof(oids) / sizeof(SECOidData)); i++) {
        ...
        if (oid->cssmAlgorithm != CSSM_ALGID_NONE) {
            ...
            entry = PL_HashTableAdd(oidmechhash, (void*)algorithm, (void*)oid);
            if (entry == NULL) {
                PORT_SetError(SEC_ERROR_LIBRARY_FAILURE);
                PORT_Assert(0); /* This function should never fail. */
                return (SECFailure);
...
SECOidData* SECOID_FindOIDByCssmAlgorithm(CSSM_ALGORITHMS cssmAlgorithm)
{
    SECOidData* ret;
    int rv;
