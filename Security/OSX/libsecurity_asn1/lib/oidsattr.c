 ...
 */
static const uint8_t OID_ObjectClass[] = {OID_ATTR_TYPE, 0},
                     OID_AliasedEntryName[] = {OID_ATTR_TYPE, 1},
                     OID_KnowledgeInformation[] = {OID_ATTR_TYPE, 2},
                     OID_CommonName[] = {OID_ATTR_TYPE, 3}, OID_Surname[] = {OID_ATTR_TYPE, 4},
                     ...
                     OID_Title[] = {OID_ATTR_TYPE, 12}, OID_Description[] = {OID_ATTR_TYPE, 13},
                     ...
                     OID_Member[] = {OID_ATTR_TYPE, 31}, OID_Owner[] = {OID_ATTR_TYPE, 32},
                     ...
                     OID_Name[] = {OID_ATTR_TYPE, 41}, OID_GivenName[] = {OID_ATTR_TYPE, 42},
...
const SecAsn1Oid
    ...
    CSSMOID_CollectiveStateProvinceName = {OID_ATTR_TYPE_LENGTH + 2,
                                           (uint8_t*)OID_CollectiveStateProvinceName},
    ...
    CSSMOID_CollectiveOrganizationName = {OID_ATTR_TYPE_LENGTH + 2,
                                          (uint8_t*)OID_CollectiveOrganizationName},
    CSSMOID_OrganizationalUnitName = {OID_ATTR_TYPE_LENGTH + 1, (uint8_t*)OID_OrganizationalUnitName},
    CSSMOID_CollectiveOrganizationalUnitName = {OID_ATTR_TYPE_LENGTH + 2,
                                                (uint8_t*)OID_CollectiveOrganizationalUnitName},
    ...
    CSSMOID_PhysicalDeliveryOfficeName = {OID_ATTR_TYPE_LENGTH + 1,
                                          (uint8_t*)OID_PhysicalDeliveryOfficeName},
    CSSMOID_CollectivePhysicalDeliveryOfficeName = {OID_ATTR_TYPE_LENGTH + 2,
                                                    (uint8_t*)OID_CollectivePhysicalDeliveryOfficeName},
    CSSMOID_TelephoneNumber = {OID_ATTR_TYPE_LENGTH + 1, (uint8_t*)OID_TelephoneNumber},
    CSSMOID_CollectiveTelephoneNumber = {OID_ATTR_TYPE_LENGTH + 2, (uint8_t*)OID_CollectiveTelephoneNumber},
    ...
    CSSMOID_CollectiveTelexTerminalIdentifier = {OID_ATTR_TYPE_LENGTH + 2,
                                                 (uint8_t*)OID_CollectiveTelexTerminalIdentifier},
    ...
    CSSMOID_CollectiveFacsimileTelephoneNumber = {OID_ATTR_TYPE_LENGTH + 2,
                                                  (uint8_t*)OID_CollectiveFacsimileTelephoneNumber},
    ...
    CSSMOID_CollectiveInternationalISDNNumber = {OID_ATTR_TYPE_LENGTH + 2,
                                                 (uint8_t*)OID_CollectiveInternationalISDNNumber},
    ...
    CSSMOID_SupportedApplicationContext = {OID_ATTR_TYPE_LENGTH + 1,
                                           (uint8_t*)OID_SupportedApplicationContext},
    ...
    CSSMOID_CertificateRevocationList = {OID_ATTR_TYPE_LENGTH + 1, (uint8_t*)OID_CertificateRevocationList},
...
/* From PKCS 9 */
static const uint8_t OID_EmailAddress[] = {OID_PKCS_9, 1},
                     OID_UnstructuredName[] = {OID_PKCS_9, 2},
                     OID_ContentType[] = {OID_PKCS_9, 3},
                     OID_MessageDigest[] = {OID_PKCS_9, 4}, OID_SigningTime[] = {OID_PKCS_9, 5},
...
const SecAsn1Oid CSSMOID_EmailAddress = {OID_PKCS_9_LENGTH + 1, (uint8_t*)OID_EmailAddress},
                 ...
                 CSSMOID_ExtendedCertificateAttributes = {OID_PKCS_9_LENGTH + 1,
                                                          (uint8_t*)OID_ExtendedCertificateAttributes};

/* PKIX */
static const uint8_t OID_QT_CPS[] = {OID_QT, 1}, OID_QT_UNOTICE[] = {OID_QT, 2},
                     _OID_AD_OCSP[] = {OID_AD_OCSP}, OID_AD_CA_ISSUERS[] = {OID_AD, 2},
                     OID_AD_TIME_STAMPING[] = {OID_AD, 3}, OID_AD_CA_REPOSITORY[] = {OID_AD, 5},
                     OID_PDA_DATE_OF_BIRTH[] = {OID_PDA, 1},
                     OID_PDA_PLACE_OF_BIRTH[] = {OID_PDA, 2}, OID_PDA_GENDER[] = {OID_PDA, 3},
                     OID_PDA_COUNTRY_CITIZEN[] = {OID_PDA, 4},
                     OID_PDA_COUNTRY_RESIDENCE[] = {OID_PDA, 5},
                     OID_QCS_SYNTAX_V1[] = {OID_QCS, 1}, OID_QCS_SYNTAX_V2[] = {OID_QCS, 2};

/* ETSI */
static const uint8_t OID_ETSI_QCS_QC_COMPLICANCE[] = {OID_ETSI_QCS, 1},
...
const SecAsn1Oid CSSMOID_QT_CPS = {OID_QT_LENGTH + 1, (uint8_t*)OID_QT_CPS},
...
const SecAsn1Oid CSSMOID_ETSI_QCS_QC_COMPLIANCE = {OID_ETSI_QCS_LENGTH + 1,
                 ...
                 CSSMOID_ETSI_QCS_QC_RETENTION = {OID_ETSI_QCS_LENGTH + 1,
                                                  (uint8_t*)OID_ETSI_QCS_QC_COMPLICANCE},
                 CSSMOID_ETSI_QCS_QC_SSCD = {OID_ETSI_QCS_LENGTH + 1, (uint8_t*)OID_ETSI_QCS_QC_COMPLICANCE};
...
static const uint8_t OID_PKCS7_Data[] = {OID_PKCS_7, 1},
...
static const uint8_t OID_ID_CT_TSTInfo[] = {ID_PKCS9_CONTENT_TYPES, 4},
                     OID_TimeStampToken[] = {ID_PKCS9_ATTRIBUTES, 14};

const SecAsn1Oid CSSMOID_PKCS9_Id_Ct_TSTInfo = {OID_PKCS9_CT_Length + 1, (uint8_t*)OID_ID_CT_TSTInfo},
                 CSSMOID_PKCS9_TimeStampToken = {OID_PKCS9_Attrs_Length + 1, (uint8_t*)OID_TimeStampToken};


const SecAsn1Oid
    CSSMOID_PKCS7_Data = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_Data},
    CSSMOID_PKCS7_SignedData = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_SignedData},
    CSSMOID_PKCS7_EnvelopedData = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_EnvelopedData},
    CSSMOID_PKCS7_SignedAndEnvelopedData = {OID_PKCS_7_LENGTH + 1,
                                            (uint8_t*)OID_PKCS7_SignedAndEnvelopedData},
    CSSMOID_PKCS7_DigestedData = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_DigestedData},
    CSSMOID_PKCS7_EncryptedData = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_EncryptedData},
    CSSMOID_PKCS7_DataWithAttributes = {OID_PKCS_7_LENGTH + 1, (uint8_t*)OID_PKCS7_DataWithAttributes},
    CSSMOID_PKCS7_EncryptedPrivateKeyInfo = {OID_PKCS_7_LENGTH + 1,
                                             (uint8_t*)OID_PKCS7_EncryptedPrivateKeyInfo},

    CSSMOID_PKCS9_FriendlyName = {OID_PKCS_9_LENGTH + 1, (uint8_t*)OID_PKCS9_FriendlyName},
    CSSMOID_PKCS9_LocalKeyId = {OID_PKCS_9_LENGTH + 1, (uint8_t*)OID_PKCS9_LocalKeyId},
    CSSMOID_PKCS9_CertTypes = {OID_PKCS_9_LENGTH + 1, (uint8_t*)OID_PKCS9_CertTypes},
    CSSMOID_PKCS9_CrlTypes = {OID_PKCS_9_LENGTH + 1, (uint8_t*)OID_PKCS9_CrlTypes},
    CSSMOID_PKCS9_X509Certificate = {OID_PKCS9_CertTypesLength + 1, (uint8_t*)OID_PKCS9_X509Certificate},
    CSSMOID_PKCS9_SdsiCertificate = {OID_PKCS9_CertTypesLength + 1, (uint8_t*)OID_PKCS9_SdsiCertificate},
    CSSMOID_PKCS9_X509Crl = {OID_PKCS9_CrlTypesLength + 1, (uint8_t*)OID_PKCS9_X509Crl},


    CSSMOID_PKCS12_keyBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_keyBag},
    CSSMOID_PKCS12_shroudedKeyBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_shroundedKeyBag},
    CSSMOID_PKCS12_certBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_certBag},
    CSSMOID_PKCS12_crlBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_crlBag},
    CSSMOID_PKCS12_secretBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_secretBag},
    CSSMOID_PKCS12_safeContentsBag = {OID_PKCS12_BagTypesLength + 1, (uint8_t*)OID_PKCS12_safeContentsBag}

;

/* Kerberos PKINIT CMS ContentInfo types */

static const uint8_t OID_KERBv5_PKINIT_AUTH_DATA[] = {OID_KERBv5_PKINIT, 1},
                     OID_KERBv5_PKINIT_DH_KEY_DATA[] = {OID_KERBv5_PKINIT, 2},
                     OID_KERBv5_PKINIT_RKEY_DATA[] = {OID_KERBv5_PKINIT, 3};

const SecAsn1Oid CSSMOID_KERBv5_PKINIT_AUTH_DATA = {OID_KERBv5_PKINIT_LEN + 1,
...
static const uint8_t OID_ITU_RFCDATA_2342_UCL_DIRECTORYPILOT_ATTRIBUTES_USERID_Data[] = {
...
static const uint8_t OID_ITU_RFCDATA_2342_UCL_DIRECTORYPILOT_ATTRIBUTES_DOMAINCOMPONENT_Data[] = {
...
static const uint8_t OID_X9_62[] = {OID_ANSI_X9_62},
    ...
    OID_Certicom[] = {OID_CERTICOM}, OID_CerticomEllCurve[] = {OID_CERTICOM_ELL_CURVE},
