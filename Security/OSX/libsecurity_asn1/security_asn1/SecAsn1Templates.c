...
const SecAsn1Template kSecAsn1PointerToAnyTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1AnyTemplate}};

const SecAsn1Template kSecAsn1SequenceOfAnyTemplate[] = {{SEC_ASN1_SEQUENCE_OF, 0, kSecAsn1AnyTemplate}};

const SecAsn1Template kSecAsn1SetOfAnyTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1AnyTemplate}};
...
const SecAsn1Template kSecAsn1SetOfBitStringTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1BitStringTemplate}};
...
const SecAsn1Template kSecAsn1SetOfBMPStringTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1BMPStringTemplate}};

const SecAsn1Template kSecAsn1BooleanTemplate[] = {{SEC_ASN1_BOOLEAN, 0, NULL, sizeof(SecAsn1Item)}};

const SecAsn1Template kSecAsn1PointerToBooleanTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1BooleanTemplate}};

const SecAsn1Template kSecAsn1SequenceOfBooleanTemplate[] = {
    {SEC_ASN1_SEQUENCE_OF, 0, kSecAsn1BooleanTemplate}};

const SecAsn1Template kSecAsn1SetOfBooleanTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1BooleanTemplate}};
...
const SecAsn1Template kSecAsn1SetOfEnumeratedTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1EnumeratedTemplate}};
...
const SecAsn1Template kSecAsn1PointerToIntegerTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1IntegerTemplate}};

const SecAsn1Template kSecAsn1SequenceOfIntegerTemplate[] = {
    {SEC_ASN1_SEQUENCE_OF, 0, kSecAsn1IntegerTemplate}};

const SecAsn1Template kSecAsn1SetOfIntegerTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1IntegerTemplate}};

const SecAsn1Template kSecAsn1NullTemplate[] = {{SEC_ASN1_NULL, 0, NULL, sizeof(SecAsn1Item)}};

const SecAsn1Template kSecAsn1PointerToNullTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1NullTemplate}};
...
const SecAsn1Template kSecAsn1ObjectIDTemplate[] = {{SEC_ASN1_OBJECT_ID, 0, NULL, sizeof(SecAsn1Item)}};

const SecAsn1Template kSecAsn1PointerToObjectIDTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1ObjectIDTemplate}};

const SecAsn1Template kSecAsn1SequenceOfObjectIDTemplate[] = {
    {SEC_ASN1_SEQUENCE_OF, 0, kSecAsn1ObjectIDTemplate}};

const SecAsn1Template kSecAsn1SetOfObjectIDTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1ObjectIDTemplate}};
...
const SecAsn1Template kSecAsn1SetOfT61StringTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1T61StringTemplate}};
...
const SecAsn1Template kSecAsn1PointerToUTCTimeTemplate[] = {{SEC_ASN1_POINTER, 0, kSecAsn1UTCTimeTemplate}};

const SecAsn1Template kSecAsn1SequenceOfUTCTimeTemplate[] = {
    {SEC_ASN1_SEQUENCE_OF, 0, kSecAsn1UTCTimeTemplate}};

const SecAsn1Template kSecAsn1SetOfUTCTimeTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1UTCTimeTemplate}};
...
const SecAsn1Template kSecAsn1SetOfUTF8StringTemplate[] = {{SEC_ASN1_SET_OF, 0, kSecAsn1UTF8StringTemplate}};
 ...
 */
const SecAsn1Template kSecAsn1SkipTemplate[] = {{SEC_ASN1_SKIP}};
