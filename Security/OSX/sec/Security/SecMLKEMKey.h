...
/*!
    @header SecMLKEMKey.h
    The functions provided in SecMLKEMKey.h implement and manage ML-KEM cipher
*/

#ifndef _SECURITY_SECMLKEMKEY_H_
#define _SECURITY_SECMLKEMKEY_H_
...
#endif /* !_SECURITY_SECMLKEMKEY_H_ */
