...
SOFT_LINK_CONSTANT(CryptoTokenKit, TKUserSecretTriesLeftErrorKey, NSString *)
SOFT_LINK_CONSTANT(CryptoTokenKit, TKClientTokenParameterAuthenticationContextProvidedBySecCaller, NSString *)
SOFT_LINK_NONOBJECT_CONSTANT(CryptoTokenKit, TKTokenNotFoundAndRegistered, TKErrorCode)
