...
static void tests(void)
{
    ...
    // When running on iOS device in debugger, the target usually runs as root and no simcrash will actually happen,
    // because file with access rights '000' is read-write available.
