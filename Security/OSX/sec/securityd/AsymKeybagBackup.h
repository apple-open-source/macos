...
/*!
 @header SecBackupServer
 The functions provided in SecBackupServer provide an interface to
 the backend for SecBackup SPIs in the server.
 */

#ifndef SecBackupServer_h
#define SecBackupServer_h
