...
{
    { DER_OFFSET(DERNameConstraints, permittedSubtrees),
        ASN1_CONTEXT_SPECIFIC | ASN1_CONSTRUCTED | 0,
        DER_DEC_OPTIONAL },
    { DER_OFFSET(DERNameConstraints, excludedSubtrees),
        ASN1_CONTEXT_SPECIFIC | ASN1_CONSTRUCTED | 1,
        DER_DEC_OPTIONAL }
};
const DERSize DERNumNameConstraintsItemSpecs =
sizeof(DERNameConstraintsItemSpecs) /sizeof(DERItemSpec);

/* DERGeneralSubtree. */
const DERItemSpec DERGeneralSubtreeItemSpecs[] =
{
    { DER_OFFSET(DERGeneralSubtree, generalName),
        0,					/* no tag - ANY */
        DER_DEC_ASN_ANY | DER_DEC_SAVE_DER},
    { DER_OFFSET(DERGeneralSubtree, minimum),
        ASN1_CONTEXT_SPECIFIC | 0,
        DER_DEC_OPTIONAL},
    { DER_OFFSET(DERGeneralSubtree, maximum),
        ASN1_CONTEXT_SPECIFIC | 1,
        DER_DEC_OPTIONAL }
};
const DERSize DERNumGeneralSubtreeItemSpecs =
