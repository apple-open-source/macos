...
const CFStringRef kSecACLAuthorizationAny = CFSTR("ACLAuthorizationAny");

const CFStringRef kSecACLAuthorizationLogin = CFSTR("ACLAuthorizationLogin");
const CFStringRef kSecACLAuthorizationGenKey = CFSTR("ACLAuthorizationGenKey");
const CFStringRef kSecACLAuthorizationDelete = CFSTR("ACLAuthorizationDelete");
const CFStringRef kSecACLAuthorizationExportWrapped = CFSTR("ACLAuthorizationExportWrapped");
const CFStringRef kSecACLAuthorizationExportClear = CFSTR("ACLAuthorizationExportClear");
const CFStringRef kSecACLAuthorizationImportWrapped = CFSTR("ACLAuthorizationImportWrapped");
const CFStringRef kSecACLAuthorizationImportClear = CFSTR("ACLAuthorizationImportClear");
const CFStringRef kSecACLAuthorizationSign = CFSTR("ACLAuthorizationSign");
const CFStringRef kSecACLAuthorizationEncrypt = CFSTR("ACLAuthorizationEncrypt");
const CFStringRef kSecACLAuthorizationDecrypt = CFSTR("ACLAuthorizationDecrypt");
const CFStringRef kSecACLAuthorizationMAC = CFSTR("ACLAuthorizationMAC");
const CFStringRef kSecACLAuthorizationDerive = CFSTR("ACLAuthorizationDerive");

/* Defined authorization tag values for Keychain */



const CFStringRef kSecACLAuthorizationKeychainCreate = CFSTR("ACLAuthorizationKeychainCreate");
const CFStringRef kSecACLAuthorizationKeychainDelete = CFSTR("ACLAuthorizationKeychainDelete");
const CFStringRef kSecACLAuthorizationKeychainItemRead = CFSTR("ACLAuthorizationKeychainItemRead");
const CFStringRef kSecACLAuthorizationKeychainItemInsert = CFSTR("ACLAuthorizationKeychainItemInsert");
const CFStringRef kSecACLAuthorizationKeychainItemModify = CFSTR("ACLAuthorizationKeychainItemModify");
const CFStringRef kSecACLAuthorizationKeychainItemDelete = CFSTR("ACLAuthorizationKeychainItemDelete");
