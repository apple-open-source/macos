...
//
// Apply a block to a dictionary
//
typedef void (^CFDictionaryApplierBlock)(const void *, const void *);
void cfDictionaryApplyBlock(CFDictionaryRef source, CFDictionaryApplierBlock block);
...
//
// Apply a block to aa array
//
typedef void (^CFArrayApplierBlock)(const void *value);
