/*
 * Copyright (c) 2000-2004,2008-2015 Apple Inc. All Rights Reserved.
 *
...
static const uint8
	...
	OID_APPLE_EXTENSION_DEVELOPER_AUTHENTICATION[] = { APPLE_EXTENSION_DEVELOPER_AUTHENTICATION },
	OID_APPLE_EXTENSION_SERVER_AUTHENTICATION[] = { APPLE_EXTENSION_SERVER_AUTHENTICATION },
	OID_APPLE_EXTENSION_ESCROW_SERVICE[] = { APPLE_EXTENSION_ESCROW_SERVICE },
	OID_APPLE_EXTENSION_PROVISIONING_PROFILE_SIGNING[] = { APPLE_EXTENSION_PROVISIONING_PROFILE_SIGNING }
;
...
CSSMOID_APPLE_EXTENSION_DEVELOPER_AUTHENTICATION= { APPLE_EXTENSION_DEVELOPER_AUTHENTICATION_LENGTH,
												(uint8 *)OID_APPLE_EXTENSION_DEVELOPER_AUTHENTICATION },
CSSMOID_APPLE_EXTENSION_SERVER_AUTHENTICATION   = { APPLE_EXTENSION_SERVER_AUTHENTICATION_LENGTH,
												(uint8 *)OID_APPLE_EXTENSION_SERVER_AUTHENTICATION },
CSSMOID_APPLE_EXTENSION_ESCROW_SERVICE          = { APPLE_EXTENSION_ESCROW_SERVICE_LENGTH + 1,
												(uint8 *)OID_APPLE_EXTENSION_ESCROW_SERVICE },
CSSMOID_APPLE_EXTENSION_PROVISIONING_PROFILE_SIGNING = { APPLE_EKU_OID_LENGTH + 1,
												(uint8 *)OID_APPLE_EXTENSION_PROVISIONING_PROFILE_SIGNING }
;
