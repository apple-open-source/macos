...
SECStatus
SECOID_CopyAlgorithmID(PRArenaPool *arena, SECAlgorithmID *to, const SECAlgorithmID *from)
{
    SECStatus rv;
...
SECComparison
SECOID_CompareAlgorithmID(const SECAlgorithmID *a, const SECAlgorithmID *b)
{
    SECComparison rv;
