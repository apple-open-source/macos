...
#include <CryptKitCSP/FEESignatureObject.h>
#include <CryptKit/feePublicKey.h>
#include <CryptKit/feeDigitalSignature.h>
...
/*
 * Note that, unlike the implementation in CryptKit/feePublicKey.c, we ignore
