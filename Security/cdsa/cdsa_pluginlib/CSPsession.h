...
#include <Security/CSPabstractsession.h>
#include <map>

#if defined(_CPP_CSPSESSION)
# pragma export on
#endif
...
protected:
	...
	public:
		...
		void allocate(size_t needed, CssmAllocator &alloc);
...
public:
	...
	static CssmData makeBuffer(size_t size, CssmAllocator &alloc);
...
public:
    ...
    public:
		...
		virtual CSPContext *clone(CssmAllocator &);	// clone internal state
    ...
    protected:
        ...
        void final(CssmData &out, CssmAllocator &alloc);
        void final(Writer &writer, CssmAllocator &alloc);
...
public:
	...
	static void makeReferenceKey(CssmAllocator &allocator, KeyReference keyReference, CSSM_KEY &ioKey);
	static KeyReference keyReference(const CSSM_KEY &key);
	static KeyReference freeReferenceKey(CssmAllocator &allocator, CSSM_KEY &ioKey);
