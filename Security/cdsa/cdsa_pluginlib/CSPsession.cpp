...
CSPFullPluginSession::CSPContext *CSPContext::clone(CssmAllocator &)
...
void CSPContext::final(CssmData &out, CssmAllocator &alloc)
{
...
void CSPContext::final(Writer &writer, CssmAllocator &alloc)
{
...
void
KeyPool::freeKey(CssmAllocator &allocator, CSSM_KEY &ioKey)
{
...
//
void
ReferencedKey::makeReferenceKey(CssmAllocator &allocator, KeyReference keyReference, CSSM_KEY &key)
{
...
ReferencedKey::KeyReference
ReferencedKey::freeReferenceKey(CssmAllocator &allocator, CSSM_KEY &key)
{
