...
SPIPREFIX CSSM_RETURN CSSM_SPI_ModuleLoad (const CSSM_GUID *CssmGuid,
...
SPIPREFIX CSSM_RETURN CSSM_SPI_ModuleUnload (const CSSM_GUID *CssmGuid,
    const CSSM_GUID *ModuleGuid,
    CSSM_SPI_ModuleEventHandler CssmNotifyCallback,
    void *CssmNotifyCallbackCtx)
{
...
SPIPREFIX CSSM_RETURN CSSM_SPI_ModuleAttach (const CSSM_GUID *ModuleGuid,
...
SPIPREFIX CSSM_RETURN CSSM_SPI_ModuleDetach (CSSM_MODULE_HANDLE ModuleHandle)
{
    BEGIN_API
