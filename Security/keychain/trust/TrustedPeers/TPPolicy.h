...
@class TPCategoryRule;

/*!
 TPPolicy represents the ability to calculate Octagon Policy, as per
 https://confluence.sd.apple.com/display/KEY/Octagon+Policy
 
 Instances of this class are typically obtained from TPPolicyDocument,
 by passing a (possibly empty) dictionary of secrets to
...
@interface TPPolicy : NSObject<TPPolicy>
