...
@interface SecKEMTesterConfig : NSObject

@property (nonatomic, readonly) id keyType;
@property (nonatomic, readonly) id keySize;
@property (nonatomic, readonly) SecKeyAlgorithm algorithm;
@property (nonatomic, readonly) const struct cckem_info *kemInfo;
...
@interface SecKEMTester : NSObject
