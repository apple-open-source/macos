...
const CFStringRef kAKSInfoCacheFlowContext = CFSTR("cfc");
#endif

@implementation OTAppleKeyStoreActualAdapter

- (AKSEvent*)eventsRegister:(dispatch_queue_t)queue callback:(void (^)(AKSEventType, CFDictionaryRef))callback
{
#if !TARGET_OS_SIMULATOR
    return AKSEventsRegister(queue, callback);
#else
    return nullptr;
#endif
}
