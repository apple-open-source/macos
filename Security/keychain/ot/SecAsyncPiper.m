...
-(instancetype)initWithError:(NSError**)error {
    if (self = [super init]) {
        ...
        close(fds[1]); // fds[0] will be closed when _readHandle is dealloc'd
        if (_writeXpcFd == nil) {
        ...
        _queue = dispatch_queue_create("SecAsyncPiper", DISPATCH_QUEUE_SERIAL);
