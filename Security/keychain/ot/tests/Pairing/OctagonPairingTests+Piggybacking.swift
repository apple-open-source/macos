...
extension OctagonPairingTests {
    ...
    func testSOSFailingPiggybackingStillWorksForOctagon() throws {
        OctagonSetSOSFeatureEnabled(true)
        enableSOSCompatibilityForTests()
        ...
        requestCircleSession.setContextIDFor(self.initiatorArguments.contextID)
        requestCircleSession.setControlObject(self.otControl)
        requestCircleSession.setFailSOSPropertyForTests(true)
        acceptSession!.setFailSOSPropertyForTests(true)
