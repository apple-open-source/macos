...
let prevailingPolicyVersion = TPPolicyVersion(version: 11, hash: "SHA256:Cm1JV53DOukT+DcNYpkbTc8+rH3cAb/1Cop6Zn7PC28=")
...
var builtInPolicyDocuments: [TPPolicyDocument] = {
    ...
    // Also, when adding the next policy, please sort the fields that don't require ordering. Previous policies are in unsorted order.
