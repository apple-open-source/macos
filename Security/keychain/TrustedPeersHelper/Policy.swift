...
let prevailingPolicyVersion = TPPolicyVersion(version: 16, hash: "SHA256:/4gt8WFEXCVLYI+C+8/2MiMz6Srv0vpcvlkJ4gkepHQ=")
...
private let reservedVersions: Set<TPCounter> = [14, 15]
