/*
	...
	Contains:	implementation of low-level comcryption engine

	Written by:	Richard Crandall and Doug Mitchell
	...
	Change History (most recent first):
		...
		11/11/97	gab		Modified for MacOS (fixed implicit type
								conversions)
		10/29/97	dpm		Extensive mods for stream-oriented API.
		10/01/97	rc		original by Richard Crandall

	To Do:


   Library for holistic (one-pass) compress-encrypt.
   This is an explicit embodiment of the Comcryption^(TM)
   invention.
