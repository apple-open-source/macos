...
static void *CL_malloc(
     ...
     void *allocref)
{
	return CssmAllocator::standard().malloc(size);
}
...
static void CL_free(
     ...
     void *allocref)
{
	CssmAllocator::standard().free(memblock);
}
...
static void *CL_realloc(
     ...
     void *allocref)
{
	return CssmAllocator::standard().realloc(memblock, size);
}
...
static void *CL_calloc(
     ...
     void *allocref)
{
	return CssmAllocator::standard().calloc(num, size);
}
