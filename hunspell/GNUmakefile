...
Patch_List     = configure.diff hunspell.cxx.diff hunspell.1.diff hunspell.3.diff hunspell.4.diff hunzip.1.diff hzip.1.diff hu_hunspell.1.diff hu_hunspell.4.diff
