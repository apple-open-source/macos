...
EQPrefs         theEQPrefs = 
{
    ...
    0x00000009,                         // eqCount	(update EQPrefsElement array size in AppleTexas2EQPrefs.cpp when updating eqCount!)
    0x00000000,                         // nameID
    {                                   // eq
        {                               // ----------     Equalization Set #1     ----------
		...
		{                               // ----------     Equalization Set #9     ----------
            ...
            0x0000000E,                 // filterCount  = 14
            {                           // filter coefficients in sets of:  b0, b1, b2, a1, a2 and are in 4.20 format
                {{{ 0x10, 0x0E, 0xFB }, { 0xE0, 0xB6, 0xFD }, { 0x0F, 0x3D, 0xCA }, { 0xE0, 0xB6, 0xFD }, { 0x0F, 0x4C, 0xC5 }}},
                {{{ 0x0F, 0xC8, 0xF2 }, { 0xE1, 0x3B, 0x36 }, { 0x0F, 0x17, 0xA8 }, { 0xE1, 0x3B, 0x36 }, { 0x0E, 0xE0, 0x9A }}},
                {{{ 0x0F, 0xD3, 0xA2 }, { 0xE2, 0x2D, 0x89 }, { 0x0E, 0xFE, 0x50 }, { 0xE2, 0x2D, 0x89 }, { 0x0E, 0xD1, 0xF2 }}},
                {{{ 0x10, 0x84, 0x41 }, { 0x03, 0x48, 0xF3 }, { 0x0A, 0x0B, 0x20 }, { 0x03, 0x48, 0xF3 }, { 0x0A, 0x8F, 0x61 }}},
                {{{ 0x10, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }}},
                {{{ 0x10, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }}},
                {{{ 0x10, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }}},
                {{{ 0x10, 0x0E, 0xFB }, { 0xE0, 0xB6, 0xFD }, { 0x0F, 0x3D, 0xCA }, { 0xE0, 0xB6, 0xFD }, { 0x0F, 0x4C, 0xC5 }}},
