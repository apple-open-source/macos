...
#ifndef _BSDCONFIGURENODE_H
#define _BSDCONFIGURENODE_H

#include "BDPIVirtualNode.h"

class BSDConfigureNode : public BDPIVirtualNode
{
	public:
										BSDConfigureNode( CFStringRef inNodeName, uid_t inUID, uid_t inEffectiveUID );
		virtual							~BSDConfigureNode( void );
