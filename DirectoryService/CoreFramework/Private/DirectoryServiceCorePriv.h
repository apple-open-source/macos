...
/*!
 * @header DirectoryServiceCorePriv
 * Umbrella header file for the private core API header files.
 */

#ifndef __DirectoryServiceCorePriv_h__
#define	__DirectoryServiceCorePriv_h__	1
...
#include <DirectoryServiceCore/DSLogException.h>
...
#endif  // __DirectoryServiceCorePriv_h__
