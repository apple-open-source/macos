...
class simulatorarm64_platform(Platform):
    arch = 'arm64'
    triple = 'arm64-apple-darwin13'
...
class device64e_platform(Platform):
    arch = 'arm64e'
    triple = 'aarch64-apple-darwin13'

    prefix = "#ifdef __arm64e__\n\n"
    suffix = "\n\n#endif"
    src_dir = 'aarch64'
    src_files = ['sysv.S', 'ffi.c', 'internal.h']
...
class ios_simulator_platform(simulator_platform):
    ...
    sdk = 'iphonesimulator'
    version_min = '-mios-simulator-version-min=9.0'
...
class ios_simulatorarm64_platform(simulatorarm64_platform):
    directory = 'darwin_ios'
    sdk = 'iphonesimulator'
    version_min = '-mios-simulator-version-min=14.0'
...
class ios_device64e_platform(device64e_platform):
    directory = 'darwin_ios'
    sdk = 'iphoneos'
    version_min = '-miphoneos-version-min=9.0'
...
class desktoparm64_platform(Platform):
    directory = 'darwin_osx'
    sdk = 'macosx'
    arch = 'arm64'
    triple = 'arm64-apple-darwin20'
...
class desktoparm64e_platform(Platform):
    directory = 'darwin_osx'
    sdk = 'macosx'
    arch = 'arm64e'
    triple = 'arm64e-apple-darwin20'
    version_min = '-mmacosx-version-min=11.0'
...
class tvos_simulatorarm64_platform(simulatorarm64_platform):
    directory = 'darwin_tvos'
    sdk = 'appletvsimulator'
    version_min = '-mtvos-simulator-version-min=14.0'


class tvos_simulator64_platform(simulator64_platform):
    directory = 'darwin_tvos'
    sdk = 'appletvsimulator'
    version_min = '-mtvos-simulator-version-min=9.0'
...
class tvos_device64e_platform(device64e_platform):
    directory = 'darwin_tvos'
    sdk = 'appletvos'
    version_min = '-mtvos-version-min=9.0'
...
class watchos_simulator_platform(simulator_platform):
    ...
    sdk = 'watchsimulator'
    version_min = '-mwatchos-simulator-version-min=4.0'


class watchos_simulator64_platform(simulator64_platform):
    directory = 'darwin_watchos'
    sdk = 'watchsimulator'
    version_min = '-mwatchos-simulator-version-min=7.0'


class watchos_simulatorarm64_platform(simulatorarm64_platform):
    directory = 'darwin_watchos'
    sdk = 'watchsimulator'
    version_min = '-mwatchos-simulator-version-min=7.0'
...
class watchos_device64_platform(device64_platform):
    ...
    sdk = 'watchos'
    arch = 'arm64'
    version_min = '-mwatchos-version-min=7.0'


class watchos_device64e_platform(device64e_platform):
    directory = 'darwin_watchos'
    sdk = 'watchos'
    arch = 'arm64e'
    version_min = '-mwatchos-version-min=7.0'
...
def generate_source_and_headers(
    ...
    if generate_ios:
        ...
        copy_src_platform_files(ios_simulatorarm64_platform)
        copy_src_platform_files(ios_device_platform)
        copy_src_platform_files(ios_device64_platform)
        copy_src_platform_files(ios_device64e_platform)
    if generate_osx:
        copy_src_platform_files(desktop64_platform)
        copy_src_platform_files(desktoparm64_platform)
        copy_src_platform_files(desktoparm64e_platform)
    if generate_tvos:
        copy_src_platform_files(tvos_simulator64_platform)
        copy_src_platform_files(tvos_simulatorarm64_platform)
        copy_src_platform_files(tvos_device64_platform)
        copy_src_platform_files(tvos_device64e_platform)
    if generate_watchos:
    ...
    if generate_ios:
        ...
        build_target(ios_simulatorarm64_platform, platform_headers)
        build_target(ios_device_platform, platform_headers)
        build_target(ios_device64_platform, platform_headers)
        build_target(ios_device64e_platform, platform_headers)
    if generate_osx:
        build_target(desktop64_platform, platform_headers)
        build_target(desktoparm64_platform, platform_headers)
    if generate_tvos:
        build_target(tvos_simulator64_platform, platform_headers)
        build_target(tvos_simulatorarm64_platform, platform_headers)
        build_target(tvos_device64_platform, platform_headers)
        build_target(tvos_device64e_platform, platform_headers)
    if generate_watchos:
