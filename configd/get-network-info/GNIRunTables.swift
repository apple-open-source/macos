...
let runTableForDefaultCommands: [(String, String?, Bool)] = [
	...
	("/usr/sbin/scutil --nwi -a",					"network-information.txt",		false),
	("/usr/bin/dig +time=2 -t any -c any www.apple.com", 		"dig-info.txt",				false),
	("/sbin/ifconfig -a -L -b -m -r -v -v",				"ifconfig.txt",				false),
	("/usr/sbin/netstat -% 1 -n -r -a -l , -% 1 -A -a -l -n -v -W , -% 1 -s , -% 1 -rs , -% 1 -mmm , -% 1 -i -n -d , -% 1 -i -x -R , -% 1 -L -a -n -v , -% 1 -g -n -s , -% 1 -B , -% 1 -n -s -i , -% 1 -qq -i , -% 1 -Q -i",
									"netstat.txt",				false),
	("/sbin/pfctl -l -s all",						"pf.txt",				false),
	("/sbin/pfctl -l -s References",					"pf.txt",				false),
	("/usr/sbin/setkey -Pp -D",					"ipsec.txt",				false),
	("/usr/sbin/skywalkctl print-banner , status , show , flow -n , flow-route -n , flow-switch , flow-owner , flow-adv , netstat -s , netstat -s --global , netstat -s -o , interface , channel , provider -D , netns -a , memory , aop",
									"skywalk.txt",				false),
...
let runTableForSensitiveInfo: [(String, String?, Bool)] = [
	...
	("/usr/sbin/ndp -% 1 -n -a , -% 1 -n -p , -% 1 -n -r , -% 1 -i",
								"ndp-info.txt",			false),
