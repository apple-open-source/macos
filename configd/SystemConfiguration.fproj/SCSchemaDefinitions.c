...
const CFStringRef kSCPropNetDNSEncryptedServers                    = CFSTR("EncryptedServers");
const CFStringRef kSCPropNetDNSEncryptedServerAuthenticationDomainName = CFSTR("AuthenticationDomainName");
const CFStringRef kSCPropNetDNSEncryptedServerServicePriority      = CFSTR("ServicePriority");
const CFStringRef kSCPropNetDNSEncryptedServerAddresses            = CFSTR("Addresses");
const CFStringRef kSCPropNetDNSEncryptedServerALPN                 = CFSTR("ALPN");
const CFStringRef kSCPropNetDNSEncryptedServerPort                 = CFSTR("Port");
const CFStringRef kSCPropNetDNSEncryptedServerDoHPath              = CFSTR("DoHPath");
const CFStringRef kSCPropNetDNSEncryptedServerServiceParameters    = CFSTR("ServiceParameters");
