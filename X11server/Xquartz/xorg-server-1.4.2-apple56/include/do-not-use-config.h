...
#define OSNAME "Darwin 10.4.0 i386"
...
#define PACKAGE_STRING "xorg-server 1.4.2-apple56"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xorg-server"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.4.2-apple56"
...
/* Vendor man version */
#define XORG_MAN_VERSION "Version 1.4.2-apple56"
