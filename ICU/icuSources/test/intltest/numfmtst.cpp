...
NumberFormatTest::TestCurrency(void)
{
    ...
    if (!(s==CharsToUnicodeString("1,50\\u00A0$"))) // Apple data change
...
NumberFormatTest::TestSpaceParsing() {
    ...
    const TestSpaceParsingItem DATA[] = {
        ...
        {"$124 ",          4, -1, FALSE},
      //{"$ 124 ",         0,  1, FALSE},
        {"$ 124 ",         5, -1, FALSE}, // Apple <rdar://problem/38565910> also changes this expected result (for the better...)
        {"$\\u00A0124 ",   5, -1, FALSE},
        {" $ 124 ",        0,  0, FALSE},
        {"124$",           0,  4, FALSE},
        {"124 $",          0,  3, FALSE},
...
NumberFormatTest::TestCurrencyParsing() {
    static const char* DATA[][6] = {
        ...
        {"fa_CA", "1", "USD", "US$\\u06f1\\u066b\\u06f0\\u06f0", "\\u200eUSD\\u06f1\\u066b\\u06f0\\u06f0", "\\u06f1\\u066b\\u06f0\\u06f0 \\u062f\\u0644\\u0627\\u0631 \\u0627\\u0645\\u0631\\u06cc\\u06a9\\u0627"},
...
void NumberFormatTest::TestAccountingCurrency() {
    ...
    expect(NumberFormat::createInstance("en_ID", style, status),
        (Formattable)(double)0, UnicodeString("IDR\\u00A00").unescape(), TRUE, status); // Apple mod
    expect(NumberFormat::createInstance("en_ID", style, status),
        (Formattable)(double)-0.2, UnicodeString("(IDR\\u00A00)").unescape(), TRUE, status); // Apple mod
...
void NumberFormatTest::Test13850_EmptyStringCurrency() {
    ...
    for (const auto& cas : cases) {
        ...
        if (cas.currencyArg==nullptr || cas.currencyArg[0]==0) {
            // <rdar://problem/49544607> Restore behavior in which empty/null sets locale default
