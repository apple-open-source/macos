...
GENRB_SOURCE_LOCAL = ars.txt ckb.txt ckb_IQ.txt ckb_IR.txt\
	iu.txt iu_CA.txt ms_Arab.txt ms_Arab_BN.txt ms_Arab_MY.txt\
	tg.txt tg_TJ.txt tk.txt tk_TM.txt\
	en_AD.txt en_AL.txt en_BA.txt en_BR.txt en_CN.txt\
