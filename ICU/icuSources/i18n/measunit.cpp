...
static const UAMeasureUnit indexToUAMeasUnit[] = {
    ...
    UAMEASUNIT_CONCENTRATION_PERCENT,                 // (18 << 8) + 4,  # 21  percent
    UAMEASUNIT_CONCENTRATION_PERMILLE,                // (18 << 8) + 5,  # 22  permille
    UAMEASUNIT_CONCENTRATION_PART_PER_MILLION,        // (18 << 8) + 3,  # 23  permillion
    UAMEASUNIT_CONCENTRATION_PERMYRIAD,               // (18 << 8) + 6,  # 24  permyriad
    //                                                                   # --- consumption (25)
    UAMEASUNIT_CONSUMPTION_LITER_PER_100_KILOMETERs,  // (13 << 8) + 2,  # 25  liter-per-100-kilometer
    ...
    //                                                                   # --- graphics (75)
    UAMEASUNIT_GRAPHICS_DOT,                          // (21 << 8) + 7,  # 75  dot
    UAMEASUNIT_GRAPHICS_DOT_PER_CENTIMETER,           // (21 << 8) + 5,  # 76  dot-per-centimeter
    UAMEASUNIT_GRAPHICS_DOT_PER_INCH,                 // (21 << 8) + 6,  # 77  dot-per-inch
    UAMEASUNIT_GRAPHICS_EM,                           // (21 << 8) + 0,  # 78  em
    UAMEASUNIT_GRAPHICS_MEGAPIXEL,                    // (21 << 8) + 2,  # 79  megapixel
    UAMEASUNIT_GRAPHICS_PIXEL,                        // (21 << 8) + 1,  # 80  pixel
    UAMEASUNIT_GRAPHICS_PIXEL_PER_CENTIMETER,         // (21 << 8) + 3,  # 81  pixel-per-centimeter
    UAMEASUNIT_GRAPHICS_PIXEL_PER_INCH,               // (21 << 8) + 4,  # 82  pixel-per-inch
    //                                                                   # --- length (83)
    UAMEASUNIT_LENGTH_ASTRONOMICAL_UNIT,              // (5 << 8) + 16,  # 83  astronomical-unit
    UAMEASUNIT_LENGTH_CENTIMETER,                     // (5 << 8) + 1,   # 84  centimeter
    UAMEASUNIT_LENGTH_DECIMETER,                      // (5 << 8) + 10,  # 85  decimeter
    UAMEASUNIT_LENGTH_EARTH_RADIUS,                   // (5 << 8) + 21,  # 86  earth-radius
    UAMEASUNIT_LENGTH_FATHOM,                         // (5 << 8) + 14,  # 87  fathom
    UAMEASUNIT_LENGTH_FOOT,                           // (5 << 8) + 5,   # 88  foot
    UAMEASUNIT_LENGTH_FURLONG,                        // (5 << 8) + 15,  # 89  furlong
    UAMEASUNIT_LENGTH_INCH,                           // (5 << 8) + 6,   # 90  inch
    UAMEASUNIT_LENGTH_KILOMETER,                      // (5 << 8) + 2,   # 91  kilometer
    UAMEASUNIT_LENGTH_LIGHT_YEAR,                     // (5 << 8) + 9,   # 92  light-year
    UAMEASUNIT_LENGTH_METER,                          // (5 << 8) + 0,   # 93  meter
    UAMEASUNIT_LENGTH_MICROMETER,                     // (5 << 8) + 11,  # 94  micrometer
    UAMEASUNIT_LENGTH_MILE,                           // (5 << 8) + 7,   # 95  mile
    UAMEASUNIT_LENGTH_MILE_SCANDINAVIAN,              // (5 << 8) + 18,  # 96  mile-scandinavian
    UAMEASUNIT_LENGTH_MILLIMETER,                     // (5 << 8) + 3,   # 97  millimeter
    UAMEASUNIT_LENGTH_NANOMETER,                      // (5 << 8) + 12,  # 98  nanometer
    UAMEASUNIT_LENGTH_NAUTICAL_MILE,                  // (5 << 8) + 13,  # 99  nautical-mile
    UAMEASUNIT_LENGTH_PARSEC,                         // (5 << 8) + 17,  # 100 parsec
    UAMEASUNIT_LENGTH_PICOMETER,                      // (5 << 8) + 4,   # 101 picometer
    UAMEASUNIT_LENGTH_POINT,                          // (5 << 8) + 19,  # 102 point
    UAMEASUNIT_LENGTH_SOLAR_RADIUS,                   // (5 << 8) + 20,  # 103 solar-radius
    UAMEASUNIT_LENGTH_YARD,                           // (5 << 8) + 8,   # 104 yard
    //                                                                   # --- light (105)
    UAMEASUNIT_LIGHT_CANDELA,                         // (17 << 8) + 2   # 105 candela
    UAMEASUNIT_LIGHT_LUMEN,                           // (17 << 8) + 3   # 106 lumen
    UAMEASUNIT_LIGHT_LUX,                             // (17 << 8) + 0,  # 107 lux
    UAMEASUNIT_LIGHT_SOLAR_LUMINOSITY,                // (17 << 8) + 1,  # 108 solar-luminosity
    //                                                                   # --- mass (109)
    UAMEASUNIT_MASS_CARAT,                            // (6 << 8) + 9,   # 109 carat
    UAMEASUNIT_MASS_DALTON,                           // (6 << 8) + 11,  # 110 dalton
    UAMEASUNIT_MASS_EARTH_MASS,                       // (6 << 8) + 12,  # 111 earth-mass
    UAMEASUNIT_MASS_GRAIN,                            // (6 << 8) + 14,  # 112 grain
    UAMEASUNIT_MASS_GRAM,                             // (6 << 8) + 0,   # 113 gram
    UAMEASUNIT_MASS_KILOGRAM,                         // (6 << 8) + 1,   # 114 kilogram
    UAMEASUNIT_MASS_METRIC_TON,                       // (6 << 8) + 7,   # 115 metric-ton
    UAMEASUNIT_MASS_MICROGRAM,                        // (6 << 8) + 5,   # 116 microgram
    UAMEASUNIT_MASS_MILLIGRAM,                        // (6 << 8) + 6,   # 117 milligram
    UAMEASUNIT_MASS_OUNCE,                            // (6 << 8) + 2,   # 118 ounce
    UAMEASUNIT_MASS_OUNCE_TROY,                       // (6 << 8) + 10,  # 119 ounce-troy
    UAMEASUNIT_MASS_POUND,                            // (6 << 8) + 3,   # 120 pound
    UAMEASUNIT_MASS_SOLAR_MASS,                       // (6 << 8) + 13,  # 121 solar-mass
    UAMEASUNIT_MASS_STONE,                            // (6 << 8) + 4,   # 122 stone
    UAMEASUNIT_MASS_TON,                              // (6 << 8) + 8,   # 123 ton
    //                                                                   # --- none (124)
    UAMEASUNIT_CONCENTRATION_PERCENT,                 // BOGUS           # 124 base
    UAMEASUNIT_CONCENTRATION_PERCENT,                 // BOGUS           # 125 percent
    UAMEASUNIT_CONCENTRATION_PERMILLE,                // BOGUS           # 126 permille
    //                                                                   # --- power (127)
    UAMEASUNIT_POWER_GIGAWATT,                        // (7 << 8) + 5,   # 127 gigawatt
    UAMEASUNIT_POWER_HORSEPOWER,                      // (7 << 8) + 2,   # 128 horsepower
    UAMEASUNIT_POWER_KILOWATT,                        // (7 << 8) + 1,   # 129 kilowatt
    UAMEASUNIT_POWER_MEGAWATT,                        // (7 << 8) + 4,   # 130 megawatt
    UAMEASUNIT_POWER_MILLIWATT,                       // (7 << 8) + 3,   # 131 milliwatt
    UAMEASUNIT_POWER_WATT,                            // (7 << 8) + 0,   # 132 watt
    //                                                                   # --- pressure (133)
    UAMEASUNIT_PRESSURE_ATMOSPHERE,                   // (8 << 8) + 5,   # 133 atmosphere
    UAMEASUNIT_PRESSURE_BAR,                          // (8 << 8) + 9,   # 134 bar
    UAMEASUNIT_PRESSURE_HECTOPASCAL,                  // (8 << 8) + 0,   # 135 hectopascal
    UAMEASUNIT_PRESSURE_INCH_HG,                      // (8 << 8) + 1,   # 136 inch-ofhg
    UAMEASUNIT_PRESSURE_KILOPASCAL,                   // (8 << 8) + 6,   # 137 kilopascal
    UAMEASUNIT_PRESSURE_MEGAPASCAL,                   // (8 << 8) + 7,   # 138 megapascal
    UAMEASUNIT_PRESSURE_MILLIBAR,                     // (8 << 8) + 2,   # 139 millibar
    UAMEASUNIT_PRESSURE_MILLIMETER_OF_MERCURY,        // (8 << 8) + 3,   # 140 millimeter-ofhg
    UAMEASUNIT_PRESSURE_PASCAL,                       // (8 << 8) + 8,   # 141 pascal
    UAMEASUNIT_PRESSURE_POUND_PER_SQUARE_INCH,        // (8 << 8) + 4,   # 142 pound-force-per-square-inch
    //                                                                   # --- speed (143)
    UAMEASUNIT_SPEED_KILOMETER_PER_HOUR,              // (9 << 8) + 1,   # 143 kilometer-per-hour
    UAMEASUNIT_SPEED_KNOT,                            // (9 << 8) + 3,   # 144 knot
    UAMEASUNIT_SPEED_METER_PER_SECOND,                // (9 << 8) + 0,   # 145 meter-per-second
    UAMEASUNIT_SPEED_MILE_PER_HOUR,                   // (9 << 8) + 2,   # 146 mile-per-hour
    //                                                                   # --- temperature (147)
    UAMEASUNIT_TEMPERATURE_CELSIUS,                   // (10 << 8) + 0,  # 147 celsius
    UAMEASUNIT_TEMPERATURE_FAHRENHEIT,                // (10 << 8) + 1,  # 148 fahrenheit
    UAMEASUNIT_TEMPERATURE_GENERIC,                   // (10 << 8) + 3,  # 149 generic
    UAMEASUNIT_TEMPERATURE_KELVIN,                    // (10 << 8) + 2,  # 150 kelvin
    //                                                                   # --- torque (151)
    UAMEASUNIT_TORQUE_NEWTON_METER,                   // (20 << 8) + 0,  # 151 newton-meter
    UAMEASUNIT_TORQUE_POUND_FOOT,                     // (20 << 8) + 1,  # 152 pound-force-foot
    //                                                                   # --- volume (153)
    UAMEASUNIT_VOLUME_ACRE_FOOT,                      // (11 << 8) + 13, # 153 acre-foot
    UAMEASUNIT_VOLUME_BARREL,                         // (11 << 8) + 26, # 154 barrel
    UAMEASUNIT_VOLUME_BUSHEL,                         // (11 << 8) + 14, # 155 bushel
    UAMEASUNIT_VOLUME_CENTILITER,                     // (11 << 8) + 4,  # 156 centiliter
    UAMEASUNIT_VOLUME_CUBIC_CENTIMETER,               // (11 << 8) + 8,  # 157 cubic-centimeter
    UAMEASUNIT_VOLUME_CUBIC_FOOT,                     // (11 << 8) + 11, # 158 cubic-foot
    UAMEASUNIT_VOLUME_CUBIC_INCH,                     // (11 << 8) + 10, # 159 cubic-inch
    UAMEASUNIT_VOLUME_CUBIC_KILOMETER,                // (11 << 8) + 1,  # 160 cubic-kilometer
    UAMEASUNIT_VOLUME_CUBIC_METER,                    // (11 << 8) + 9,  # 161 cubic-meter
    UAMEASUNIT_VOLUME_CUBIC_MILE,                     // (11 << 8) + 2,  # 162 cubic-mile
    UAMEASUNIT_VOLUME_CUBIC_YARD,                     // (11 << 8) + 12, # 163 cubic-yard
    UAMEASUNIT_VOLUME_CUP,                            // (11 << 8) + 18, # 164 cup
    UAMEASUNIT_VOLUME_CUP_METRIC,                     // (11 << 8) + 22, # 165 cup-metric
    UAMEASUNIT_VOLUME_DECILITER,                      // (11 << 8) + 5,  # 166 deciliter
    UAMEASUNIT_VOLUME_DESSERT_SPOON,                  // (11 << 8) + 27, # 167 dessert-spoon
    UAMEASUNIT_VOLUME_DESSERT_SPOON_IMPERIAL,         // (11 << 8) + 28, # 168 dessert-spoon-imperial
    UAMEASUNIT_VOLUME_DRAM,                           // (11 << 8) + 29, # 169 dram
    UAMEASUNIT_VOLUME_DROP,                           // (11 << 8) + 30, # 170 drop
    UAMEASUNIT_VOLUME_FLUID_OUNCE,                    // (11 << 8) + 17, # 171 fluid-ounce
    UAMEASUNIT_VOLUME_FLUID_OUNCE_IMPERIAL,           // (11 << 8) + 25, # 172 fluid-ounce-imperial
    UAMEASUNIT_VOLUME_GALLON,                         // (11 << 8) + 21, # 173 gallon
    UAMEASUNIT_VOLUME_GALLON_IMPERIAL,                // (11 << 8) + 24, # 174 gallon-imperial
    UAMEASUNIT_VOLUME_HECTOLITER,                     // (11 << 8) + 6,  # 175 hectoliter
    UAMEASUNIT_VOLUME_JIGGER,                         // (11 << 8) + 31, # 176 jigger
    UAMEASUNIT_VOLUME_LITER,                          // (11 << 8) + 0,  # 177 liter
    UAMEASUNIT_VOLUME_MEGALITER,                      // (11 << 8) + 7,  # 178 megaliter
    UAMEASUNIT_VOLUME_MILLILITER,                     // (11 << 8) + 3,  # 179 milliliter
    UAMEASUNIT_VOLUME_PINCH,                          // (11 << 8) + 32, # 180 pinch
    UAMEASUNIT_VOLUME_PINT,                           // (11 << 8) + 19, # 181 pint
    UAMEASUNIT_VOLUME_PINT_METRIC,                    // (11 << 8) + 23, # 182 pint-metric
    UAMEASUNIT_VOLUME_QUART,                          // (11 << 8) + 20, # 183 quart
    UAMEASUNIT_VOLUME_QUART_IMPERIAL,                 // (11 << 8) + 33, # 184 quart-imperial
    UAMEASUNIT_VOLUME_TABLESPOON,                     // (11 << 8) + 16, # 185 tablespoon
    UAMEASUNIT_VOLUME_TEASPOON,                       // (11 << 8) + 15, # 186 teaspoon
};
