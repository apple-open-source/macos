...
// NOTE: Apple removes the apostrophes from the version numbers because the Apple-internal ScenDependencies tool
// doesn't support C++14
#if defined(__cpp_lib_ranges) && __cpp_lib_ranges >= 202110L // See above for the value.
...
// NOTE: Apple removes the apostrophes from the version numbers because the Apple-internal ScenDependencies tool
// doesn't support C++14
#if defined(__cpp_lib_concepts) && __cpp_lib_concepts >= 202002L // Test against C++20 concepts.
namespace {
