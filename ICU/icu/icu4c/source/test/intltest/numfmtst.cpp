...
// rdar://
  TESTCASE_AUTO(TestCurrencySymbolCountryFallback);
...
#if APPLE_ICU_CHANGES
// rdar://
    fmt.setAttribute(UNUM_FORMAT_WITH_FULL_PRECISION, 1, status);
#endif  // APPLE_ICU_CHANGES
...
// but I'm changing the test because the minimumGroupingDigits change looks legitimate
    {"it_IT@currency=ITL", "ITL\\u00A01150" },
#else
    {"it_IT@currency=ITL", "ITL\\u00A01.150" },
#endif  // APPLE_ICU_CHANGES
#if APPLE_ICU_CHANGES
// rdar://
    {"pt_PT@currency=PTE", "1150$50\\u00A0\\u200B"}, // per cldrbug 7670
#else
...
// rdar://109171835
#if APPLE_ICU_CHANGES
    static const char16_t SLE[] = {0x53, 0x4C, 0x45, 0}; /*SLE*/
#endif
...
// rdar://109171835
#if APPLE_ICU_CHANGES
    assertEquals("SLE.getName(SYMBOL_NAME, en)",
                CharsToUnicodeString("\\u05dc\\u05d9\\u05d0\\u05d5\\u05df \\u05e1\\u05d9\\u05d9\\u05e8\\u05d4 \\u05dc\\u05d0\\u05d5\\u05e0\\u05d9"),
               UnicodeString(ucurr_getName(SLE, "he",
                                           UCURR_LONG_NAME,
...
// rdar://
    ...
    assertEquals("HNL.getName(LONG_NAME) for hu",
                 UnicodeString(u"hondurasi lempira", -1),
                 UnicodeString(ucurr_getName(u"HNL", "hu",
                                             UCURR_LONG_NAME,
                                             &isChoiceFormat, &len, &ec)),
                                             possibleDataError);
#endif  // APPLE_ICU_CHANGES
...
#if APPLE_ICU_CHANGES
// rdar://
void NumberFormatTest::TestCurrencySymbolCountryFallback(void) {
    UErrorCode ec = U_ZERO_ERROR;
    int32_t len;
    
    // Tests for rdar://62548298
    assertEquals("USD.getName(SYMBOL_NAME, en_US)",
                 UnicodeString("$"),
                 UnicodeString(ucurr_getName(u"USD", "en_US",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("CAD.getName(SYMBOL_NAME, en_US)",
                 UnicodeString("CA$"),
                 UnicodeString(ucurr_getName(u"CAD", "en_US",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("USD.getName(SYMBOL_NAME, en_CA)",
                 UnicodeString("US$"),
                 UnicodeString(ucurr_getName(u"USD", "en_CA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("CAD.getName(SYMBOL_NAME, en_CA)",
                 UnicodeString("$"),
                 UnicodeString(ucurr_getName(u"CAD", "en_CA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("CAD.getName(SYMBOL_NAME, ru)",
                 UnicodeString("CA$"),
                 UnicodeString(ucurr_getName(u"CAD", "ru",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("CAD.getName(SYMBOL_NAME, ru_CA)",
                 UnicodeString("$"),
                 UnicodeString(ucurr_getName(u"CAD", "ru_CA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(SYMBOL_NAME, fr_FR)",
                 UnicodeString("THB"),
                 UnicodeString(ucurr_getName(u"THB", "fr_FR",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(SYMBOL_NAME, fr_TH)",
                 UnicodeString(u"\u0e3f"),
                 UnicodeString(ucurr_getName(u"THB", "fr_TH",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(SYMBOL_NAME, th_TH)",
                 UnicodeString(u"\u0e3f"),
                 UnicodeString(ucurr_getName(u"THB", "th_TH",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(SYMBOL_NAME, th_US)",
                 UnicodeString(u"\u0e3f"),
                 UnicodeString(ucurr_getName(u"THB", "th_FR",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(LONG_NAME, fr_FR)",
                 UnicodeString(u"baht tha\u00eflandais"),
                 UnicodeString(ucurr_getName(u"THB", "fr_FR",
                                             UCURR_LONG_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(LONG_NAME, fr_TH)",
                 UnicodeString(u"baht tha\u00eflandais"),
                 UnicodeString(ucurr_getName(u"THB", "fr_TH",
                                             UCURR_LONG_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(LONG_NAME, th_TH)",
                 UnicodeString(u"\u0e1a\u0e32\u0e17"),
                 UnicodeString(ucurr_getName(u"THB", "th_TH",
                                             UCURR_LONG_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("THB.getName(LONG_NAME, th_US)",
                 UnicodeString(u"\u0e1a\u0e32\u0e17"),
                 UnicodeString(ucurr_getName(u"THB", "th_FR",
                                             UCURR_LONG_NAME,
                                             NULL, &len, &ec)),
    ...
    // Additional tests for rdar://77347002
    assertEquals("SAR.getName(SYMBOL_NAME, ar_SA)",
                 UnicodeString(u"\u0631.\u0633.\u200F"),
                 UnicodeString(ucurr_getName(u"SAR", "ar_SA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, en_US)",
                 UnicodeString(u"SAR"),
                 UnicodeString(ucurr_getName(u"SAR", "en_US",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, ar_US)",
                 UnicodeString(u"\u0631.\u0633.\u200F"),
                 UnicodeString(ucurr_getName(u"SAR", "ar_US",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, en_SA)",
                 UnicodeString(u"SAR"),
                 UnicodeString(ucurr_getName(u"SAR", "en_SA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, ru_RU)",
                 UnicodeString(u"SAR"),
                 UnicodeString(ucurr_getName(u"SAR", "ru_RU",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, ar_RU)",
                 UnicodeString(u"\u0631.\u0633.\u200F"),
                 UnicodeString(ucurr_getName(u"SAR", "ar_RU",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("SAR.getName(SYMBOL_NAME, ru_SA)",
                 UnicodeString(u"SAR"),
                 UnicodeString(ucurr_getName(u"SAR", "ru_SA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("RUR.getName(SYMBOL_NAME, ar_SA)",
                 UnicodeString(u"RUR"),
                 UnicodeString(ucurr_getName(u"RUR", "ar_SA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("RUR.getName(SYMBOL_NAME, ru_RU)",
                 UnicodeString(u"\u0440."),
                 UnicodeString(ucurr_getName(u"RUR", "ru_RU",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("RUR.getName(SYMBOL_NAME, ar_RU)",
                 UnicodeString(u"RUR"),
                 UnicodeString(ucurr_getName(u"RUR", "ar_RU",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    assertEquals("RUR.getName(SYMBOL_NAME, ru_SA)",
                 UnicodeString(u"\u0440."),
                 UnicodeString(ucurr_getName(u"RUR", "ru_SA",
                                             UCURR_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
    
    // rdar://56247241
    assertEquals("DKK.getName(NARROW_NAME, en_DK)",
                 UnicodeString("kr."),
                 UnicodeString(ucurr_getName(u"DKK", "en_DK",
                                             UCURR_NARROW_SYMBOL_NAME,
                                             NULL, &len, &ec)),
                 false);
...
#if APPLE_ICU_CHANGES
// rdar://
    UnicodeString expected(CharsToUnicodeString("1150$50\\u00A0\\u200B")); // per cldrbug 7670
#else
...
#if APPLE_ICU_CHANGES
// rdar://97937093
        errln("Error formatting number: " + UnicodeString(u_errorName(status), -1, US_INV));
#else
...
#if APPLE_ICU_CHANGES
// rdar://97937093
        errln("Error parsing number: " + UnicodeString(u_errorName(status), -1, US_INV));
#else
...
NumberFormatTest::TestSpaceParsing() {
    ...
    const TestSpaceParsingItem DATA[] = {
        ...
        {"$124 ",          4, -1, false},
//#if APPLE_ICU_CHANGES
// NOTE: The OCISU implementation changed out from under us here (in ICU 78).  They've gone to much stricter parsing than we
// had before, and I don't think there's a good way to make this test case pass (i.e., uphold the old Apple override) without
// violating the spirit of the OS change and causing other unit tests to fail.  We could override the entire stricter-parsing
// change, but that also seems questionable (especially since this is the only related unit tests that's currently failing.
// I don't think this unit-test change is key to any Apple-specific use cases, so I'm reverting the unit-test override.
// --rtg 10/27/25 for rdar://157895131
//// rdar://38565910>
//// also changes this expected result (for the better...)
//        {"$ 124 ",         5, -1, false},
//#else
        {"$ 124 ",         0,  1, false},
//#endif  // APPLE_ICU_CHANGES
...
#if APPLE_ICU_CHANGES
// rdar://
        {"fa_CA", "1", "USD", "US$\\u06f1\\u066b\\u06f0\\u06f0", "\\u200eUSD\\u06f1\\u066b\\u06f0\\u06f0", "\\u06f1\\u066b\\u06f0\\u06f0 \\u062f\\u0644\\u0627\\u0631 \\u0622\\u0645\\u0631\\u06cc\\u06a9\\u0627"},
#else
...
NumberFormatTest::TestParseCurrencyInUCurr() {
    const char* DATA[] = {
        ...
        "Malaysian ringgit1.00",
#if APPLE_ICU_CHANGES
// rdar://102181560 (Malaysian Ringgit plural form should be “ringgit” instead of “ringgits”)
#else
...
// rdar://
    ...
    if (df != NULL) {
        UErrorCode status = U_ZERO_ERROR;
        df->setAttribute(UNUM_FORMAT_WITH_FULL_PRECISION, true, status);
    }
#endif  // APPLE_ICU_CHANGES
    UnicodeString appendTo;
...
#if APPLE_ICU_CHANGES
// rdar://49544607
        if (cas.currencyArg==nullptr || cas.currencyArg[0]==0) {
            // rdar://49544607 Restore behavior in which empty/null sets locale default
...
#if APPLE_ICU_CHANGES
// rdar://
        assertEquals("currency", u"", nf->getCurrency()); // rdar://51985640
#else
...
#if APPLE_ICU_CHANGES
// rdar://126991186 (Problems with grouping in unum_ functions when specifying patterns)
// if you create a DecimalFormat without grouping and then turn grouping on, grouping size now
// defaults to 3
