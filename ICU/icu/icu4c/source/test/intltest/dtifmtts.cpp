...
// rdar://
        "en", "CE 2007 11 10 10:10:10", "CE 2007 11 20 10:10:10", "dMMMyhm", "Nov 10, 2007 at 10:10\\u202FAM\\u2009\\u2013\\u2009Nov 20, 2007 at 10:10\\u202FAM",
#else
...
// rdar://98584839 en_US: Compact date shown alongside inline widget shows “12 Fri” instead of “Fri 12”
        "en", "CE 2007 10 10 10:10:10", "CE 2008 10 10 10:10:10", "Ed", "Wed 10\\u2009\\u2013\\u2009Fri 10",
#else
...
#if APPLE_ICU_CHANGES
// rdar://
        "en", "CE 2007 10 10 10:10:10", "CE 2007 11 10 10:10:10", "Ed", "Wed 10\\u2009\\u2013\\u2009Sat 10",
#else
...
#if APPLE_ICU_CHANGES
// rdar://
        "en", "CE 2007 11 10 10:10:10", "CE 2007 11 20 10:10:10", "Ed", "Sat 10\\u2009\\u2013\\u2009Tue 20",
#else
...
#if APPLE_ICU_CHANGES
// rdar://
        "en", "CE 2007 01 10 10:00:10", "CE 2007 01 10 14:10:10", "Ed", "Wed 10",
#else
...
#if APPLE_ICU_CHANGES
        "th", "BE 2550 10 10 10:10:10", "BE 2550 11 10 10:10:10", "y", "2550", // rdar://153888302
#else
...
#if APPLE_ICU_CHANGES
// rdar://49623848 y->yyyy in intervalFormat skeletons used for japanese calendar (updated for rdar://116185298 to use Western digits)
        "ja-u-ca-japanese", "H 31 04 15 09:00:00", JP_ERA_2019_NARROW " 1 05 15 09:00:00", "yyMMdd", "H31/04/15\\uFF5E" JP_ERA_2019_NARROW "1/05/15",

        "ar@calendar=islamic", "1438 10 10 10:10:10", "1438 10 20 10:10:10", "MMMd", "10\\u201320 \\u0634\\u0648\\u0627\\u0644",
#endif  // APPLE_ICU_CHANGES
    };
...
#if APPLE_ICU_CHANGES
// rdar://116151591 Part of the fix for SimpleDateFormat::getPatternForTimeStyle().  It seems wrong that the C metacharacter
// should still represent the first thing in allowedHourFormats when the locale ID overrides preferredHourFormat-- if I can
// make this happen in OSICU, I'll file a ticket.
        // Hour-cycle: k
        {u"12\u202FAM", u"24", u"24", u"12\u202FAM", u"24", u"0 (hour: 24)", u"24"},
        // Hour-cycle: H
        {u"12\u202FAM", u"00", u"00", u"12\u202FAM", u"00", u"0 (hour: 00)", u"00"},
#else
        // Hour-cycle: k
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"H31/03/02 午前6時～H31/04/03 午前6時",
#else
...
#if APPLE_ICU_CHANGES
// rdar://
                 u"H31/03/02 午前6時～R1/05/04 午前6時",
#else
