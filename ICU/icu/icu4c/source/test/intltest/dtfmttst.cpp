...
#if APPLE_ICU_CHANGES
// rdar://157895131: Apple overrides the AM and PM strings for Thai
    assertEquals("SimpleDateFormat wide", u"11:58:59 PM", formatResult);
#else
...
#if APPLE_ICU_CHANGES
// rdar://157895131: Apple overrides the AM and PM strings for Thai
    assertEquals("DateFormatSymbols wide", u"AM", borrowedAmPm[0]);
#else
