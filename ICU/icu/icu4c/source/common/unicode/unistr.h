...
#if APPLE_ICU_CHANGES // rdar://162810290
    // not using uprv_memset() here or in the other constructors
    // because that would involve pulling the private cmemory.h
    // include file into this public include file, and in any case
    // our version of cmemory.h just #define's uprv_memset to memset
    memset(&fUnion, 0, sizeof(fUnion));
#endif
