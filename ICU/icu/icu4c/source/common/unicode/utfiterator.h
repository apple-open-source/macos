...
// NOTE: Apple removes the apostrophes from the version numbers because the Apple-internal ScenDependencies tool
// doesn't support C++14
#if U_CPLUSPLUS_VERSION >= 23 && __cpp_lib_ranges >= 202202L &&                                         \
    __cpp_lib_bind_back >= 202202L // http://wg21.link/P2387R3.
...
// NOTE: Apple removes the apostrophes from the version numbers because the Apple-internal ScenDependencies tool
// doesn't support C++14
#if defined(__cpp_lib_ranges) && __cpp_lib_ranges >= 202110L  // We need https://wg21.link/P2415R2.
