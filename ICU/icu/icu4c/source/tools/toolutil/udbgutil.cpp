...
static const Field names_UCalendarDateFields[] =
{
    ...
    FIELD_NAME_STR( LEN_UCAL, UCAL_IS_REPEATED_DAY ),
#endif // APPLE_ICU_CHANGES
};
...
#if APPLE_ICU_CHANGES
// rdar://
  { "coll-uca.version", paramCollUCAVersion, nullptr, 0},
  { "coll-root.version", paramCollRootVersion, nullptr, 0},
  { "coll-en.version", paramCollEnVersion, nullptr, 0},
  { "coll-zh.version", paramCollZhVersion, nullptr, 0},
#endif  // APPLE_ICU_CHANGES
