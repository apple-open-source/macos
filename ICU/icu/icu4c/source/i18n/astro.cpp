...
// These offsets are aligned comparing the calculations with reference site https://www.drikpanchang.com/ and cover the period of 2025-2030
// These structure should be updated by findindg the dates for which our calculation doesn't match drikpanchang.com using Ujjain as locale
// and adding the Rata Die (https://en.wikipedia.org/wiki/Rata_Die) number for that day and the offset to make our result match, in sorted order
// We also need to keep track of repeating days; if day that was repeated is changed then it isLeapDay property needs to be reset
// Vice versa, if a change in offset causes the day to be the same as the next one, then the next one's isLeapDay property needs to be set
// This table is an array of {RD, offset, updateRepeatedDay} elements.
static const int32_t vikramRDOffsets[][3] = {
    {739132, -1, 1}, {739133, 0, 1},
    {739270, -1, 1}, {739271, 0, 1}, {739285, 1, 0}, {739286, 1, 0}, {739301, -1, 1}, {739302, -1, 0}, {739303, 0, 1}, {739342, 1, 0}, {739343, 1, 0},
    {739389, -1, 1}, {739390, -1, 0}, {739399, 1, 0}, {739465, -1, 1}, {739466, 0, 1}, {739508, 1, 0}, {739509, 1, 0}, {739519, -1, 1}, {739520, 0, 1},
    {739532, 1, 0}, {739552, -1, 1}, {739553, -1, 0}, {739554, -1, 0}, {739555, -1, 0}, {739556, -1, 0}, {739564, 1, 0}, {739565, 1, 0}, {739573, -1, 1},
    {739574, 0, 1}, {739605, -1, 1}, {739606, 0, 1}, {739614, -1, 0}, {739623, 1, 0}, {739624, 1, 0}, {739625, 1, 0}, {739626, 0, 1}, {739689, -1, 1},
    {739690, 0, 1}, {739727, 1, 0}, {739742, -1, 1}, {739743, 0, 1}, {739759, 1, 0}, {739760, 1, 0},{739761, 1, 0}, {739762, 1, 0}, {739763, 0, 1},
    {739783, 1, 0}, {739806, -1, 0}, {739807, -1, 0}, {739815, 1, 0}, {739816, 1, 0}, {739817, 1, 0}, {739818, 1, 0}, {739819, 1, 0}, {739820, 0, 1},
    {739838, -1, 0}, {739853, -1, 1}, {739854, 0, 1}, {739861, -1, 0}, {739893, 1, 0}, {739907, -1, 1}, {739908, 0, 1}, {739939, -1, 1},
    {739940, -1, 0},{739948, 1, 0}, {739949, 1, 0}, {739950, 1, 0}, {739974, 1, 0},
    {739992, -1, 1}, {739993, 0, 1}, {739998, -1, 0}, {739999, -1, 0}, {740000, -1, 0}, {740007, 1, 0}, {740008, 1, 0}, {740009, 1, 0}, {740010, 1, 0},
    {740011, 1, 0}, {740012, 1, 0}, {740013, 0, 1}, {740057, -1, 0}, {740090, -1, 0}, {740112, 1, 0}, {740129, -1, 1}, {740130, -1, 0}, {740131, -1, 0},
    {740132, 0, 1}, {740134, -1, 0}, {740135, -1, 0}, {740143, 1, 0}, {740144, 1, 0}, {740145, 1, 0}, {740151, -1, 1}, {740152, 0, 1}, {740167, 1, 0},
    {740185, -1, 1}, {740186, -1, 0}, {740187, -1, 0}, {740188, -1, 0}, {740189, -1, 0}, {740190, -1, 0}, {740191, -1, 0}, {740198, 1, 0}, {740199, 1, 0},
    {740223, -1, 0}, {740242, -1, 1}, {740243, -1, 0}, {740244, -1, 0}, {740245, -1, 0}, {740278, -1, 0}, {740294, -1, 1}, {740295, 0, 1}, {740301, 1, 0},
    {740334, 1, 0}, {740335, 1, 0}, {740346, -1, 1}, {740347, 0, 1}, {740359, 1, 0}, {740377, -1, 1}, {740378, -1, 0}, {740379, -1, 0}, {740380, 0, 1},
    {740382, -1, 0}, {740383, -1, 0}, {740384, -1, 0}, {740391, 1, 0}, {740392, 1, 0}, {740393, 1, 0}, {740394, 1, 0}, {740397, 1, 1}, {740398, 1, 0},
    {740399, 0, 1}, {740441, -1, 0}, {740442, -1, 0}, {740474, -1, 0}, {740528, 1, 0}, {740539, -1, 1}, {740540, 0, 1}, {740551, 1, 0},
    {740582, 1, 0}, {740583, 1, 0}, {740595, -1, 1}, {740596, 0, 1}, {740607, -1, 0}, {740663, -1, 0}, {740664, -1, 0}, {740668, 0, 0}, {740669, 0, 0},
    {740733, -1, 1}, {740734, 0, 1}, {740744, 1, 0}, {740764, -1, 1}, {740765, -1, 0}, {740766, -1, 0},
    {740767, -1, 0}, {740768, -1, 0}, {740769, -1, 0}, {740776, 1, 0}, {740777, 1, 0}, {740778, 1, 0},
    {740818, -1, 1}, {740819, 0, 1}, {740825, -1, 0}, {740826, -1, 0}, {740827, -1, 0}, {740834, 1, 0}, {740835, 1, 0},
    {740836, 1, 0}, {740837, 1, 0}, {740838, 1, 0}, {740839, 1, 0}, {740840, 0, 1}, {740858, -1, 0}, {740881, -1, 0}, {740928, -1, 1}, {740929, 0, 1},
    {740947, -1, 0}, {740948, -1, 0}, {740949, 0, 1}, {740966, 1, 0}, {740967, 1, 0}, {740982, -1, 1}, {740983, -1, 0}, {740984, 0, 1}, {740991, -1, 0},
    {740998, 1, 0}, {740999, 1, 0}, {741000, 1, 0}, {741001, 1, 0}, {741002, 1, 0}, {741003, 0, 1}, {741023, 1, 0}, {741036, -1, 1}, {741037, 0, 1},
    {741048, -1, 0}, {741088, 1, 1}, {741089, 0, 1}, {741129, 1, 0}, {741161, 1, 0}, {741162, 1, 0}, {741172, -1, 1}, {741173, 0, 1}, {741186, 1, 0},
    {741204, -1, 1}, {741205, -1, 0}, {741206, -1, 0}, {741207, -1, 0}, {741208, -1, 0}, {741209, -1, 0}, {741210, -1, 0}, {741211, -1, 0}, {741218, 1, 0},
    {741219, 1, 0}, {741242, -1, 0}, {741261, -1, 1}, {741262, -1, 0}, {741263, -1, 0}, {741264, -1, 0}, {741265, -1, 0}, {741297, -1, 0}, {741329, -1, 0},
    {741337, -1, 1}, {741338, 0, 1}, {741351, 1, 0}, {741369, -1, 1}, {741370, -1, 0}, {741371, -1, 0}, {741372, -1, 0}, {741373, -1, 0}, {741374, -1, 0},
    {741375, -1, 0}, {741383, 1, 0}, {741384, 1, 0}, {741385, 1, 0}, {741390, -1, 1}, {741391, 0, 1}, {741408, 1, 0}, {741433, -1, 0}, {741441, 1, 0},
    {741442, 1, 0},   
};
  
// rdar://151415578
// Precalculate the month start for period of 1900-2100 (Gregorian calendar) or 1957-2156 Vikram calendar
// correct the values from  reference site https://www.drikpanchang.com/ that doesn't match the calculation
int32_t hinduMonthStartJD[] = {
      if (vikramRDOffsets[x][0] < rataDie) {
        lo = x + 1;
      }
      else if (vikramRDOffsets[x][0] > rataDie) {
        hi = x - 1;
      }
      else {
        return vikramRDOffsets[x][id];
      }
    }
...
//-------------------------------------------------------------------------
// Astronomy helpers
double CalendarAstronomer::hinduSunrise(int32_t date, double longitudeOffset, double latitudeDeg) {
...
double CalendarAstronomer::hinduSunset(int32_t date, double longitudeOffset, double latitudeDeg) {
...
double CalendarAstronomer::astroHinduSunset(int32_t date, double longitudeDeg, double latitudeDeg, double hours) {
    return dusk(date, longitudeDeg, latitudeDeg, hours, 0.0);
}

double CalendarAstronomer::hinduEquationOfTime(double date) {
    double offset = hinduSine(hinduMeanPosition(date, HINDU_ANOMALISTIC_YEAR));
    double equationSun = offset * (57.0 + 18.0 / 60.0) * (14.0 / 360.0 - std::abs(offset) / 1080.0);

    return (hinduDailyMotion(date) / 360.0) * (equationSun / 360.0) * HINDU_SIDEREAL_YEAR;
}

double CalendarAstronomer::hinduAscensionalDifference(double date, double latitudeDeg) {
...
double CalendarAstronomer::hinduSolarSiderealDifference(int32_t date) {
    return hinduDailyMotion(date) * hinduRisingSign(date);
}

double CalendarAstronomer::hinduMeanPosition(double tee, double period) {
    return 360.0 * modLisp((tee - HINDU_CREATION) / period, 1.0);
}

double CalendarAstronomer::hinduDailyMotion(double date) {
    ...
    int32_t entry = static_cast<int32_t>(anomaly / (225.0 / 60.0));
...
double CalendarAstronomer::hinduTruePosition(double tee, double period, double size, double anomalistic, double change) {
...
double CalendarAstronomer::hinduTropicalLongitude(double date) {
    double days = date - HINDU_EPOCH_YEAR; // Assuming date is in days
    double precession = 27.0 - std::abs(108.0 * mod3(600.0 / 1577917828.0 * days - 1.0 / 4, - 1.0 / 2, 1.0 / 2));

    return modLisp(hinduSolarLongitude(date) - precession, 360.0);
}

double CalendarAstronomer::hinduRisingSign(double date) {
...
double CalendarAstronomer::hinduNewMoonBefore(double tee) {
...
int32_t CalendarAstronomer::hinduLunarDayFromMoment(double tee) {
    return 1 + static_cast<int32_t>(hinduLunarPhase(tee) / 12.0);
}

int32_t CalendarAstronomer::hinduZodiac(double tee) {
    return static_cast<int32_t>(hinduSolarLongitude(tee) / 30.0); // rdar://146422322 months indexes should be zero based, not 1-based
}

int32_t CalendarAstronomer::hinduCalendarYear(double tee) {
    return std::round((tee - HINDU_EPOCH_YEAR) / HINDU_SIDEREAL_YEAR - hinduSolarLongitude(tee) / 360.0 );
}

int32_t CalendarAstronomer::astroHinduCalendarYear(double tee) {
    return std::round((tee - HINDU_EPOCH_YEAR) / MEAN_SIDEREAL_YEAR - siderealSolarLongitude(tee) / 360.0 );
}

double CalendarAstronomer::hinduSolarLongitudeAtOrAfter(double lambda, double tee) {
    double tau = tee + HINDU_SIDEREAL_YEAR / 360 * fmod(lambda - hinduSolarLongitude(tee), 360.0); // rdar://145903949 Fix incorrect calculation
    double a = std::max(tee, tau - 5.0);
    double b = tau + 5.0;
    return invertAngularSolarLongitude(lambda, a, b);
}

double CalendarAstronomer::hinduLunarDayAtOrAfter(double k, double tee) {
    double phase = (k - 1) * 12.0; // Degrees corresponding to k.

    double tau = tee + (1.0 / 360.0) * modLisp(phase - hinduLunarPhase(tee), 360.0) * HINDU_SYNODIC_MONTH; // rdar://145903949 Fix incorrect calculation
...
int32_t CalendarAstronomer::hinduLunarStation(double date, double longitudeOffset, double latitudeDeg) {
    return 1 + static_cast<int32_t>(std::floor(hinduLunarLongitude(hinduSunrise(date, longitudeOffset, latitudeDeg)) / angle(0, 800, 0)));
}

double CalendarAstronomer::hinduStandardFromSundial(double tee, double longitudeOffset, double latitudeDeg) {
    ...
    return a + 2 * (b - a) * (time - ((q == 3) ? hr(18.0) : ((q == 0) ? hr(-6.0) : hr(6.0))));
}

// fixed-from-moment
int32_t CalendarAstronomer::fixedFromMoment(double tee) {
    return static_cast<int32_t>(std::floor(tee));
}

// time-from-moment
double CalendarAstronomer::timeFromMoment(double tee) {
    return modLisp(tee, 1.0);
}

// --- Hindu solar calendar astronomy ---
double CalendarAstronomer::julianCenturies(double tee) {
    const double j2000 = 730120.5; // got this from running "j2000" in calendar.l from Reingold/Dershowitz
    const double dynamicalFromUniversal = tee + ephemerisCorrection(tee);
    return (dynamicalFromUniversal - j2000) / 36525;
}
        
double CalendarAstronomer::ephemerisCorrection(double tee) {
    // Reingold & Dershowitz, pp. 210-212
    int32_t year = gregorianYearFromFixed(std::floor(tee));
    int32_t gregorianDateDifference = fixedFromGregorian(year, 7, 1) - fixedFromGregorian(1900, 1, 1);
    double c = gregorianDateDifference / 36525;
    
    if (year >= 2051) {
        return (-20 + (32 * std::pow((year - 1820) / 100, 2)) + (0.5628 * (2150 - year))) / 86400;
    } else if (year >= 2006) {
        year -= 2000;
        double coeffs[] = { 62.92, 0.32217, 0.005589 };
        return poly(year, coeffs, 3, 0) / 86400;
    } else if (year >= 1987) {
        year -= 2000;
        double coeffs[] = { 63.86, 0.3345, -0.060374, 0.0017275, 0.000651814, 0.00002373599 };
        return poly(year, coeffs, 6, 0) / 86400;
    } else if (year >= 1900) {
        double coeffs[] = { -0.00002, 0.000297, 0.025184, -0.181133, 0.553040, -0.861938, 0.677066, -0.212591 };
        return poly(c, coeffs, 8, 0);
    } else if (year >= 1800) {
        double coeffs[] = { -0.000009, 0.003844, 0.083563, 0.865736, 4.867575, 15.845535, 31.332267, 38.291999, 28.316289, 11.636204, 2.043794 };
        return poly(c, coeffs, 11, 0);
    } else if (year >= 1700) {
        year -= 1700;
        double coeffs[] = { 8.118780842, -0.005092142, 0.003336121, -0.0000266484 };
        return poly(year, coeffs, 4, 0) / 86400;
    } else if (year >= 1600) {
        year -= 1600;
        double coeffs[] = { 120, -0.9808, -0.01532, 0.000140272128 };
        return poly(year, coeffs, 4, 0) / 86400;
    } else if (year >= 500) {
        year = (year - 1000) / 100;
        double coeffs[] = { 1574.2, -556.01, 71.23472, 0.319781, -0.8503463, -0.005050998, 0.0083572073 };
        return poly(year, coeffs, 7, 0) / 86400;
    } else if (year > -500) {
        year /= 100;
        double coeffs[] = { 10583.6, -1014.41, 33.78311, -33.78311, -0.1798452, 0.022174192, 0.0090316521 };
        return poly(year, coeffs, 7, 0) / 86400;
    } else {
        year = (year - 1820) / 100;
        double coeffs[] = { -20, 0, 32 };
        return poly(year, coeffs, 3, 0) / 86400;
    }
}
        
int32_t CalendarAstronomer::gregorianYearFromFixed(int32_t date) {
    // Reingold & Dershowitz, p. 61
    int32_t result = 0;
    bool leapYear = false;
    int32_t temp;
    date -= 1; // "gregorian-epoch"
    
    result = 400 * std::floor(date / 146097);
    date = modLisp(date, 146097);
    
    temp = std::floor(date / 36524);
    result += 100 * temp;
    if (temp == 4) {
        leapYear = true;
    }
    date = modLisp(date, 36524);
    
    result += 4 * std::floor(date / 1461);
    date = modLisp(date, 1461);
...
int32_t CalendarAstronomer::fixedFromGregorian(int32_t year, int32_t month, int32_t day) {
    // Reingold & Dershowitz, p. 60
    int32_t result = 0; // // gregorian-epoch (1) - 1
    result += 365 * (year - 1);
    result += std::floor((year - 1) / 4);
    result -= std::floor((year - 1) / 100);
    result += std::floor((year - 1) / 400);
    result += std::floor((367 * month - 362) / 12);
    result += day;
    
    if (month <= 2) {
        result += 0;
    } else if (modLisp(year, 4) == 0 && modLisp(year, 100) == 0 && !modLisp(year, 400)) {
        result -= 1;
    } else {
        result -= 2;
    }
...
double CalendarAstronomer::declination(double tee, double beta, double lambda) {
    double eps = obliquity(tee);
    return arcsinDegrees( sinDegrees(beta) * cosDegrees(eps) +
                                cosDegrees(beta) * sinDegrees(eps) * sinDegrees(lambda) );
}

double CalendarAstronomer::obliquity(double tee) {
    double c = julianCenturies(tee);
    const double coeffs[] = {0.0,-46.8150 / 3600.0,-0.00059 / 3600.0,0.001813 / 3600.0};

    return angle(23, 26, 21.448) + poly(c, coeffs, 4, 0);
}

int CalendarAstronomer::siderealZodiac(double tee) {
    double longitude = siderealSolarLongitude(tee);
    return static_cast<int>(std::floor(longitude / 30.0)); // we omit the "+1" from the R&D algorithm because ICU months are 0-based
}

double CalendarAstronomer::siderealSolarLongitude(double tee) {
    return modLisp(solarLongitude(tee) - precession(tee) + HINDU_SIDEREAL_START, 360);
}

double CalendarAstronomer::solarLongitude(double tee) {
    double c = julianCenturies(tee);
    int size = 49;

    const double coefficients[] = {
            403406,195207,119433,112392,3891,2819,1721,660,350,334,314,268,242,234,
            158,132,129,114,99,93,86,78,72,68,64,46,38,37,32,29,28,27,27,25,24,21,
            21,20,18,17,14,13,13,13,12,10,10,10,10
    };
    ...
    for (int i = 0; i < size; ++i) {
        double angle = addends[i] + multipliers[i] * c;
        sum += coefficients[i] * sinDegrees(angle);
    }
...
double CalendarAstronomer::aberration(double tee) {
    double c = julianCenturies(tee);
    double angle = 177.63 + 35999.01848 * c;
    return 0.0000974 * cosDegrees(angle) - 0.005575;
}

double CalendarAstronomer::nutation(double tee) {
    double c = julianCenturies(tee);

    double capACoef[] = {124.90, -1934.134, 0.002063};
    double capBCoef[] = {201.11, 72001.5377, 0.00057};

    double capA = poly(c, capACoef, 3, 0);
    double capB = poly(c, capBCoef, 3, 0);

    return -0.004778 * sinDegrees(capA) - 0.0003667 * sinDegrees(capB);
}

double CalendarAstronomer::meshaSamkranti(int gYear) {
    double jan1 = gYear + HINDU_EPOCH_YEAR;
    return hinduSolarLongitudeAtOrAfter(0, jan1);
}

double CalendarAstronomer::poly(double x, const double* a, int size, int index) {
    if (index >= size) {
        return 0;
    }
    return a[index] + x * poly(x, a, size, index + 1);
}
      
// Normalize angle to [0, 360)
double CalendarAstronomer::mod360(double angle) {
    double result = modLisp(angle, 360.0);
    return (result < 0) ? result + 360.0 : result;
}
        
double CalendarAstronomer::mod3(double x, double a, double b) {
    if (a == b) {
        return x;
    } else {
...
double CalendarAstronomer::degreesFromRadians(double theta) {
    return mod360(theta * 180.0 / M_PI);
}

double CalendarAstronomer::radiansFromDegrees(double theta) {
    return mod360(theta) * M_PI / 180.0;
}

double CalendarAstronomer::sinDegrees(double theta) {
    return std::sin(radiansFromDegrees(theta));
}

double CalendarAstronomer::cosDegrees(double theta) {
    return std::cos(radiansFromDegrees(theta));
}

double CalendarAstronomer::tanDegrees(double theta) {
    return std::tan(radiansFromDegrees(theta));
}

double CalendarAstronomer::arcsinDegrees(double x) {
    return degreesFromRadians(std::asin(x));
}

double CalendarAstronomer::arccosDegrees(double x) {
    return degreesFromRadians(std::acos(x));
}

double CalendarAstronomer::arctanDegrees(double x) {
    return degreesFromRadians(std::atan(x));
}

double CalendarAstronomer::arctanDegrees(double y, double x) {
    if (x == 0.0 && y == 0.0) {
        // TODO: NaN is represent "bogus", but needs to be propertly handled from the calling method, which is precession()
    ...
    double alpha = degreesFromRadians(std::atan(y/x));
    if (x >= 0.0) {
        return mod360(alpha);
    } else {
        return mod360(alpha + 180.0);
    }
}

double CalendarAstronomer::precession(double tee) {
    double c = julianCenturies(tee);

    double etaCoef[] = {0, 47.0029 / 3600.0, -0.03302 / 3600.0, 0.000060 / 3600.0 };
    double capPCoef[] = {174.876384, -869.8089 / 3600.0, 0.03536 / 3600.0 };
    double pCoef[] = {0, 5029.0966 / 3600.0, 1.11113 / 3600.0,0.000006 / 3600.0};

    double eta = modLisp(poly(c, etaCoef, 4, 0 ), 360.0);
    double capP = modLisp(poly(c, capPCoef, 3, 0), 360.0);
    double p = modLisp(poly(c, pCoef, 4, 0), 360.0);
    double capA = cosDegrees(eta) * sinDegrees(capP);
    double capB = cosDegrees(capP);
    double arg = arctanDegrees(capA, capB);

    return modLisp((p + capP - arg), 360.0);
}
        
double CalendarAstronomer::dusk(int32_t date, double longitudeDeg, double latitudeDeg, double hours, double alpha) {
    double result = momentOfDepression(date + hr(18), longitudeDeg, latitudeDeg, alpha, false);
    if (isnan(result)) {
        return result;
    } else {
        return standardFromLocal(result, longitudeDeg, hours);
    }
}
        
double CalendarAstronomer::momentOfDepression(double approx, double longitudeDeg, double latitudeDeg, double alpha, bool isEarly) {
    double tee = approxMomentOfDepression(approx, longitudeDeg, latitudeDeg, alpha, isEarly);
    if (isnan(tee)) {
        return tee;
    } else if (std::fabs(approx - tee) < 30) {
        return tee;
    } else {
        return momentOfDepression(tee, longitudeDeg, latitudeDeg, alpha, isEarly);
    }
}
        
double CalendarAstronomer::approxMomentOfDepression(double tee, double longitudeDeg, double latitudeDeg, double alpha, bool isEarly) {
    double tryy = sineOffset(tee, longitudeDeg, latitudeDeg, alpha);
    int32_t date = fixedFromMoment(tee);
    
    double alt = date;
    if (isEarly && alpha >= 0.0) {
        alt = date;
    } else if (alpha >= 0.0) {
        alt = date + 1;
    } else  {
    ...
    double value = (tryy > 1) ? sineOffset(alt, longitudeDeg, latitudeDeg, alpha) : tryy;
    double offset = mod3(arcsinDegrees(value) / 360.0, -hr(12), hr(12));
    
    if (std::fabs(value) <= 1) {
        return localFromApparent(isEarly ? date + hr(6) - offset : date + hr(18) + offset, longitudeDeg);
    } else {
        return std::numeric_limits<double>::quiet_NaN();    // we're using NaN for R&D's "bogus" value
    }
}

double CalendarAstronomer::standardFromLocal(double tee_ell, double longitudeDeg, double locationHours) {
    return standardFromUniversal(universalFromLocal(tee_ell, longitudeDeg), locationHours);
}

double CalendarAstronomer::standardFromUniversal(double tee_u, double locationHours) {
    return tee_u + locationHours;
}

double CalendarAstronomer::universalFromLocal(double tee_ell, double longitudeDeg) {
    return tee_ell - zoneFromLongitude(longitudeDeg);
}
        
double CalendarAstronomer::localFromApparent(double tee, double longitudeDeg) {
    return tee - hinduEquationOfTime(universalFromLocal(tee, longitudeDeg));
}

double CalendarAstronomer::zoneFromLongitude(double phi) {
    return phi / 360;
}
        
double CalendarAstronomer::sineOffset(double tee, double longitudeDeg, double latitudeDeg, double alpha) {
    double phi = latitudeDeg;
    double teePrime = universalFromLocal(tee, longitudeDeg);
    double delta = declination(teePrime, 0.0, solarLongitude(teePrime));
    return tanDegrees(phi) * tanDegrees(delta) + (sinDegrees(alpha) / (cosDegrees(delta) * cosDegrees(phi)));
}

// --- End Hindu solar calendar astronomy ---

// Trigonometry
double CalendarAstronomer::sinDegrees(const Angle& angle) {
    return std::sin(angle.degrees * M_PI / 180.0 + angle.minutes * M_PI / (180.0 * 60.0) + angle.seconds * M_PI / (180.0 * 3600.0));
}

double CalendarAstronomer::hinduSineTable(int32_t entry) {
...
double CalendarAstronomer::hinduSine(double theta) {
...
double CalendarAstronomer::hinduArcsin(double amp) {
    if (amp < 0) {
...
double CalendarAstronomer::angle(int32_t d, int32_t m, double s) {
    return static_cast<double>(d) + (static_cast<double>(m) + (s / 60.0)) / 60.0;
}


// Math and algo helpers
double CalendarAstronomer::hr(double x) {
    // Hours -> duration
    return x / 24.0;
}

double CalendarAstronomer::modLisp(double a, double b) {
...
double CalendarAstronomer::binarySearch(double l, double u, double tee, double epsilon) {
    while (u - l > epsilon) {
        double x = (l + u) / 2.0;
...
double CalendarAstronomer::invertAngularSolarLongitude(double y, double l, double u) {
    double epsilon = 1.0 / 100000.0; // Desired accuracy

    while (u - l > epsilon) {
        double x = (l + u) / 2.0;
        if ( hinduSolarLongitude(x) < y) { // rdar://145903949 Fix incorrect calculation
            l = x;
        } else {
            u = x;
        }
...
double CalendarAstronomer::invertAngularLunarPhase(double y, double l, double u) {
    double epsilon = 1.0 / 100000.0; // Desired accuracy
