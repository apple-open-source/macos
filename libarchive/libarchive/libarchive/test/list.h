...
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFMT)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFREG)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFLNK)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFSOCK)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFCHR)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFBLK)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFDIR)
DEFINE_TEST(test_archive_write_secure_symlink_race_AE_IFIFO)
#endif
