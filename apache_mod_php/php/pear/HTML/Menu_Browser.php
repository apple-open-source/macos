...
// +----------------------------------------------------------------------+
//
// $Id: Menu_Browser.php,v 1.1.1.1 2001/12/14 22:14:54 zarzycki Exp $
...
* @version  $Id: Menu_Browser.php,v 1.1.1.1 2001/12/14 22:14:54 zarzycki Exp $
*/
class HTML_Menu_Browser {
    ...
    * @see      $dir
    */
    function HTML_Menu_Browser($dir = '', $index = '', $file_suffix = '') {
        if ($dir)
            $this->dir = $dir;
        if ($index)
            $this->index = $index;
