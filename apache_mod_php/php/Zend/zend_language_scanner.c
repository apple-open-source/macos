 ...
 * $Header: /cvs/Darwin/Services/apache_mod_php/php/Zend/zend_language_scanner.c,v 1.1.1.1 2001/01/25 05:01:01 wsanchez Exp $
 */
...
yy_match:
		...
		while ( yy_base[yy_current_state] != 7492 );
