...
(define_attr "fppc" "none,single,double,conflict"
  (cond
   [(match_operand:DF 0 "" "") (const_string "double")
    (match_operand:SF 0 "" "") (const_string "single")]
   (const_string "none")))
...
{
#ifdef MACHO_PIC
  extern rtx machopic_indirect_data_reference();
  extern rtx machopic_legitimize_pic_address();
  ...
  if (MACHOPIC_PURE)
    {
       ...
       operands[1] = machopic_legitimize_pic_address (operands[1], SImode, 
...
(define_insn "addsi3"
  [(set (match_operand:SI 0 "general_operand" "=m,?a,?a,r")
	(plus:SI (match_operand:SI 1 "general_operand" "%0,a,rJK,0")
		 (match_operand:SI 2 "general_operand" "dIKLs,rJKi,a,mrIKLs")))]
  ""
  "*
{
...
#endif
#if defined (CASE_VECTOR_PC_RELATIVE) || defined (MACHOPIC_PURE)
...
(define_insn ""
  [(set (pc)
	(plus:SI (pc) (match_operand:SI 0 "register_operand" "r")))
   (use (label_ref (match_operand 1 "" "")))]
  ""
  "*
#ifdef ASM_RETURN_CASE_JUMP
...
#ifdef MACHO_PIC
    operands[1] = (rtx)machopic_indirect_call_target (operands[1]);
    SYMBOL_REF_FLAG (XEXP (operands[1], 0)) = 1;
  }
#endif
}")
...
(define_expand "cmpxf"
  [(set (cc0)
	(compare (match_operand:XF 0 "general_operand" "f,m")
		 (match_operand:XF 1 "general_operand" "fm,f")))]
  "TARGET_68881"
  "
{
#ifdef MACHO_PIC
  extern rtx machopic_indirect_data_reference();
  rtx reg = reload_in_progress ? 0 : gen_reg_rtx (Pmode);
#endif
...
#ifdef MACHO_PIC
      operands[0] = machopic_indirect_data_reference (operands[0], reg);
#endif
    }
  if (CONSTANT_P (operands[1]))
    {
      operands[1] = force_const_mem (XFmode, operands[1]);
#ifdef MACHO_PIC
      operands[1] = machopic_indirect_data_reference (operands[1], reg);
#endif
    }
}")
...
#ifdef MACHO_PIC
      operands[2] = machopic_indirect_data_reference (operands[2], reg);
#endif
    }
}")
...
(define_insn "fppc_switch"
  ...
  ""
  "fmovem%.l %!,%0\;eor%.l %#192,%0\;fmovem%.l %0,%!")
