...
static enum in_section {no_section, in_text, in_data, in_named, EXTRA_SECTIONS, num_sections} in_section
  = no_section;
#else
static enum in_section {no_section, in_text, in_data, in_named, num_sections} in_section
  = no_section;
#endif
     ...
     char *fnname;
{
  ...
  if (TREE_PUBLIC (decl))
	...
	BC_GLOBALIZE_LABEL (asm_out_file, fnname);
      ...
      else if (DECL_PRIVATE_EXTERN (decl))
