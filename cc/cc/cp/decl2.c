...
/* Nonzero if squashed mangling is to be performed.
   (This feature is not implemented in this version of the compiler.)  */
...
static struct { char *string; int *variable; int on_value;} lang_f_options[] =
{
  ...
  {"exceptions",        &flag_handle_exceptions, 1},
...
#ifdef NEXT_SEMANTICS
  if (DYNAMIC_DESTRUCTORS)
    dfndecl = current_function_decl;
#endif
...
#ifdef NEXT_SEMANTICS
      if (needs_cleaning && DYNAMIC_DESTRUCTORS)
	{
