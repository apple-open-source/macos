...
/* Do not reference target_flags, since otherwise you get an undefined symbol
   when linking!  */
#define _TARGET_V9_SAVE TARGET_V9
#undef   TARGET_V9
#define  TARGET_V9 0
#endif
...
#ifdef  TARGET_V9
#undef  TARGET_V9
#define TARGET_V9 _TARGET_V9_SAVE
#undef _TARGET_V9_SAVE
#endif
#if !defined (__APPLE__) && (!defined (NS_TARGET_MAJOR) || NS_TARGET_MAJOR < 4)
  kern_return_t r;
...
#if defined (NEXT_PDO) && defined (_WIN32)
const char* _NSRootDirectory (void)
{
  static const char* root = NULL;
  if (!root)
    if (!(root = getenv ("NEXT_ROOT")))
      root = "";
  return root;
}
#endif
...
#if defined(NEXT_SEMANTICS) || defined(_AIX)
