 ...
 */
#ifndef _IOKIT_USBMACRISC4DOMAIN_H
#define _IOKIT_USBMACRISC4DOMAIN_H

#include <IOKit/IOService.h>
#include <IOKit/pwr_mgt/IOPM.h>

class IOPMUSBMacRISC4: public IOService
{
    OSDeclareDefaultStructors(IOPMUSBMacRISC4)
...
#endif /*  _IOKIT_USBMACRISC4DOMAIN_H */
