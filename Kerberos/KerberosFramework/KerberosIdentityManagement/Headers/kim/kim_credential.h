 ...
 * credential object.  If you wish to store this API in the ccache collection
 * you must either call #kim_credential_store() on the validated credential
 * or use #kim_ccache_validate() instead.
 * 
 *
 ...
 * credential object.  If you wish to store this API in the ccache collection
 * you must either call #kim_credential_store() on the renewed credential
 * or use #kim_ccache_renew() instead.
 *
 *
