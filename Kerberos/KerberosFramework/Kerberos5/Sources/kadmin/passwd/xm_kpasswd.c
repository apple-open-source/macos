 ...
 * 
 * $Header: /cvs/krbdev/krb5/src/kadmin/passwd/xm_kpasswd.c,v 1.8 2001/02/26 18:22:08 epeisach Exp $
 *
 *
 */

static char rcsid_2[] = "$Id: xm_kpasswd.c,v 1.8 2001/02/26 18:22:08 epeisach Exp $";
