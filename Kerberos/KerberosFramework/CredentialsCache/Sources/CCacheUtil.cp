...
/*************************************************************
 *
 *				Utility function for CCache API for MacOS
 *		(note that none of these functions are exported by the library)
 *	
 *
 *************************************************************/
...
bool CCIValidPointer (
	const	void*		inPointer) {
	
	return CCIValidPointer_ (inPointer);
}
