 ...
 * LifetimeFormatter.h
 *
 * $Header: /cvs/kfm/Common/Headers/LifetimeFormatter.h,v 1.2 2004/05/14 01:01:57 lxs Exp $
 *
...
@interface LifetimeFormatter : NSFormatter
{
    time_t controlMinimum;
    time_t controlIncrement;
    BOOL displaySeconds;
