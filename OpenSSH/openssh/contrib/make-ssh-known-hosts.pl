...
#	  $Source: /cvs/Darwin/Services/OpenSSH/openssh/contrib/make-ssh-known-hosts.pl,v $
#	  Author : $Author: wsanchez $
#
#	  (C) Tero Kivinen 1995 <Tero.Kivinen@hut.fi>
#
#	  Creation          : 19:52 Jun 27 1995 kivinen
#	  Last Modification : 00:07 Jul  8 1998 kivinen
#	  Last check in     : $Date: 2000/04/16 20:32:00 $
...
#	  Revision 1.1.1.1  2000/04/16 20:32:00  wsanchez
#	  Import of OpenSSH 1.2.3
#	
...
$version = ' $Id: make-ssh-known-hosts.pl,v 1.1.1.1 2000/04/16 20:32:00 wsanchez Exp $ ';
