/* Build expressions with type checking for C++ compiler.
   Copyright (C) 1987, 1988, 1989, 1992-1998, 1999, 2000 Free Software Foundation, Inc.
     ...
     tree values;
{
  ...
  /* Walk the values list placing the converted constants into valarray and 
	  ...
	  /* Const and volatile mean something different for function types,
	      ...
	      else if (!at_least_as_qualified_p (ttl, ttr))
		{
		  if (string_conv_p (type, rhs, 1))
		    ...
		    {
		      /* Some builtin functions allow const and volatile and
			 do not discard their meaning.  */
