     ...
     rtx equiv;
{
  ...
  /* look for any CALL_INSNs in this sequence, and attach a REG_EH_REGION
     ...
     already a REG_EH_REGION note, in which case we update it.) */
...
#define INT_TYPE_SIZE BITS_PER_WORD
  ...
  setjmp_libfunc = gen_rtx_SYMBOL_REF (Pmode, "_setjmp");
  longjmp_libfunc = gen_rtx_SYMBOL_REF (Pmode, "_longjmp");
#else
