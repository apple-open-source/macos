 ...
 */
ssize_t /*ARGSUSED*/
mts_mbtowc(mts_wchar_t *wcharp, const char *mbchar, size_t nbytes __unused)
{
	unsigned char mbyte;
 ...
 */
ssize_t
mts_stombs(char *mbstring, const char *string, size_t max_mblen)
{
	char *start = mbstring;
