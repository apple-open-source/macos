...
extern int parse_stat(char *xmlp, int xmlp_len, const char *orig_uri, struct vattr *statbuf);
...
extern int parse_opendir(char *xmlp, int xmlp_len, int fd, char *dir_name, char *hostname, int uid);
extern int parse_file_count(char *xmlp, int xmlp_len, int *file_count);
extern void parser_add(CFXMLParserRef parser, void *parent, void *child, void *context);
extern void parser_opendir_add(CFXMLParserRef parser, void *parent, void *child, void *context);
extern void *parser_lookup_create(CFXMLParserRef parser, CFXMLNodeRef node, void *context);
extern void *parser_file_count_create(CFXMLParserRef parser, CFXMLNodeRef node, void *context);
extern void parser_end(CFXMLParserRef parser, void *xmlType, void *context);
...
#define WEBDAV_OPENDIR_IGNORE 5		/* Same Rules Apply */
