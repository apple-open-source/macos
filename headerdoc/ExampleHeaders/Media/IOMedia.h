 ...
 * @abstract
 * kIOMediaContent is a property of IOMedia objects.  It has an OSString value.
 * @discussion
 ...
 * @abstract
 * kIOMediaContentHint is a property of IOMedia objects.  It has an OSString
 * value.
 * @discussion
 ...
 * @abstract
 * kIOMediaEjectable is a property of IOMedia objects.  It has an OSBoolean
 * value.
 * @discussion
 ...
 * @abstract
 * kIOMediaLeaf is a property of IOMedia objects.  It has an OSBoolean value.
 * @discussion
...
/*!
 * @defined kIOMediaPreferredBlockSize
 * @abstract
 * kIOMediaPreferredBlockSize is a property of IOMedia objects.  It has an
 * OSNumber value.
 * @discussion
 * The kIOMediaPreferredBlockSize property describes the media's natural block
 * size in bytes.  This information is useful to clients that want to optimize
 * access to the media.
 */

#define kIOMediaPreferredBlockSize "Preferred Block Size"

/*!
 * @defined kIOMediaSize
 * @abstract
 * kIOMediaSize is a property of IOMedia objects.  It has an OSNumber value.
 * @discussion
 ...
 * @abstract
 * kIOMediaWhole is a property of IOMedia objects.  It has an OSBoolean value.
 * @discussion
 ...
 * @abstract
 * kIOMediaWritable is a property of IOMedia objects.  It has an OSBoolean
 * value.
 * @discussion
 ...
 * @abstract
 * kIOMediaContentMask is a property of IOMedia clients.  It has an OSString
 * value.
 * @discussion
