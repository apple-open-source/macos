...
#define DEF_SC_HEIGHT   24
	...
	if (unix2003_compat) {
		...
		/*
		 * The below used to be special for unix2003_compat, but as of the
		 * latest import less is aligned with the previous logic -- namely, that
		 * LINES/COLUMNS take precedence if specified.
		 */
	}
