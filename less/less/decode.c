...
public void init_cmds(void)
{
	...
	if (unix2003_compat)
	{
		add_UNIX03cmd_table(UNIX03cmdtable, sizeof(UNIX03cmdtable));
	}
 ...
 */
public void
add_UNIX03cmd_table(unsigned char *buf, size_t len)
{
...
{
	/* If UNIX03cmd_tables exists, try to decode it first */
