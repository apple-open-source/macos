...
OBJECTS_all = buckets/apr_buckets_heap.lo buckets/apr_buckets_file.lo buckets/apr_buckets_pipe.lo buckets/apr_buckets_simple.lo buckets/apr_buckets_refcount.lo buckets/apr_buckets.lo buckets/apr_brigade.lo buckets/apr_buckets_socket.lo buckets/apr_buckets_pool.lo buckets/apr_buckets_flush.lo buckets/apr_buckets_mmap.lo buckets/apr_buckets_eos.lo buckets/apr_buckets_alloc.lo crypto/apr_md5.lo crypto/apr_md4.lo crypto/getuuid.lo crypto/apr_sha1.lo crypto/uuid.lo dbm/apr_dbm_sdbm.lo dbm/apr_dbm.lo dbm/sdbm/sdbm_lock.lo dbm/sdbm/sdbm_pair.lo dbm/sdbm/sdbm_hash.lo dbm/sdbm/sdbm.lo encoding/apr_base64.lo hooks/apr_hooks.lo ldap/apr_ldap_stub.lo ldap/apr_ldap_url.lo misc/apu_version.lo misc/apr_queue.lo misc/apr_thread_pool.lo misc/apr_rmm.lo misc/apr_date.lo misc/apr_reslist.lo misc/apu_dso.lo memcache/apr_memcache.lo uri/apr_uri.lo xml/apr_xml.lo strmatch/apr_strmatch.lo xlate/xlate.lo dbd/apr_dbd.lo
...
HEADERS = $(top_srcdir)/include/apr_optional_hooks.h $(top_srcdir)/include/apr_ldap_init.h $(top_srcdir)/include/apr_uri.h $(top_srcdir)/include/apr_md5.h $(top_srcdir)/include/apr_md4.h $(top_srcdir)/include/apr_uuid.h $(top_srcdir)/include/apr_buckets.h $(top_srcdir)/include/apr_ldap_url.h $(top_srcdir)/include/apr_ldap_rebind.h $(top_srcdir)/include/apr_queue.h $(top_srcdir)/include/apr_hooks.h $(top_srcdir)/include/apr_reslist.h $(top_srcdir)/include/apr_base64.h $(top_srcdir)/include/apr_rmm.h $(top_srcdir)/include/apr_memcache.h $(top_srcdir)/include/apr_sha1.h $(top_srcdir)/include/apr_strmatch.h $(top_srcdir)/include/apr_xml.h $(top_srcdir)/include/apr_dbm.h $(top_srcdir)/include/apr_anylock.h $(top_srcdir)/include/apr_xlate.h $(top_srcdir)/include/apr_thread_pool.h $(top_srcdir)/include/apu_version.h $(top_srcdir)/include/apr_dbd.h $(top_srcdir)/include/apr_optional.h $(top_srcdir)/include/apr_date.h $(top_srcdir)/include/apr_ldap_option.h $(top_srcdir)/include/apr_sdbm.h $(top_srcdir)/include/private/apr_dbd_internal.h $(top_srcdir)/include/private/apr_dbm_private.h $(top_srcdir)/include/private/apu_internal.h $(top_srcdir)/include/private/apr_dbd_odbc_v2.h
