...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"svn_diff_file_diff3_2", _wrap_svn_diff_file_diff3_2, METH_VARARGS, (char *)"svn_diff_file_diff3_2(char const * original, char const * modified, char const * latest, svn_diff_file_options_t options, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_file_diff4_2", _wrap_svn_diff_file_diff4_2, METH_VARARGS, (char *)"svn_diff_file_diff4_2(char const * original, char const * modified, char const * latest, char const * ancestor, svn_diff_file_options_t options, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_diff_file_diff4", _wrap_svn_diff_file_diff4, METH_VARARGS, (char *)"svn_diff_file_diff4(char const * original, char const * modified, char const * latest, char const * ancestor, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_file_output_unified3", _wrap_svn_diff_file_output_unified3, METH_VARARGS, (char *)"svn_diff_file_output_unified3(svn_stream_t * output_stream, svn_diff_t * diff, char const * original_path, char const * modified_path, char const * original_header, char const * modified_header, char const * header_encoding, char const * relative_to_dir, svn_boolean_t show_c_function, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_file_output_unified", _wrap_svn_diff_file_output_unified, METH_VARARGS, (char *)"svn_diff_file_output_unified(svn_stream_t * output_stream, svn_diff_t * diff, char const * original_path, char const * modified_path, char const * original_header, char const * modified_header, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_output_binary", _wrap_svn_diff_output_binary, METH_VARARGS, (char *)"svn_diff_output_binary(svn_stream_t * output_stream, svn_stream_t * original, svn_stream_t * latest, svn_cancel_func_t cancel_func, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_diff_mem_string_diff", _wrap_svn_diff_mem_string_diff, METH_VARARGS, (char *)"svn_diff_mem_string_diff(svn_string_t const * original, svn_string_t const * modified, svn_diff_file_options_t options, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_diff_mem_string_diff3", _wrap_svn_diff_mem_string_diff3, METH_VARARGS, (char *)"svn_diff_mem_string_diff3(svn_string_t const * original, svn_string_t const * modified, svn_string_t const * latest, svn_diff_file_options_t options, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_diff_mem_string_diff4", _wrap_svn_diff_mem_string_diff4, METH_VARARGS, (char *)"svn_diff_mem_string_diff4(svn_string_t const * original, svn_string_t const * modified, svn_string_t const * latest, svn_string_t const * ancestor, svn_diff_file_options_t options, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_get_binary_diff_original_stream", _wrap_svn_diff_get_binary_diff_original_stream, METH_VARARGS, (char *)"svn_diff_get_binary_diff_original_stream(svn_diff_binary_patch_t const * bpatch, apr_pool_t result_pool) -> svn_stream_t *"},
	 { (char *)"svn_diff_get_binary_diff_result_stream", _wrap_svn_diff_get_binary_diff_result_stream, METH_VARARGS, (char *)"svn_diff_get_binary_diff_result_stream(svn_diff_binary_patch_t const * bpatch, apr_pool_t result_pool) -> svn_stream_t *"},
	 ...
	 { (char *)"svn_patch_t_binary_patch_set", _wrap_svn_patch_t_binary_patch_set, METH_VARARGS, (char *)"svn_patch_t_binary_patch_set(svn_patch_t self, svn_diff_binary_patch_t * binary_patch)"},
	 { (char *)"svn_patch_t_binary_patch_get", _wrap_svn_patch_t_binary_patch_get, METH_VARARGS, (char *)"svn_patch_t_binary_patch_get(svn_patch_t self) -> svn_diff_binary_patch_t *"},
	 { (char *)"svn_patch_t_old_executable_bit_set", _wrap_svn_patch_t_old_executable_bit_set, METH_VARARGS, (char *)"svn_patch_t_old_executable_bit_set(svn_patch_t self, svn_tristate_t old_executable_bit)"},
	 { (char *)"svn_patch_t_old_executable_bit_get", _wrap_svn_patch_t_old_executable_bit_get, METH_VARARGS, (char *)"svn_patch_t_old_executable_bit_get(svn_patch_t self) -> svn_tristate_t"},
	 { (char *)"svn_patch_t_new_executable_bit_set", _wrap_svn_patch_t_new_executable_bit_set, METH_VARARGS, (char *)"svn_patch_t_new_executable_bit_set(svn_patch_t self, svn_tristate_t new_executable_bit)"},
	 { (char *)"svn_patch_t_new_executable_bit_get", _wrap_svn_patch_t_new_executable_bit_get, METH_VARARGS, (char *)"svn_patch_t_new_executable_bit_get(svn_patch_t self) -> svn_tristate_t"},
	 { (char *)"svn_patch_t_old_symlink_bit_set", _wrap_svn_patch_t_old_symlink_bit_set, METH_VARARGS, (char *)"svn_patch_t_old_symlink_bit_set(svn_patch_t self, svn_tristate_t old_symlink_bit)"},
	 { (char *)"svn_patch_t_old_symlink_bit_get", _wrap_svn_patch_t_old_symlink_bit_get, METH_VARARGS, (char *)"svn_patch_t_old_symlink_bit_get(svn_patch_t self) -> svn_tristate_t"},
	 { (char *)"svn_patch_t_new_symlink_bit_set", _wrap_svn_patch_t_new_symlink_bit_set, METH_VARARGS, (char *)"svn_patch_t_new_symlink_bit_set(svn_patch_t self, svn_tristate_t new_symlink_bit)"},
	 { (char *)"svn_patch_t_new_symlink_bit_get", _wrap_svn_patch_t_new_symlink_bit_get, METH_VARARGS, (char *)"svn_patch_t_new_symlink_bit_get(svn_patch_t self) -> svn_tristate_t"},
	 ...
	 { (char *)"svn_diff_parse_next_patch", _wrap_svn_diff_parse_next_patch, METH_VARARGS, (char *)"svn_diff_parse_next_patch(svn_patch_file_t * patch_file, svn_boolean_t reverse, svn_boolean_t ignore_whitespace, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_diff_binary_patch_t_swigregister", svn_diff_binary_patch_t_swigregister, METH_VARARGS, NULL},
