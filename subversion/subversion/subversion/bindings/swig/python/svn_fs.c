...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"svn_fs_upgrade2", _wrap_svn_fs_upgrade2, METH_VARARGS, (char *)"svn_fs_upgrade2(char const * path, svn_fs_upgrade_notify_t notify_func, void * notify_baton, svn_cancel_func_t cancel_func, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_hotcopy3", _wrap_svn_fs_hotcopy3, METH_VARARGS, (char *)"svn_fs_hotcopy3(char const * src_path, char const * dest_path, svn_boolean_t clean, svn_boolean_t incremental, svn_fs_hotcopy_notify_t notify_func, void * notify_baton, svn_cancel_func_t cancel_func, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_hotcopy2", _wrap_svn_fs_hotcopy2, METH_VARARGS, (char *)"svn_fs_hotcopy2(char const * src_path, char const * dest_path, svn_boolean_t clean, svn_boolean_t incremental, svn_cancel_func_t cancel_func, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_node_relation", _wrap_svn_fs_node_relation, METH_VARARGS, (char *)"svn_fs_node_relation(svn_fs_node_relation_t * relation, svn_fs_root_t * root_a, char const * path_a, svn_fs_root_t * root_b, char const * path_b, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_change_node_prop", _wrap_svn_fs_change_node_prop, METH_VARARGS, (char *)"svn_fs_change_node_prop(svn_fs_root_t * root, char const * path, char const * name, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_fs_props_different", _wrap_svn_fs_props_different, METH_VARARGS, (char *)"svn_fs_props_different(svn_fs_root_t * root1, char const * path1, svn_fs_root_t * root2, char const * path2, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_props_changed", _wrap_svn_fs_props_changed, METH_VARARGS, (char *)"svn_fs_props_changed(svn_fs_root_t * root1, char const * path1, svn_fs_root_t * root2, char const * path2, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_get_mergeinfo2", _wrap_svn_fs_get_mergeinfo2, METH_VARARGS, (char *)"svn_fs_get_mergeinfo2(svn_fs_root_t * root, apr_array_header_t paths, svn_mergeinfo_inheritance_t inherit, svn_boolean_t include_descendants, svn_boolean_t adjust_inherited_mergeinfo, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_get_mergeinfo", _wrap_svn_fs_get_mergeinfo, METH_VARARGS, (char *)"svn_fs_get_mergeinfo(svn_fs_root_t * root, apr_array_header_t paths, svn_mergeinfo_inheritance_t inherit, svn_boolean_t include_descendants, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_fs_merge", _wrap_svn_fs_merge, METH_VARARGS, (char *)"svn_fs_merge(svn_fs_root_t * source_root, char const * source_path, svn_fs_root_t * target_root, char const * target_path, svn_fs_root_t * ancestor_root, char const * ancestor_path, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_copy", _wrap_svn_fs_copy, METH_VARARGS, (char *)"svn_fs_copy(svn_fs_root_t * from_root, char const * from_path, svn_fs_root_t * to_root, char const * to_path, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_file_checksum", _wrap_svn_fs_file_checksum, METH_VARARGS, (char *)"svn_fs_file_checksum(svn_checksum_kind_t kind, svn_fs_root_t * root, char const * path, svn_boolean_t force, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_try_process_file_contents", _wrap_svn_fs_try_process_file_contents, METH_VARARGS, (char *)"svn_fs_try_process_file_contents(svn_fs_root_t * root, char const * path, svn_fs_process_contents_func_t processor, void * baton, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_apply_textdelta", _wrap_svn_fs_apply_textdelta, METH_VARARGS, (char *)"svn_fs_apply_textdelta(svn_fs_root_t * root, char const * path, char const * base_checksum, char const * result_checksum, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_contents_different", _wrap_svn_fs_contents_different, METH_VARARGS, (char *)"svn_fs_contents_different(svn_fs_root_t * root1, char const * path1, svn_fs_root_t * root2, char const * path2, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_contents_changed", _wrap_svn_fs_contents_changed, METH_VARARGS, (char *)"svn_fs_contents_changed(svn_fs_root_t * root1, char const * path1, svn_fs_root_t * root2, char const * path2, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_revision_prop2", _wrap_svn_fs_revision_prop2, METH_VARARGS, (char *)"svn_fs_revision_prop2(svn_fs_t * fs, svn_revnum_t rev, char const * propname, svn_boolean_t refresh, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_change_rev_prop2", _wrap_svn_fs_change_rev_prop2, METH_VARARGS, (char *)"svn_fs_change_rev_prop2(svn_fs_t * fs, svn_revnum_t rev, char const * name, svn_string_t const *const * old_value_p, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_get_file_delta_stream", _wrap_svn_fs_get_file_delta_stream, METH_VARARGS, (char *)"svn_fs_get_file_delta_stream(svn_fs_root_t * source_root, char const * source_path, svn_fs_root_t * target_root, char const * target_path, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_lock", _wrap_svn_fs_lock, METH_VARARGS, (char *)"svn_fs_lock(svn_fs_t * fs, char const * path, char const * token, char const * comment, svn_boolean_t is_dav_comment, apr_time_t expiration_date, svn_revnum_t current_rev, svn_boolean_t steal_lock, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_unlock_many", _wrap_svn_fs_unlock_many, METH_VARARGS, (char *)"svn_fs_unlock_many(svn_fs_t * fs, apr_hash_t unlock_targets, svn_boolean_t break_lock, svn_fs_lock_callback_t lock_callback, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_get_locks2", _wrap_svn_fs_get_locks2, METH_VARARGS, (char *)"svn_fs_get_locks2(svn_fs_t * fs, char const * path, svn_depth_t depth, svn_fs_get_locks_callback_t get_locks_func, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_pack", _wrap_svn_fs_pack, METH_VARARGS, (char *)"svn_fs_pack(char const * db_path, svn_fs_pack_notify_t notify_func, void * notify_baton, svn_cancel_func_t cancel_func, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_fs_verify", _wrap_svn_fs_verify, METH_VARARGS, (char *)"svn_fs_verify(char const * path, apr_hash_t fs_config, svn_revnum_t start, svn_revnum_t end, svn_fs_progress_notify_func_t notify_func, void * notify_baton, svn_cancel_func_t cancel_func, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_invoke_upgrade_notify", _wrap_svn_fs_invoke_upgrade_notify, METH_VARARGS, (char *)"svn_fs_invoke_upgrade_notify(svn_fs_upgrade_notify_t _obj, void * baton, apr_uint64_t number, svn_fs_upgrade_notify_action_t action, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_invoke_hotcopy_notify", _wrap_svn_fs_invoke_hotcopy_notify, METH_VARARGS, (char *)"svn_fs_invoke_hotcopy_notify(svn_fs_hotcopy_notify_t _obj, void * baton, svn_revnum_t start_revision, svn_revnum_t end_revision, apr_pool_t scratch_pool)"},
	 ...
	 { (char *)"svn_fs_invoke_mergeinfo_receiver", _wrap_svn_fs_invoke_mergeinfo_receiver, METH_VARARGS, (char *)"svn_fs_invoke_mergeinfo_receiver(svn_fs_mergeinfo_receiver_t _obj, char const * path, apr_hash_t mergeinfo, void * baton, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_invoke_process_contents_func", _wrap_svn_fs_invoke_process_contents_func, METH_VARARGS, (char *)"svn_fs_invoke_process_contents_func(svn_fs_process_contents_func_t _obj, unsigned char const * contents, apr_size_t len, void * baton, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_fs_invoke_lock_callback", _wrap_svn_fs_invoke_lock_callback, METH_VARARGS, (char *)"svn_fs_invoke_lock_callback(svn_fs_lock_callback_t _obj, void * baton, char const * path, svn_lock_t lock, svn_error_t fs_err, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_fs_invoke_pack_notify", _wrap_svn_fs_invoke_pack_notify, METH_VARARGS, (char *)"svn_fs_invoke_pack_notify(svn_fs_pack_notify_t _obj, void * baton, apr_int64_t shard, svn_fs_pack_notify_action_t action, apr_pool_t pool) -> svn_error_t"},
