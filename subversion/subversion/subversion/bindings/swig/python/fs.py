...
def svn_fs_access_add_lock_token2(*args):
  ...
  return apply(_fs.svn_fs_access_add_lock_token2, args)
...
def svn_fs_file_checksum(*args):
  """
    svn_fs_file_checksum(svn_checksum_t checksum, svn_checksum_kind_t kind, 
        ...
        apr_pool_t pool) -> svn_error_t
    """
  return apply(_fs.svn_fs_file_checksum, args)
...
def svn_fs_pack(*args):
  """
    svn_fs_pack(char db_path, svn_fs_pack_notify_t notify_func, void notify_baton, 
        ...
        apr_pool_t pool) -> svn_error_t
    """
  return apply(_fs.svn_fs_pack, args)
class svn_fs_t:
...
def svn_fs_invoke_pack_notify(*args):
  """
    ...
    """
  return apply(_fs.svn_fs_invoke_pack_notify, args)
