...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"svn_ra_open", _wrap_svn_ra_open, METH_VARARGS, (char *)"svn_ra_open(char const * repos_URL, svn_ra_callbacks_t callbacks, void * callback_baton, apr_hash_t config, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_change_rev_prop2", _wrap_svn_ra_change_rev_prop2, METH_VARARGS, (char *)"svn_ra_change_rev_prop2(svn_ra_session_t * session, svn_revnum_t rev, char const * name, svn_string_t const *const * old_value_p, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_change_rev_prop", _wrap_svn_ra_change_rev_prop, METH_VARARGS, (char *)"svn_ra_change_rev_prop(svn_ra_session_t * session, svn_revnum_t rev, char const * name, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_get_commit_editor3", _wrap_svn_ra_get_commit_editor3, METH_VARARGS, (char *)"svn_ra_get_commit_editor3(svn_ra_session_t * session, apr_hash_t revprop_table, svn_commit_callback2_t commit_callback, apr_hash_t lock_tokens, svn_boolean_t keep_locks, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_commit_editor2", _wrap_svn_ra_get_commit_editor2, METH_VARARGS, (char *)"svn_ra_get_commit_editor2(svn_ra_session_t * session, char const * log_msg, svn_commit_callback2_t commit_callback, apr_hash_t lock_tokens, svn_boolean_t keep_locks, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_commit_editor", _wrap_svn_ra_get_commit_editor, METH_VARARGS, (char *)"svn_ra_get_commit_editor(svn_ra_session_t * session, char const * log_msg, svn_commit_callback_t callback, apr_hash_t lock_tokens, svn_boolean_t keep_locks, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_file", _wrap_svn_ra_get_file, METH_VARARGS, (char *)"svn_ra_get_file(svn_ra_session_t * session, char const * path, svn_revnum_t revision, svn_stream_t * stream, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_dir2", _wrap_svn_ra_get_dir2, METH_VARARGS, (char *)"svn_ra_get_dir2(svn_ra_session_t * session, char const * path, svn_revnum_t revision, apr_uint32_t dirent_fields, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_list", _wrap_svn_ra_list, METH_VARARGS, (char *)"svn_ra_list(svn_ra_session_t * session, char const * path, svn_revnum_t revision, apr_array_header_t patterns, svn_depth_t depth, apr_uint32_t dirent_fields, svn_ra_dirent_receiver_t receiver, void * receiver_baton, apr_pool_t scratch_pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_mergeinfo", _wrap_svn_ra_get_mergeinfo, METH_VARARGS, (char *)"svn_ra_get_mergeinfo(svn_ra_session_t * session, apr_array_header_t paths, svn_revnum_t revision, svn_mergeinfo_inheritance_t inherit, svn_boolean_t include_descendants, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_do_update2", _wrap_svn_ra_do_update2, METH_VARARGS, (char *)"svn_ra_do_update2(svn_ra_session_t * session, svn_revnum_t revision_to_update_to, char const * update_target, svn_depth_t depth, svn_boolean_t send_copyfrom_args, svn_delta_editor_t update_editor, void * update_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_do_update", _wrap_svn_ra_do_update, METH_VARARGS, (char *)"svn_ra_do_update(svn_ra_session_t * session, svn_revnum_t revision_to_update_to, char const * update_target, svn_boolean_t recurse, svn_delta_editor_t update_editor, void * update_baton, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_do_switch2", _wrap_svn_ra_do_switch2, METH_VARARGS, (char *)"svn_ra_do_switch2(svn_ra_session_t * session, svn_revnum_t revision_to_switch_to, char const * switch_target, svn_depth_t depth, char const * switch_url, svn_delta_editor_t switch_editor, void * switch_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_do_switch", _wrap_svn_ra_do_switch, METH_VARARGS, (char *)"svn_ra_do_switch(svn_ra_session_t * session, svn_revnum_t revision_to_switch_to, char const * switch_target, svn_boolean_t recurse, char const * switch_url, svn_delta_editor_t switch_editor, void * switch_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_do_status2", _wrap_svn_ra_do_status2, METH_VARARGS, (char *)"svn_ra_do_status2(svn_ra_session_t * session, char const * status_target, svn_revnum_t revision, svn_depth_t depth, svn_delta_editor_t status_editor, void * status_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_do_status", _wrap_svn_ra_do_status, METH_VARARGS, (char *)"svn_ra_do_status(svn_ra_session_t * session, char const * status_target, svn_revnum_t revision, svn_boolean_t recurse, svn_delta_editor_t status_editor, void * status_baton, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_do_diff2", _wrap_svn_ra_do_diff2, METH_VARARGS, (char *)"svn_ra_do_diff2(svn_ra_session_t * session, svn_revnum_t revision, char const * diff_target, svn_boolean_t recurse, svn_boolean_t ignore_ancestry, svn_boolean_t text_deltas, char const * versus_url, svn_delta_editor_t diff_editor, void * diff_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_do_diff", _wrap_svn_ra_do_diff, METH_VARARGS, (char *)"svn_ra_do_diff(svn_ra_session_t * session, svn_revnum_t revision, char const * diff_target, svn_boolean_t recurse, svn_boolean_t ignore_ancestry, char const * versus_url, svn_delta_editor_t diff_editor, void * diff_baton, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_get_locations", _wrap_svn_ra_get_locations, METH_VARARGS, (char *)"svn_ra_get_locations(svn_ra_session_t * session, char const * path, svn_revnum_t peg_revision, apr_array_header_t location_revisions, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_location_segments", _wrap_svn_ra_get_location_segments, METH_VARARGS, (char *)"svn_ra_get_location_segments(svn_ra_session_t * session, char const * path, svn_revnum_t peg_revision, svn_revnum_t start_rev, svn_revnum_t end_rev, svn_location_segment_receiver_t receiver, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_file_revs2", _wrap_svn_ra_get_file_revs2, METH_VARARGS, (char *)"svn_ra_get_file_revs2(svn_ra_session_t * session, char const * path, svn_revnum_t start, svn_revnum_t end, svn_boolean_t include_merged_revisions, svn_file_rev_handler_t handler, void * handler_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_file_revs", _wrap_svn_ra_get_file_revs, METH_VARARGS, (char *)"svn_ra_get_file_revs(svn_ra_session_t * session, char const * path, svn_revnum_t start, svn_revnum_t end, svn_ra_file_rev_handler_t handler, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_lock", _wrap_svn_ra_lock, METH_VARARGS, (char *)"svn_ra_lock(svn_ra_session_t * session, apr_hash_t path_revs, char const * comment, svn_boolean_t steal_lock, svn_ra_lock_callback_t lock_func, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_unlock", _wrap_svn_ra_unlock, METH_VARARGS, (char *)"svn_ra_unlock(svn_ra_session_t * session, apr_hash_t path_tokens, svn_boolean_t break_lock, svn_ra_lock_callback_t lock_func, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_replay", _wrap_svn_ra_replay, METH_VARARGS, (char *)"svn_ra_replay(svn_ra_session_t * session, svn_revnum_t revision, svn_revnum_t low_water_mark, svn_boolean_t send_deltas, svn_delta_editor_t editor, void * edit_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_deleted_rev", _wrap_svn_ra_get_deleted_rev, METH_VARARGS, (char *)"svn_ra_get_deleted_rev(svn_ra_session_t * session, char const * path, svn_revnum_t peg_revision, svn_revnum_t end_revision, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_get_inherited_props", _wrap_svn_ra_get_inherited_props, METH_VARARGS, (char *)"svn_ra_get_inherited_props(svn_ra_session_t * session, char const * path, svn_revnum_t revision, apr_pool_t result_pool, apr_pool_t scratch_pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_reporter3_invoke_set_path", _wrap_svn_ra_reporter3_invoke_set_path, METH_VARARGS, (char *)"svn_ra_reporter3_invoke_set_path(svn_ra_reporter3_t _obj, void * report_baton, char const * path, svn_revnum_t revision, svn_depth_t depth, svn_boolean_t start_empty, char const * lock_token, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_reporter2_invoke_set_path", _wrap_svn_ra_reporter2_invoke_set_path, METH_VARARGS, (char *)"svn_ra_reporter2_invoke_set_path(svn_ra_reporter2_t _obj, void * report_baton, char const * path, svn_revnum_t revision, svn_boolean_t start_empty, char const * lock_token, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_reporter2_invoke_link_path", _wrap_svn_ra_reporter2_invoke_link_path, METH_VARARGS, (char *)"svn_ra_reporter2_invoke_link_path(svn_ra_reporter2_t _obj, void * report_baton, char const * path, char const * url, svn_revnum_t revision, svn_boolean_t start_empty, char const * lock_token, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_reporter_invoke_set_path", _wrap_svn_ra_reporter_invoke_set_path, METH_VARARGS, (char *)"svn_ra_reporter_invoke_set_path(svn_ra_reporter_t _obj, void * report_baton, char const * path, svn_revnum_t revision, svn_boolean_t start_empty, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_reporter_invoke_link_path", _wrap_svn_ra_reporter_invoke_link_path, METH_VARARGS, (char *)"svn_ra_reporter_invoke_link_path(svn_ra_reporter_t _obj, void * report_baton, char const * path, char const * url, svn_revnum_t revision, svn_boolean_t start_empty, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_plugin_invoke_open", _wrap_svn_ra_plugin_invoke_open, METH_VARARGS, (char *)"svn_ra_plugin_invoke_open(svn_ra_plugin_t _obj, char const * repos_URL, svn_ra_callbacks_t callbacks, void * callback_baton, apr_hash_t config, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_plugin_invoke_change_rev_prop", _wrap_svn_ra_plugin_invoke_change_rev_prop, METH_VARARGS, (char *)"svn_ra_plugin_invoke_change_rev_prop(svn_ra_plugin_t _obj, void * session_baton, svn_revnum_t rev, char const * name, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_plugin_invoke_rev_prop", _wrap_svn_ra_plugin_invoke_rev_prop, METH_VARARGS, (char *)"svn_ra_plugin_invoke_rev_prop(svn_ra_plugin_t _obj, void * session_baton, svn_revnum_t rev, char const * name, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_get_commit_editor", _wrap_svn_ra_plugin_invoke_get_commit_editor, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_commit_editor(svn_ra_plugin_t _obj, void * session_baton, char const * log_msg, svn_commit_callback_t callback, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_get_file", _wrap_svn_ra_plugin_invoke_get_file, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_file(svn_ra_plugin_t _obj, void * session_baton, char const * path, svn_revnum_t revision, svn_stream_t * stream, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_get_dir", _wrap_svn_ra_plugin_invoke_get_dir, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_dir(svn_ra_plugin_t _obj, void * session_baton, char const * path, svn_revnum_t revision, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_do_update", _wrap_svn_ra_plugin_invoke_do_update, METH_VARARGS, (char *)"svn_ra_plugin_invoke_do_update(svn_ra_plugin_t _obj, void * session_baton, svn_revnum_t revision_to_update_to, char const * update_target, svn_boolean_t recurse, svn_delta_editor_t update_editor, void * update_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_do_switch", _wrap_svn_ra_plugin_invoke_do_switch, METH_VARARGS, (char *)"svn_ra_plugin_invoke_do_switch(svn_ra_plugin_t _obj, void * session_baton, svn_revnum_t revision_to_switch_to, char const * switch_target, svn_boolean_t recurse, char const * switch_url, svn_delta_editor_t switch_editor, void * switch_baton, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_do_status", _wrap_svn_ra_plugin_invoke_do_status, METH_VARARGS, (char *)"svn_ra_plugin_invoke_do_status(svn_ra_plugin_t _obj, void * session_baton, char const * status_target, svn_revnum_t revision, svn_boolean_t recurse, svn_delta_editor_t status_editor, void * status_baton, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_plugin_invoke_get_log", _wrap_svn_ra_plugin_invoke_get_log, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_log(svn_ra_plugin_t _obj, void * session_baton, apr_array_header_t paths, svn_revnum_t start, svn_revnum_t end, svn_boolean_t discover_changed_paths, svn_boolean_t strict_node_history, svn_log_message_receiver_t receiver, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_check_path", _wrap_svn_ra_plugin_invoke_check_path, METH_VARARGS, (char *)"svn_ra_plugin_invoke_check_path(svn_ra_plugin_t _obj, void * session_baton, char const * path, svn_revnum_t revision, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_plugin_invoke_get_locations", _wrap_svn_ra_plugin_invoke_get_locations, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_locations(svn_ra_plugin_t _obj, void * session_baton, char const * path, svn_revnum_t peg_revision, apr_array_header_t location_revisions, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_plugin_invoke_get_file_revs", _wrap_svn_ra_plugin_invoke_get_file_revs, METH_VARARGS, (char *)"svn_ra_plugin_invoke_get_file_revs(svn_ra_plugin_t _obj, void * session_baton, char const * path, svn_revnum_t start, svn_revnum_t end, svn_ra_file_rev_handler_t handler, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_invoke_get_wc_prop_func", _wrap_svn_ra_invoke_get_wc_prop_func, METH_VARARGS, (char *)"svn_ra_invoke_get_wc_prop_func(svn_ra_get_wc_prop_func_t _obj, void * baton, char const * path, char const * name, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_invoke_set_wc_prop_func", _wrap_svn_ra_invoke_set_wc_prop_func, METH_VARARGS, (char *)"svn_ra_invoke_set_wc_prop_func(svn_ra_set_wc_prop_func_t _obj, void * baton, char const * path, char const * name, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_invoke_push_wc_prop_func", _wrap_svn_ra_invoke_push_wc_prop_func, METH_VARARGS, (char *)"svn_ra_invoke_push_wc_prop_func(svn_ra_push_wc_prop_func_t _obj, void * baton, char const * path, char const * name, svn_string_t const * value, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_invoke_invalidate_wc_props_func", _wrap_svn_ra_invoke_invalidate_wc_props_func, METH_VARARGS, (char *)"svn_ra_invoke_invalidate_wc_props_func(svn_ra_invalidate_wc_props_func_t _obj, void * baton, char const * path, char const * name, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_invoke_file_rev_handler", _wrap_svn_ra_invoke_file_rev_handler, METH_VARARGS, (char *)"svn_ra_invoke_file_rev_handler(svn_ra_file_rev_handler_t _obj, void * baton, char const * path, svn_revnum_t rev, apr_hash_t rev_props, apr_array_header_t prop_diffs, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_invoke_lock_callback", _wrap_svn_ra_invoke_lock_callback, METH_VARARGS, (char *)"svn_ra_invoke_lock_callback(svn_ra_lock_callback_t _obj, void * baton, char const * path, svn_boolean_t do_lock, svn_lock_t lock, svn_error_t ra_err, apr_pool_t pool) -> svn_error_t"},
	 { (char *)"svn_ra_invoke_progress_notify_func", _wrap_svn_ra_invoke_progress_notify_func, METH_VARARGS, (char *)"svn_ra_invoke_progress_notify_func(svn_ra_progress_notify_func_t _obj, apr_off_t progress, apr_off_t total, void * baton, apr_pool_t pool)"},
	 { (char *)"svn_ra_invoke_replay_revstart_callback", _wrap_svn_ra_invoke_replay_revstart_callback, METH_VARARGS, (char *)"svn_ra_invoke_replay_revstart_callback(svn_ra_replay_revstart_callback_t _obj, svn_revnum_t revision, void * replay_baton, apr_hash_t rev_props, apr_pool_t pool) -> svn_error_t"},
	 ...
	 { (char *)"svn_ra_invoke_open_tunnel_func", _wrap_svn_ra_invoke_open_tunnel_func, METH_VARARGS, (char *)"svn_ra_invoke_open_tunnel_func(svn_ra_open_tunnel_func_t _obj, void * tunnel_baton, char const * tunnel_name, char const * user, char const * hostname, int port, svn_cancel_func_t cancel_func, apr_pool_t pool) -> svn_error_t"},
