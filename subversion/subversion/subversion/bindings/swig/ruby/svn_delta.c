...
#define SWIGTYPE_p_svn_diff_fns_t swig_types[53]
...
_wrap_svn_txdelta_run(int argc, VALUE *argv, VALUE self) {
  ...
  res9 = SWIG_ConvertPtr(argv[5], &argp9,SWIGTYPE_p_apr_pool_t, 0 |  0 );
  if (!SWIG_IsOK(res9)) {
    SWIG_exception_fail(SWIG_ArgError(res9), Ruby_Format_TypeError( "", "apr_pool_t *","svn_txdelta_run", 9, argv[5] )); 
  }
  arg9 = (apr_pool_t *)(argp9);
  res10 = SWIG_ConvertPtr(argv[6], &argp10,SWIGTYPE_p_apr_pool_t, 0 |  0 );
  if (!SWIG_IsOK(res10)) {
    SWIG_exception_fail(SWIG_ArgError(res10), Ruby_Format_TypeError( "", "apr_pool_t *","svn_txdelta_run", 10, argv[6] )); 
  }
  arg10 = (apr_pool_t *)(argp10);
  {
