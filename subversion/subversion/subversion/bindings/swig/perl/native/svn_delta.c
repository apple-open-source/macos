...
#define SWIGTYPE_p_svn_diff_output_fns_t swig_types[55]
#define SWIGTYPE_p_svn_diff_t swig_types[56]
...
#define SWIGTYPE_p_svn_log_changed_path2_t swig_types[64]
#define SWIGTYPE_p_svn_log_changed_path_t swig_types[65]
#define SWIGTYPE_p_svn_log_entry_t swig_types[66]
#define SWIGTYPE_p_svn_merge_range_t swig_types[67]
#define SWIGTYPE_p_svn_mergeinfo_inheritance_t swig_types[68]
#define SWIGTYPE_p_svn_node_kind_t swig_types[69]
#define SWIGTYPE_p_svn_opt_revision_range_t swig_types[70]
...
XS(_wrap_svn_txdelta_run) {
  {
    ...
    res9 = SWIG_ConvertPtr(ST(7), &argp9,SWIGTYPE_p_apr_pool_t, 0 |  0 );
    if (!SWIG_IsOK(res9)) {
      SWIG_exception_fail(SWIG_ArgError(res9), "in method '" "svn_txdelta_run" "', argument " "9"" of type '" "apr_pool_t *""'"); 
    }
    arg9 = (apr_pool_t *)(argp9);
    res10 = SWIG_ConvertPtr(ST(8), &argp10,SWIGTYPE_p_apr_pool_t, 0 |  0 );
    if (!SWIG_IsOK(res10)) {
      SWIG_exception_fail(SWIG_ArgError(res10), "in method '" "svn_txdelta_run" "', argument " "10"" of type '" "apr_pool_t *""'"); 
    }
