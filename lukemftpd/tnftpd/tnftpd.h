/* $NetBSD: tnftpd.h,v 1.31 2008/09/21 16:35:24 lukem Exp $	*/
...
/* Always use our arpa/ftp.h; it's guaranteed to have FTPNAMES */
#include "arpa_ftp.h"
...
# define MAP_FAILED	((void *)-1)	/* mmap(2) error indicator */
#endif
