...
void add_objc_super_decl				PROTO((void));
...
tree build_objc_string				PROTO((int, char *));
tree build_objc_string_object			PROTO((tree));
tree lookup_interface				PROTO((tree));
tree lookup_name_type				PROTO((tree));
void emit_class_ivars				PROTO((tree));
int lang_decode_option				PROTO((int, char **));
...
void objc_check_type				PROTO((tree));
