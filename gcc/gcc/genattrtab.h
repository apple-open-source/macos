...
extern void gen_final_presence_set	PARAMS ((rtx)); /* APPLE LOCAL - 3.4 scheduler update */
extern void gen_absence_set		PARAMS ((rtx));
extern void gen_final_absence_set	PARAMS ((rtx)); /* APPLE LOCAL - 3.4 scheduler update */
