...
static int stab_ensym_required = FALSE;
  ...
  /* Until we get the "usr/include/stab.h" and "/System/.../mach-o/stab.h"
     merged, these defs are snarfed from the "...mach-o/stab.h" file.  */

#ifndef N_BNSYM
#define N_BNSYM 0x2e    /* (==46) begin nsect sym: 0,,n_sect,0,address */ 
#define N_ENSYM 0x4e    /* (==78) end nsect sym: 0,,n_sect,0,address */
#endif
     ...
     int show_arg_types;
{
  ...
  switch (TREE_CODE (type))
    ...
    case VECTOR_TYPE:
      /* Output a vector type as an array,
	 pending some other way to do it.  */
      fprintf (asmfile, "ar");
      dbxout_type_index (integer_type_node);
      fprintf (asmfile, ";0;%d;",
