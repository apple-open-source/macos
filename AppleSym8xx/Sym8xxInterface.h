...
#define SCSI_RESET_IOMD			MAX_SCSI_TARGETS	// zero-based offset for the RESET IOMD
#define MAX_SCSI_IOMDS			(MAX_SCSI_TARGETS + 1)	// one for each target, plus one for RESET
