...
/* This file contains the old ipfirewall interface for the sake of maintaining
 * binary compatibility with existing clients of the firewall.  The names of
 * structures and pre-processor constants/macros have been doctored so as not
 * to conflict with the header for the new interface.
 */
...
struct ip_old_fw_chain {
        LIST_ENTRY(ip_old_fw_chain) chain;
        struct ip_old_fw    *rule;
};
 ...
 */
#define IP_OLD_FW_REJECT_RST	0x0100		/* TCP packets: send RST */

/*
 * Definitions for IP option names.
 */
#define IP_OLD_FW_IPOPT_LSRR	0x01
#define IP_OLD_FW_IPOPT_SSRR	0x02
#define IP_OLD_FW_IPOPT_RR		0x04
#define IP_OLD_FW_IPOPT_TS		0x08

/*
 * Definitions for TCP flags.
 */
#define IP_OLD_FW_TCPF_FIN		TH_FIN
#define IP_OLD_FW_TCPF_SYN		TH_SYN
#define IP_OLD_FW_TCPF_RST		TH_RST
#define IP_OLD_FW_TCPF_PSH		TH_PUSH
#define IP_OLD_FW_TCPF_ACK		TH_ACK
#define IP_OLD_FW_TCPF_URG		TH_URG
