...
{
    if (theItem == activeUserToolbarItem || 
        theItem == newToolbarItem) {
        return YES;
        
    } else if (theItem == renewToolbarItem ||
               theItem == destroyToolbarItem ||
               theItem == passwordToolbarItem) {
        return [self hasSelectedCache];
        
    } else if (theItem == infoToolbarItem) {
