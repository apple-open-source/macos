...
/*
 * $Id: gssapi_krb5.c 20898 2008-10-20 18:18:49Z ghudson $
 */
 ...
 */
OM_uint32
kg_get_defcred(minor_status, no_ui, cred)
    ...
    gss_cred_id_t *cred;
{
    ...
    if ((major = krb5_gss_acquire_cred(minor_status,
                                       ...
                                       GSS_C_NULL_OID_SET, 
                                       GSS_C_INITIATE | (no_ui ? GSS_C_CRED_NO_UI : 0),
...
{
    kim_ui_environment env;

    *minor_status = 0;

    switch (flag) {
    case GSS_KRB5_UI_ALLOW:
    case GSS_KRB5_UI_PROBE:
        env = KIM_UI_ENVIRONMENT_AUTO;
        break;
    case GSS_KRB5_UI_DENY:
    default:
        env = KIM_UI_ENVIRONMENT_NONE;
        break;
    }

    kim_library_set_ui_environment(env);
