...
implements SerializableHttpSession, HttpSession, Session, Serializable {
   ...
   // ----------------------------------------------------- Instance Variables
    ...
    public String toString() {
        ...
        sb.append("id="+id+", ");
	sb.append("created="+new Date(getCreationTime())+", ");
	sb.append("last access="+new Date(getLastAccessedTime())+", ");
	sb.append("expire time="+new Date(getLastAccessedTime()+getMaxInactiveInterval()*1000));
        sb.append("]");
        return (sb.toString());
