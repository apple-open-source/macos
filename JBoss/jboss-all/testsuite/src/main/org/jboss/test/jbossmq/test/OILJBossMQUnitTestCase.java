...
public class OILJBossMQUnitTestCase extends JBossMQUnitTest
{
   ...
   public static Test suite() throws Exception
   {
      ...
      suite.addTest(new JBossTestSetup(new TestSuite(OILJBossMQUnitTestCase.class))
      {
         ...
         {
            this.getLog().info("OILJBossMQUnitTestCase started");
            JBossMQUnitTest.TOPIC_FACTORY = "ConnectionFactory";
            JBossMQUnitTest.QUEUE_FACTORY = "ConnectionFactory";
         }
         protected void tearDown() throws Exception
         {
            this.getLog().info("OILJBossMQUnitTestCase done");
         }
      });
