...
// $Id: ExternalUnitTestCase.java,v 1.1 2002/04/26 11:53:27 cgjung Exp $
...
public class ExternalUnitTestCase extends AxisTestCase {
   ...
   public ExternalUnitTestCase(String name) {
    ...
    protected String getAxisConfiguration() {
        return "external/client/"+super.getAxisConfiguration();
    }
    ...
    public static Test suite() throws Exception {
        return getDeploySetup(ExternalUnitTestCase.class, "external.ear");
    }
