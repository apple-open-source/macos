...
// $Id: StoreUnitTestCase.java,v 1.1 2002/04/02 13:48:42 cgjung Exp $

package org.jboss.test.net.store;

import org.jboss.net.samples.store.Item;
import org.jboss.net.samples.store.BusinessPartner;
import org.jboss.net.samples.store.Address;
import org.jboss.net.samples.store.Phone;
import org.jboss.net.samples.store.StateType;
...
public class StoreUnitTestCase extends AxisTestCase {
   ...
   // Constructors --------------------------------------------------
    ...
    protected String getAxisConfiguration() {
        return "store/client/"+super.getAxisConfiguration();
    }
