...
// $Id: AxisInvocationHandler.java,v 1.8.2.1 2002/09/12 16:18:03 cgjung Exp $
...
public class AxisInvocationHandler implements InvocationHandler, Serializable{
	...
	private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
		...
		EngineConfiguration newEngine=ServiceFactory.getEngineConfiguration(rootContext);
		if(newEngine!=null) {
			call=new Call(new Service(newEngine));
		} else {
