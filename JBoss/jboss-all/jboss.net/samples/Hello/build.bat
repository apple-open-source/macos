...
REM  ======================================================================
REM
REM $Id: build.bat,v 1.1 2002/06/04 03:42:58 fbrier Exp $
REM
REM Authors:
...
set ANT_OPTS=-Djava.protocol.handler.pkgs=org.jboss.net.protocol -Djavax.xml.parsers.DocumentBuilderFactory=%JAXP_DOM_FACTORY% -Djavax.xml.parsers.SAXParserFactory=%JAXP_SAX_FACTORY% -Dbuild.script=build.bat -Djavac.verbose=true
