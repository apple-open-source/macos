   ...
   implements DestinationManagerMBean
{
   ...
   public String listMessageCounter() throws Exception
   {
      ...
      for( i=0; i<counter.length; i++ )
      {
         ...
         else
         {
            ...
            if( strDestLast != null )
            {
               ...
               ret += "<tr bgcolor=\"#" + ( (i%2)==0 ? "FFFFFF" : "F0F0F0") + "\"><td rowspan=\"" +
                      destCount + "\">" + strTypeLast + "</td><td rowspan=\"" +
                      destCount + "\">" + strNameLast + "</td>" +
                      destData;
      ...
      ret += "<tr><td></td><td></td><td></td><td></td><td>" + countTotal +
              "</td><td>" + ( countDeltaTotal == 0 ? "-" : Integer.toString( countDeltaTotal ) ) +
              "</td><td>" + depthTotal +
              "</td><td>" + ( depthDeltaTotal == 0 ? "-" : Integer.toString( depthDeltaTotal ) ) +
