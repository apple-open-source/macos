...
rem
rem Options
rem install                Install the service using Tomcat4 as service name.
...
if exist "%CATALINA_HOME%\bin\tomcat4.exe" goto okHome
...
set EXECUTABLE=%CATALINA_HOME%\bin\tomcat4.exe

rem Set default Service name
set SERVICE_NAME=Tomcat4
