...
0x09, 0x7A,                  /* (LOCAL)  USAGE              0x0020007A Motion: Gyrometer (CACP=Application or Physical Collection)  */\
0xA1, 0x01,                  /* (MAIN)   COLLECTION         0x01 Application (Usage=0x0020007A: Page=Sensor Device Page, Usage=Motion: Gyrometer, Type=CACP) */\
...
0x0A, 0x57, 0x04,            /*   (LOCAL)  USAGE              0x00200457 Data Field: Angular Velocity about X Axis (SV=Static Value)    */\
...
0x05, 0x20,                  /*   (GLOBAL) USAGE_PAGE         0x0020 Sensor Device Page <-- Redundant: USAGE_PAGE is already 0x0020   */\
0x0A, 0x58, 0x04,            /*   (LOCAL)  USAGE              0x00200458 Data Field: Angular Velocity about Y Axis (SV=Static Value)    */\
...
0x81, 0x02,                  /*   (MAIN)   INPUT              0x00000002 (1 field x 32 bits) 0=Data 1=Variable 0=Absolute 0=NoWrap 0=Linear 0=PrefState 0=NoNull 0=NonVolatile 0=Bitmap    */\
0x05, 0x20,                  /*   (GLOBAL) USAGE_PAGE         0x0020 Sensor Device Page <-- Redundant: USAGE_PAGE is already 0x0020   */\
0x0A, 0x59, 0x04,            /*   (LOCAL)  USAGE              0x00200459 Data Field: Angular Velocity about Z Axis (SV=Static Value)    */\
0x75, 0x20,                  /*   (GLOBAL) REPORT_SIZE        0x20 (32) Number of bits per field <-- Redundant: REPORT_SIZE is already 32    */\
0x95, 0x01,                  /*   (GLOBAL) REPORT_COUNT       0x01 (1) Number of fields <-- Redundant: REPORT_COUNT is already 1    */\
0x81, 0x02,                  /*   (MAIN)   INPUT              0x00000002 (1 field x 32 bits) 0=Data 1=Variable 0=Absolute 0=NoWrap 0=Linear 0=PrefState 0=NoNull 0=NonVolatile 0=Bitmap    */\
0x06, 0x0C, 0xFF,            /*   (GLOBAL) USAGE_PAGE         0xFF0C     */\
0x09, 0x09,                  /*   (LOCAL)  USAGE              0xFF0C0009     */\
0x26, 0x00, 0x00,            /*   (GLOBAL) LOGICAL_MAXIMUM    0x0000 (0)  <-- Info: Consider replacing 26 0000 with 24   */\
0x16, 0x00, 0x00,            /*   (GLOBAL) LOGICAL_MINIMUM    0x0000 (0)  <-- Info: Consider replacing 16 0000 with 14   */\
...
//--------------------------------------------------------------------------------
// Sensor Device Page HIDGyroFeatureReport 01 (Device <-> Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    // Usages:  0020030E
    // Coll:    Motion:Gyrometer
    // Access:  Read/Write
    // Type:    Variable
    // Page 0x0020: Sensor Device Page
    // Collection: Motion:Gyrometer
    uint32_t SNS_MotionGyrometerPropertyReportInterval; // Usage 0x0020030E: Property: Report Interval, Value = 0 to 1879048192
} HIDGyroFeatureReport01;


//--------------------------------------------------------------------------------
// Sensor Device Page HIDGyroInputReport 01 (Device --> Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    // Locals:  USAG:00200457 UMIN:0 UMAX:0 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:  00200457
    // Coll:    Motion:Gyrometer
    // Access:  Read/Write
    // Type:    Variable
    // Page 0x0020: Sensor Device Page
    // Collection: Motion:Gyrometer
    int32_t  SNS_MotionGyrometerDataFieldAngularVelocityAboutXAxis; // Usage 0x00200457: Data Field: Angular Velocity about X Axis, Value = -32768 to 32767, Physical = ((Value + 32768) - 32768)
    ...
    // Flags:   00000002: 0=Data 1=Variable 0=Absolute 0=NoWrap 0=Linear 0=PrefState 0=NoNull 0=NonVolatile 0=Bitmap
    // Globals: PAGE:0020 LMIN:-32768 LMAX:32767 PMIN:-32768 PMAX:32767 UEXP:-3 UNIT:0 RSIZ:32 RID:01 RCNT:1
    // Locals:  USAG:00200458 UMIN:0 UMAX:0 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:  00200458
    // Coll:    Motion:Gyrometer
    // Access:  Read/Write
    // Type:    Variable
    // Page 0x0020: Sensor Device Page
    int32_t  SNS_MotionGyrometerDataFieldAngularVelocityAboutYAxis; // Usage 0x00200458: Data Field: Angular Velocity about Y Axis, Value = -32768 to 32767, Physical = ((Value + 32768) - 32768)
    ...
    // Flags:   00000002: 0=Data 1=Variable 0=Absolute 0=NoWrap 0=Linear 0=PrefState 0=NoNull 0=NonVolatile 0=Bitmap
    // Globals: PAGE:0020 LMIN:-32768 LMAX:32767 PMIN:-32768 PMAX:32767 UEXP:-3 UNIT:0 RSIZ:32 RID:01 RCNT:1
    // Locals:  USAG:00200459 UMIN:0 UMAX:0 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:  00200459
    // Coll:    Motion:Gyrometer
    // Access:  Read/Write
    // Type:    Variable
    // Page 0x0020: Sensor Device Page
    int32_t  SNS_MotionGyrometerDataFieldAngularVelocityAboutZAxis; // Usage 0x00200459: Data Field: Angular Velocity about Z Axis, Value = -32768 to 32767, Physical = ((Value + 32768) - 32768)
    ...
    // Type:    Variable
    // Page 0xFF0C:
    uint8_t  MotionGyrometer0009 : 2;                  // Usage 0xFF0C0009: , Value = 0 to 0, Physical = Value / 0
    ...
    // Type:    Variable
    // Page 0xFF0C:
    uint8_t  MotionGyrometer000A : 1;                  // Usage 0xFF0C000A: , Value = 0 to 0, Physical = Value / 0
    ...
    // Type:    Variable
    // Page 0xFF0C:
    uint32_t MotionGyrometer000B;                      // Usage 0xFF0C000B: , Value = 0 to 0
} HIDGyroInputReport01;
