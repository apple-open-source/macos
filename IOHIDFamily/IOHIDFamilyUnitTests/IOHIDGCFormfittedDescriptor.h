//
//  IOHIDGCFormFittedDescriptor.h
//  IOHIDFamily
//
//  Created by yg on 8/13/18.
//

#ifndef IOHIDGCFormFittedDescriptor_h
#define IOHIDGCFormFittedDescriptor_h

//--------------------------------------------------------------------------------
// Decoded Application Collection
//--------------------------------------------------------------------------------

#define HIDGCFormFitted \
...
0x95, 0x04,                  /*     (GLOBAL) REPORT_COUNT       0x04 (4) Number of fields       */\
0x09, 0x05,                  /*     (LOCAL)  USAGE              0x00050005       */\
...
//--------------------------------------------------------------------------------
// Generic Desktop Page HIDGCFormFittedInputReport (Device --> Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    // Globals: PAGE:0005 LMIN:0 LMAX:1 PMIN:0 PMAX:1 UEXP:0 UNIT:0 RSIZ:1 RID:0 RCNT:3
    // Locals:  USAG:0005003A UMIN:0 UMAX:0 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:  0005003A
    // Coll:    GamePad GamePad
    // Access:  Read/Only
    // Type:    Variable
    // Page 0x0005: Game Controls Page
    uint8_t  GC_GamePadFormFittingGamepad : 1;         // Usage 0x0005003A: Form-fitting Gamepad, Value = 0 to 1, Physical = Value
    uint8_t  GC_GamePadFormFittingGamepad1 : 1;        // Usage 0x0005003A: Form-fitting Gamepad, Value = 0 to 1, Physical = Value
    uint8_t  GC_GamePadFormFittingGamepad2 : 1;        // Usage 0x0005003A: Form-fitting Gamepad, Value = 0 to 1, Physical = Value
} HIDGCFormFittedInputReport;


//--------------------------------------------------------------------------------
// LED Indicator Page HIDGCFormFittedOutputReport (Device <-- Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    // Locals:  USAG:00050005 UMIN:0008FF00 UMAX:0008FF03 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:  00050005 0008FF00 0008FF01 0008FF02 0008FF03
    // Coll:    GamePad GamePad
    // Access:  Read/Write
    // Type:    Variable
    // Page 0x0008: LED Indicator Page
    // Collection: GamePad GamePad
    uint8_t  GC_GamePad0005 : 1;                       // Usage 0x00050005: , Value = 0 to 1, Physical = Value
    ...
    // Usage 0x0008FF03  Value = 0 to 1 <-- Ignored: REPORT_COUNT (4) is too small
    ...
    uint8_t  : 1;                                      // Pad
    uint8_t  : 1;                                      // Pad
} HIDGCFormFittedOutputReport;

#endif /* IOHIDGCFormFittedDescriptor_h */
