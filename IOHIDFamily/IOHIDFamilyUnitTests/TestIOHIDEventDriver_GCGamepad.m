//
//  TestIOHIDEventDriver_GCGamepad .m
...
#import "IOHIDGCGamepadDescriptor.h"

@interface TestIOHIDEventDriver_GCGamepad : IOHIDEventDriverTestCase

@property XCTestExpectation                 * testEventExpectation;

@end

@implementation TestIOHIDEventDriver_GCGamepad
...
- (void)testGCGCGamepad  {
    ...
    HIDGCGamepadInputReport report;
    ...
    HIDXCTAssertWithParameters (RETURN_FROM_TEST, !property || ([property isKindOfClass: [NSNumber class]] && ((NSNumber *)property).boolValue == NO), "kIOHIDGameControllerFormFittingKey:%@", property);
