...
#import "IOHIDCarPlaySelectButton.h"


@interface TestIOHIDEventDriver_CarPlaySelectButton : IOHIDEventDriverTestCase

@property XCTestExpectation                 * testEventExpectation;

@end

@implementation TestIOHIDEventDriver_CarPlaySelectButton
