//
//  IOHIDGCGamepadDescriptor.h
//  IOHIDFamily
//
//  Created by yg on 8/13/18.
//

#ifndef IOHIDGCGamepadDescriptor_h
#define IOHIDGCGamepadDescriptor_h
...
0x95, 0x01,                  /*     (GLOBAL) REPORT_COUNT       0x01 (1) Number of fields       */\
0x91, 0x01,                  /*     (MAIN)   OUTPUT             0x00000001 (1 field x 4 bits) 1=Constant 0=Array 0=Absolute 0=NoWrap 0=Linear 0=PrefState 0=NoNull 0=NonVolatile 0=Bitmap      */\
0xC0,                        /*   (MAIN)   END_COLLECTION     Logical   */\
0xC0,                        /* (MAIN)   END_COLLECTION     Application */\


//--------------------------------------------------------------------------------
// Generic Desktop Page HIDGCGamepadInputReport (Device --> Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    uint8_t  : 1;                                      // Pad
    uint8_t  : 1;                                      // Pad
} HIDGCGamepadInputReport;


//--------------------------------------------------------------------------------
// LED Indicator Page HIDGCGamepadOutputReport (Device <-- Host)
//--------------------------------------------------------------------------------
...
typedef struct __attribute__((packed))
{
    ...
    // Globals: PAGE:0008 LMIN:0 LMAX:1 PMIN:0 PMAX:1 UEXP:0 UNIT:0 RSIZ:4 RID:0 RCNT:1
    // Locals:  USAG:0 UMIN:0 UMAX:0 DIDX:0 DMIN:0 DMAX:0 SIDX:0 SMIN:0 SMAX:0
    // Usages:
    // Coll:    GamePad GamePad
    // Access:  Read/Only
    ...
    // Page 0x0008: LED Indicator Page
    uint8_t  : 4;                                      // Pad
} HIDGCGamepadOutputReport;

#endif /* IOHIDGCGamepadDescriptor_h */
