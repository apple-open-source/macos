...
#import "IOHIDGCFormfittedCollectionDescriptor.h"

@interface TestIOHIDEventDriver_GCFormFittedCollection : IOHIDEventDriverTestCase

@property XCTestExpectation                 * testEventExpectation;

@end

@implementation TestIOHIDEventDriver_GCFormFittedCollection
...
- (void)testGCFormFittedCollection {
    IOReturn        status;
    ...
    HIDGCFormFittedCollectionInputReport report;
