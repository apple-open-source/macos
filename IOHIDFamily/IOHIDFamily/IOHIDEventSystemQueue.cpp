...
OSDefineMetaClassAndStructors( IOHIDEventSystemQueue, super )
...
//---------------------------------------------------------------------------
void IOHIDEventSystemQueue::sendDataAvailableNotification()
{
    super::sendDataAvailableNotification();
    _didSendNotificationForLastEnqueue = true;
}
