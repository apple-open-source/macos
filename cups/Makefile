...
installtests:
	xcodebuild build-for-testing -project cups/xcode/CUPS.xcodeproj -scheme cups-ATP -testProductsPath $(DSTROOT)/AppleInternal/Tests/cups/cups-ATP.xctestproduct
