...
#define IMAP_UNRECOGNIZED_CHARSET                (-1904809436L)
#define IMAP_INVALID_USER                        (-1904809435L)
#define IMAP_INVALID_LOGIN                       (-1904809434L)
#define IMAP_ANONYMOUS_NOT_PERMITTED             (-1904809433L)
#define IMAP_UNSUPPORTED_QUOTA                   (-1904809432L)
#define IMAP_SASL_FAIL                           (-1904809431L)
#define IMAP_SASL_CANCEL                         (-1904809430L)
#define IMAP_SASL_PROTERR                        (-1904809429L)
#define IMAP_NO_OVERQUOTA                        (-1904809428L)
#define IMAP_NO_CLOSEQUOTA                       (-1904809427L)
#define IMAP_NO_MSGGONE                          (-1904809426L)
#define IMAP_NO_CHECKSEEN                        (-1904809425L)
#define IMAP_NO_CHECKPRESERVE                    (-1904809424L)
#define IMAP_NO_NOSUCHMSG                        (-1904809423L)
#define IMAP_NO_NOSUCHANNOTATION                 (-1904809422L)
#define IMAP_NO_UNKNOWN_CTE                      (-1904809421L)
#define IMAP_BYE_LOGOUT                          (-1904809420L)
#define IMAP_OK_COMPLETED                        (-1904809419L)
#define IMAP_END_LIST                            (-1904809418L)
