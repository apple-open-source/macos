...
%package plug-odcrammd5
%summary: SASL OD-CRAM-MD5 mechanism plugin

%description plug-odcrammd5
This plugin implements the SASL OD-CRAM-MD5 mechanism.
OD-CRAM-MD5 is the mandatory-to-implement authentication mechanism for a
number of protocols; it uses MD5 with a challenge/response system to
authenticate the user.

%package plug-odchkpass
%summary: SASL OD-Checkpass mechanism plugin

%description plug-odchkpass
This plugin implements the SASL OD-Checkpass mechanism.
OD-Checkpass is the mandatory-to-implement authentication mechanism for a
number of protocols; it uses OD Clear Text auth to authenticate the user.

%package plug-odapop
%summary: SASL OD-APOP mechanism plugin

%description plug-odapop
This plugin implements the SASL OD-APOP mechanism.
OD-APOP is the mandatory-to-implement authentication mechanism for a
number of protocols; it uses Open Directory APOP auth to authenticate
the user.
...
%files plug-odcrammd5
%doc doc/rfc1321.txt doc/rfc2095.txt doc/rfc2104.txt
/usr/lib/sasl/libodcrammd5.so.1.0.1
/usr/lib/sasl/libodcrammd5.so

%files plug-odchkpass
%doc doc/rfc1321.txt doc/rfc2095.txt doc/rfc2104.txt
/usr/lib/sasl/libodchkpass.so.1.0.1
/usr/lib/sasl/libodchkpass.so

%files plug-odapop
%doc doc/rfc1321.txt doc/rfc2095.txt doc/rfc2104.txt
/usr/lib/sasl/libodapop.so.1.0.1
/usr/lib/sasl/libodapop.so
