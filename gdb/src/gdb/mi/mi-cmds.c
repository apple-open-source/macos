...
struct mi_cmd mi_cmds[] =
{
  ...
  {"break-catch", 0, 0, mi_cmd_break_catch},
  {"break-commands", 0, 0},
  ...
  {"exec-status", 0, 0, mi_cmd_exec_status},
  ...
  {"file-sharedlibrary-set-load-state", "sharedlibrary set-load-state %s", 0},
  {"file-sharedlibrary-add-symbol-file", "sharedlibrary add-symbol-file %s", 0},
  {"file-sharedlibrary-remove-symbol-file", "sharedlibrary remove-symbol-file %s", 0},
  {"gdb-complete", 0, 0},
  ...
  {"kod-show", 0, 0},
  {"mi-verify-command", 0, 0, mi_cmd_mi_verify_command},
  {"mi-enable-timings", 0, 0, mi_cmd_enable_timings},
  {"mi-no-op", 0, 0, mi_cmd_mi_no_op},
  {"overlay-auto", 0, 0},
  ...
  {"thread-set-pc", 0, 0, mi_cmd_thread_set_pc},
  {"trace-actions", 0, 0},
  {"trace-delete", 0, 0},
  {"trace-disable", 0, 0},
  {"trace-dump", 0, 0},
