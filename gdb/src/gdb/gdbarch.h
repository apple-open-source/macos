...
typedef void (gdbarch_deprecated_print_extra_frame_info_ftype) (struct frame_info *next_frame, void **this_cache);
extern void gdbarch_deprecated_print_extra_frame_info (struct gdbarch *gdbarch, struct frame_info *next_frame, void **this_cache);
extern void set_gdbarch_deprecated_print_extra_frame_info (struct gdbarch *gdbarch, gdbarch_deprecated_print_extra_frame_info_ftype *deprecated_print_extra_frame_info);
#if (GDB_MULTI_ARCH > GDB_MULTI_ARCH_PARTIAL) && defined (DEPRECATED_PRINT_EXTRA_FRAME_INFO)
#error "Non multi-arch definition of DEPRECATED_PRINT_EXTRA_FRAME_INFO"
#endif
#if !defined (DEPRECATED_PRINT_EXTRA_FRAME_INFO)
#define DEPRECATED_PRINT_EXTRA_FRAME_INFO(next_frame, this_cache) (gdbarch_deprecated_print_extra_frame_info (current_gdbarch, next_frame, this_cache))
#endif
