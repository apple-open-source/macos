...
f:2:DEPRECATED_PRINT_EXTRA_FRAME_INFO:void:deprecated_print_extra_frame_info:struct frame_info *next_frame, void **this_cache:next_frame, this_cache::0:default_print_extra_frame_info::0
#
