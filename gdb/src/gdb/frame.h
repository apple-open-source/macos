...
/* Use frame_unwind_register_unsigned.  */
...
extern struct frame_info *deprecated_frame_next_hack (struct frame_info *frame);
extern void *deprecated_frame_cache_hack (struct frame_info *frame);
extern void default_print_extra_frame_info (struct frame_info *next_frame, void **this_cache);
