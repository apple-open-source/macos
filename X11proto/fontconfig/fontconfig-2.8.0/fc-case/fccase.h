...
static const FcCaseFold    fcCaseFold[FC_NUM_CASE_FOLD] = {
    ...
    { 0x000004d0, FC_CASE_FOLD_EVEN_ODD, 0x0055,      1 },
    ...
    { 0x0000a640, FC_CASE_FOLD_EVEN_ODD, 0x001f,      1 },
    { 0x0000a662, FC_CASE_FOLD_EVEN_ODD, 0x000b,      1 },
