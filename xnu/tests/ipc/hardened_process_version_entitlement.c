...
T_DECL(test_hardened_process_version,
    "entitlement version should propagate to task info",
    ...
    T_META_BOOTARGS_SET("amfi_allow_any_signature=1"))
{
	...
	T_EXPECT_EQ_UINT(conf->hardened_process_version, 1, "hardened-process version should be set");
}
