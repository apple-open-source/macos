...
L073:
	popl %edx
	leal L_fun_krb5_get_error_message$non_lazy_ptr-"L073"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L074:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_alloc$non_lazy_ptr-"L074"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L075:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_free$non_lazy_ptr-"L075"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L076:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_set_canonicalize$non_lazy_ptr-"L076"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L077:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_set_forwardable$non_lazy_ptr-"L077"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L078:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_set_proxiable$non_lazy_ptr-"L078"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L079:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_set_renew_life$non_lazy_ptr-"L079"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L080:
	popl %edx
	leal L_fun_krb5_get_init_creds_opt_set_tkt_life$non_lazy_ptr-"L080"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L081:
	popl %edx
	leal L_fun_krb5_get_init_creds_password$non_lazy_ptr-"L081"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L082:
	popl %edx
	leal L_fun_krb5_get_kdc_cred$non_lazy_ptr-"L082"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L083:
	popl %edx
	leal L_fun_krb5_get_kdc_sec_offset$non_lazy_ptr-"L083"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L084:
	popl %edx
	leal L_fun_krb5_init_context$non_lazy_ptr-"L084"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L085:
	popl %edx
	leal L_fun_krb5_init_context_flags$non_lazy_ptr-"L085"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L086:
	popl %edx
	leal L_fun_krb5_make_principal$non_lazy_ptr-"L086"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L087:
	popl %edx
	leal L_fun_krb5_parse_name$non_lazy_ptr-"L087"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L088:
	popl %edx
	leal L_fun_krb5_parse_name_flags$non_lazy_ptr-"L088"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L089:
	popl %edx
	leal L_fun_krb5_principal_compare$non_lazy_ptr-"L089"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L090:
	popl %edx
	leal L_fun_krb5_principal_get_realm$non_lazy_ptr-"L090"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L091:
	popl %edx
	leal L_fun_krb5_timeofday$non_lazy_ptr-"L091"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L092:
	popl %edx
	leal L_fun_krb5_unparse_name$non_lazy_ptr-"L092"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L093:
	popl %edx
	leal L_fun_krb5_us_timeofday$non_lazy_ptr-"L093"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L094:
	popl %edx
	leal L_fun_krb5_kt_start_seq_get$non_lazy_ptr-"L094"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L095:
	popl %edx
	leal L_fun_krb5_kt_end_seq_get$non_lazy_ptr-"L095"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L096:
	popl %edx
	leal L_fun_krb5_xfree$non_lazy_ptr-"L096"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L097:
	popl %edx
	leal L_fun_krb5_kt_next_entry$non_lazy_ptr-"L097"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L098:
	popl %edx
	leal L_fun_krb5_kt_free_entry$non_lazy_ptr-"L098"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L099:
	popl %edx
	leal L_fun_gsskrb5_extract_authz_data_from_sec_context$non_lazy_ptr-"L099"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0100:
	popl %edx
	leal L_fun_krb5_sendauth$non_lazy_ptr-"L0100"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0101:
	popl %edx
	leal L_fun_krb5_free_ap_rep_enc_part$non_lazy_ptr-"L0101"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0102:
	popl %edx
	leal L_fun_krb5_free_error$non_lazy_ptr-"L0102"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0103:
	popl %edx
	leal L_fun_krb5_recvauth$non_lazy_ptr-"L0103"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0104:
	popl %edx
	leal L_fun_krb5_recvauth_match_version$non_lazy_ptr-"L0104"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0105:
	popl %edx
	leal L_fun_krb5_mk_priv$non_lazy_ptr-"L0105"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0106:
	popl %edx
	leal L_fun_krb5_rd_priv$non_lazy_ptr-"L0106"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0107:
	popl %edx
	leal L_fun_krb5_mk_safe$non_lazy_ptr-"L0107"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0108:
	popl %edx
	leal L_fun_krb5_rd_safe$non_lazy_ptr-"L0108"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0109:
	popl %edx
	leal L_fun_krb5_set_home_dir_access$non_lazy_ptr-"L0109"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0110:
	popl %edx
	leal L_fun_krb5_verify_init_creds$non_lazy_ptr-"L0110"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0111:
	popl %edx
	leal L_fun_krb5_verify_init_creds_opt_init$non_lazy_ptr-"L0111"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0112:
	popl %edx
	leal L_fun_krb5_verify_init_creds_opt_set_ap_req_nofail$non_lazy_ptr-"L0112"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0113:
	popl %edx
	leal L_fun_krb5_kuserok$non_lazy_ptr-"L0113"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0114:
	popl %edx
	leal L_fun_com_right$non_lazy_ptr-"L0114"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0115:
	popl %edx
	leal L_fun_com_right_r$non_lazy_ptr-"L0115"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0116:
	popl %edx
	leal L_fun_gss_import_name$non_lazy_ptr-"L0116"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0117:
	popl %edx
	leal L_fun_krb5_appdefault_boolean$non_lazy_ptr-"L0117"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
L0118:
	popl %edx
	leal L_fun_krb5_appdefault_string$non_lazy_ptr-"L0118"(%edx), %eax
	movl (%eax), %edx
	movl (%edx), %edx
	jmp *%edx
...
.comm _fun_krb5_init_context_flags,4,2
.comm _fun_krb5_make_principal,4,2
.comm _fun_krb5_parse_name,4,2
.comm _fun_krb5_parse_name_flags,4,2
...
L_fun_krb5_init_context$non_lazy_ptr:
	...
	.long 0
L_fun_krb5_init_context_flags$non_lazy_ptr:
	.indirect_symbol _fun_krb5_init_context_flags
	.long 0
...
L_fun_krb5_parse_name$non_lazy_ptr:
	...
	.long 0
L_fun_krb5_parse_name_flags$non_lazy_ptr:
	.indirect_symbol _fun_krb5_parse_name_flags
	.long 0
