...
-(void)testFileChangeModeUpdateChangeTime {
    ...
    USERFS_TEST_LOG("Creating dir and file");
    ...
    USERFS_TEST_LOG("Sleeping to make a time difference before changing mode");
    sleep(3);
    
    USERFS_TEST_LOG("Changing dir and file mode");
    ...
    USERFS_TEST_LOG("Checking dir and file change time (fa_ctime)");
