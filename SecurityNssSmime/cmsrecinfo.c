...
PRBool
nss_cmsrecipientinfo_usessubjectkeyid(SecCmsRecipientInfo *ri)
{
...
SecCmsRecipientInfo *
nss_cmsrecipientinfo_create(SecCmsMessage *cmsg, SecCmsRecipientIDSelector type,
                            ...
                            CSSM_DATA *subjKeyID)
{
    ...
    ri = (SecCmsRecipientInfo *)PORT_ArenaZAlloc(poolp, sizeof(SecCmsRecipientInfo));
    if (ri == NULL)
	goto loser;
                                             ...
                                             SecCertificateRef cert)
{
    ...
    SecCmsRecipientInfo *retVal = NULL;
...
OSStatus
SecCmsRecipientInfoWrapBulkKey(SecCmsRecipientInfo *ri, SecSymmetricKeyRef bulkkey, 
