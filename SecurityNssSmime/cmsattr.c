...
cms_attr_choose_attr_value_template(void *src_or_dest, PRBool encoding, const char *buf, void *dest)
{
	...
	case SEC_OID_PKCS9_SIGNING_TIME:
	    encoded = PR_FALSE;
	    theTemplate = SEC_ASN1_GET(SEC_UTCTimeTemplate); // @@@ This should be a choice between UTCTime and GeneralizedTime -- mb
	    break;
