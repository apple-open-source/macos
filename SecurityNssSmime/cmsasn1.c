...
nss_cms_choose_content_template(void *src_or_dest, PRBool encoding, const char *buf, void *dest);

static const SEC_ASN1TemplateChooserPtr nss_cms_chooser
	= nss_cms_choose_content_template;

const SEC_ASN1Template SecCmsMessageTemplate[] = {
 ...
 */
static const SEC_ASN1Template SecCmsEncapsulatedContentInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
...
static const SEC_ASN1Template SecCmsEncryptedContentInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
	  0, NULL, sizeof(SecCmsContentInfo) },
    { SEC_ASN1_OBJECT_ID,
	  offsetof(SecCmsContentInfo,contentType) },
...
const SEC_ASN1Template SecCmsSignerInfoTemplate[];


const SEC_ASN1Template SecCmsSignedDataTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
...
static const SEC_ASN1Template SecCmsSignerIdentifierTemplate[] = {
    { SEC_ASN1_CHOICE,
...
static const SEC_ASN1Template SecCmsOriginatorInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
const SEC_ASN1Template SecCmsRecipientInfoTemplate[];

const SEC_ASN1Template SecCmsEnvelopedDataTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
...
static const SEC_ASN1Template SecCmsRecipientIdentifierTemplate[] = {
    { SEC_ASN1_CHOICE,
...
static const SEC_ASN1Template SecCmsKeyTransRecipientInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsOriginatorPublicKeyTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsOriginatorIdentifierOrKeyTemplate[] = {
    { SEC_ASN1_CHOICE,
...
const SEC_ASN1Template SecCmsRecipientKeyIdentifierTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsKeyAgreeRecipientIdentifierTemplate[] = {
    { SEC_ASN1_CHOICE,
...
static const SEC_ASN1Template SecCmsRecipientEncryptedKeyTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsKeyAgreeRecipientInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsKEKIdentifierTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
static const SEC_ASN1Template SecCmsKEKRecipientInfoTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
const SEC_ASN1Template SecCmsDigestedDataTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
...
const SEC_ASN1Template SecCmsEncryptedDataTemplate[] = {
    { SEC_ASN1_SEQUENCE | SEC_ASN1_MAY_STREAM,
 ...
 */
const SEC_ASN1Template SecCmsIssuerAndSNTemplate[] = {
    { SEC_ASN1_SEQUENCE,
...
nss_cms_choose_content_template(void *src_or_dest, PRBool encoding, const char *buf, void *dest)
{
    ...
    cinfo = (SecCmsContentInfo *)src_or_dest;
