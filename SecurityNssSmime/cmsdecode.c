...
struct SecCmsDecoderContextStr {
    ...
    SecCmsMessage *			cmsg;		/* backpointer to the root message */
    SECOidTag				type;		/* type of message */
    SecCmsContent			content;	/* pointer to message */
    SecCmsDecoderContext *		childp7dcx;	/* inner CMS decoder context */
    PRBool				saw_contents;
    int					error;
...
/*
 * SecCmsDecoderCancel - stop decoding in case of error
 */
void
