...
static int
nss_cms_recipients_traverse(SecCmsRecipientInfo **recipientinfos, SecCmsRecipient **recipient_list)
{
    int count = 0;
    int rlindex = 0;
    int i, j;
...
SecCmsRecipient **
nss_cms_recipient_list_create(SecCmsRecipientInfo **recipientinfos)
{
    int count, rv;
