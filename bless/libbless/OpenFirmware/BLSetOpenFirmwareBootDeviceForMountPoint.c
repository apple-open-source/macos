 ...
 *  Copyright (c) 2001 Apple Computer, Inc. All rights reserved.
 *
 *  $Id: BLSetOpenFirmwareBootDeviceForMountPoint.c,v 1.4 2002/04/27 17:55:00 ssen Exp $
 *
...
int BLSetOpenFirmwareBootDeviceForMountPoint(BLContext context, unsigned char mountpoint[]) {
