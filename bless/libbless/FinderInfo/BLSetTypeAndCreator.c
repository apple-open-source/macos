 ...
 *  Copyright (c) 2001-2003 Apple Computer, Inc. All rights reserved.
 *
 *  $Id: BLSetTypeAndCreator.c,v 1.9 2003/07/22 15:58:30 ssen Exp $
 *
...
int BLSetTypeAndCreator(BLContextPtr context, unsigned char path[], uint32_t type, uint32_t creator) {
