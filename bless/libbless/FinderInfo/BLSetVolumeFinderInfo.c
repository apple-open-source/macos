 ...
 *  Copyright (c) 2001-2005 Apple Computer, Inc. All rights reserved.
 *
 *  $Id: BLSetVolumeFinderInfo.c,v 1.14 2005/02/03 00:42:25 ssen Exp $
 *
...
int BLSetVolumeFinderInfo(BLContextPtr context, const unsigned char mountpoint[], uint32_t words[]) {
