...
/* Prototypes and definitions for some compatibility code. */

/* This is really strange.  I don't understand why they had to include
   those leading underscores to the function names. */
#define popen(program, mode) _popen((program), (mode))
