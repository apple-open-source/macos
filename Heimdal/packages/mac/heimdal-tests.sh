...
if sudo -n true ; then
    ...
    for a in check-apple-lkdc check-apple-hodadmin check-server-hodadmin check-apple-od check-apple-plugins ; do
...
# check-apple-acquire - disbled until CEAD is available
