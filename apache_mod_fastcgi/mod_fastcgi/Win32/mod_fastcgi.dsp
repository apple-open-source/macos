...
# ADD CPP /nologo /MT /W4 /GX /O2 /I "C:\Apache\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /FR /YX /FD /c
...
# ADD LINK32 ApacheCore.lib ws2_32.lib /nologo /subsystem:windows /dll /incremental:yes /machine:I386 /out:"../Release/mod_fastcgi.dll" /libpath:"C:\Apache\libexec"
...
# ADD CPP /nologo /MTd /W4 /Gm /GX /ZI /Od /I "C:\Apache\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "FCGI_DEBUG" /FR /YX /FD /c
...
# ADD LINK32 ApacheCore.lib ws2_32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"../Debug/mod_fastcgi.dll" /pdbtype:sept /libpath:"C:\Apache\libexec"
