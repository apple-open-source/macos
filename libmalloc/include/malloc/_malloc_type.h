...
#undef _MALLOC_TYPE_MALLOC_BACKDEPLOY_PUBLIC
#define _MALLOC_TYPE_MALLOC_BACKDEPLOY_PUBLIC 0
#endif
...
__API_AVAILABLE(macos(14.0), ios(17.0), tvos(17.0), watchos(10.0), bridgeos(8.0), visionos(1.0), driverkit(23.0))
...
/* Enable for all Apple platforms (including Exclaves), except bridgeOS. */
