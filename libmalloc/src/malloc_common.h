...
typedef enum {
	...
	MALLOC_PROCESS_MAC_QUICKLOOK_UISERVICE,
	MALLOC_PROCESS_MAC_QUICKLOOK,
	MALLOC_PROCESS_MAC_QUICKLOOK_THUMBNAIL,
	...
	MALLOC_PROCESS_MAC_SAFARI,
	MALLOC_PROCESS_MAC_SAFARI_SUPPORT,
	MALLOC_PROCESS_MAC_VTDECODERXPCSERVICE,

	MALLOC_PROCESS_VISION_PRESENCED,
	MALLOC_PROCESS_VISION_FACETIME,
	MALLOC_PROCESS_VISION_MANAGEDASSETSD,
	MALLOC_PROCESS_VISION_POLARISD,
	MALLOC_PROCESS_VISION_ARKITD,
	MALLOC_PROCESS_VISION_BACKBOARDD,
	...
	MALLOC_PROCESS_WATCH_BACKBOARDD,
	MALLOC_PROCESS_WATCH_CLOCKFACE,

	MALLOC_PROCESS_MAC_GROUPSESSIONSERVICE,
	MALLOC_PROCESS_MAC_IMTRANSCODERAGENT,
	MALLOC_PROCESS_MAC_KEYCHAINSHARINGMESSAGINGD,
	MALLOC_PROCESS_MAC_MESSAGES,
	MALLOC_PROCESS_MAC_SCREENSHARING,

	MALLOC_PROCESS_MAC_VTENCODERXPCSERVICE,

	MALLOC_PROCESS_VISION_WAKEBOARDD,
	MALLOC_PROCESS_VISION_REALITYCAMERAD,
		...
		malloc_process_identity_t identity)
{
	...
	if (identity == MALLOC_PROCESS_VISION_ARKITD ||
			identity == MALLOC_PROCESS_VISION_BACKBOARDD) {
		return true;
	}
#endif
