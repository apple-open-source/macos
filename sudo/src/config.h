...
/* Mac OS X has dirfd, but we do not want to use it in closefrom()
 * because we do not have /proc/self/fd.
 */
/* #undef HAVE_DIRFD */
...
#define _PATH_SUDERS "/private/etc/sudoers"

/* TRW: 6950663 - Including apple membership functionality. */
#define __APPLE_MEMBERD__ 1
