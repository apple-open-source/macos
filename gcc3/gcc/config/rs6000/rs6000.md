...
(define_insn "*call_nonlocal_sysv"
  [(call (mem:SI (match_operand:SI 0 "call_operand" "c,*l,c,*l,s,s"))
	 (match_operand 1 "" "g,g,g,g,g,g"))
   (use (match_operand:SI 2 "immediate_operand" "O,O,n,n,O,n"))
   (clobber (match_scratch:SI 3 "=l,l,l,l,l,l"))]
  "DEFAULT_ABI == ABI_AIX_NODESC
   || DEFAULT_ABI == ABI_V4
   || DEFAULT_ABI == ABI_DARWIN"
  "*
{
  ...
  [(set_attr "type" "jmpreg,jmpreg,jmpreg,jmpreg,branch,branch")
   (set_attr "length" "4,4,8,8,4,8")])

;; APPLE LOCAL separate cl into c,*l; switch and attr's expanded to match
(define_insn "*call_value_nonlocal_sysv"
  [(set (match_operand 0 "" "")
	(call (mem:SI (match_operand:SI 1 "call_operand" "c,*l,c,*l,s,s"))
	      (match_operand 2 "" "g,g,g,g,g,g")))
   (use (match_operand:SI 3 "immediate_operand" "O,O,n,n,O,n"))
   (clobber (match_scratch:SI 4 "=l,l,l,l,l,l"))]
  "DEFAULT_ABI == ABI_AIX_NODESC
   || DEFAULT_ABI == ABI_V4
   || DEFAULT_ABI == ABI_DARWIN"
  "*
