		...
		if ((r_flags & IMAGE_REL_PPC_TOCDEFN) 
		    == IMAGE_REL_PPC_TOCDEFN )
		  {
		    ...
		    */
		    ...
		    record_toc(toc_section, our_toc_offset, pub, xstrdup(name));
		  }
...
long int import_table_size = 0;
long int first_thunk_address = 0;
long int thunk_size = 0;

struct list_ele *head = NULL;
struct list_ele *tail = NULL;
