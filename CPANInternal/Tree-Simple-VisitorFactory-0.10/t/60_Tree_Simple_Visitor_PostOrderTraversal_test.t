...
BEGIN { 
    use_ok('Tree::Simple::Visitor::PostOrderTraversal');
}
...
can_ok("Tree::Simple::Visitor::PostOrderTraversal", 'new');

my $visitor = Tree::Simple::Visitor::PostOrderTraversal->new();
isa_ok($visitor, 'Tree::Simple::Visitor::PostOrderTraversal');
...
is_deeply(
    [ $visitor->getResults() ],
    [ qw(1.1 1.2.1 1.2.2 1.2 1.3 1 2.1 2.2 2 3.1 3.2 3.3 3 4.1 4) ],
...
is_deeply(
    [ $visitor->getResults() ],
    [ qw(Tree_1.1 Tree_1.2.1 Tree_1.2.2 Tree_1.2 Tree_1.3 Tree_1 
         Tree_2.1 Tree_2.2 Tree_2 Tree_3.1 Tree_3.2 Tree_3.3 
         Tree_3 Tree_4.1 Tree_4 Tree_root) ],
    '... our results are as expected');
