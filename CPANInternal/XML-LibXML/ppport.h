...
----------------------------------------------------------------------
    ...
    ppport.new.h -- Perl/Pollution/Portability Version 3.06_01

    Automatically created by Devel::PPPort running under
    perl 5.008008 on Wed Nov 22 15:01:26 2006.

    Do NOT edit this file directly! -- Edit PPPort_pm.PL and the
    includes in parts/inc/ instead.

    Use 'perldoc ppport.new.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl ppport.new.h [options] [source files]
...
This version of F<ppport.new.h> is designed to support operation with Perl
...
Tell F<ppport.new.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<ppport.new.h> if you intend to be backward compatible only
up to a certain Perl version.

=head2 --cplusplus

Usually, F<ppport.new.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<ppport.new.h> to leave C++
comments untouched.
...
F<ppport.new.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<ppport.new.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl ppport.new.h --list-provided

to see which API elements are provided by ppport.new.h.
...
also deprecated. You can safely use the supported API, as F<ppport.new.h>
...
more C<#define>s in your source code before the inclusion of F<ppport.new.h>.
...
Just C<#define> the macro before including C<ppport.new.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "ppport.new.h"
...
F<ppport.new.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<ppport.new.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<ppport.new.h> can be run as a Perl script to check your
...
use something like this:
    ...
    perl ppport.new.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl ppport.new.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl ppport.new.h --diff='diff -C 10'
...
use:
    ...
    perl ppport.new.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl ppport.new.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl ppport.new.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<ppport.new.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<ppport.new.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error ppport.new.h only works with Perl version 5
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, ppport.new.h implements a version
